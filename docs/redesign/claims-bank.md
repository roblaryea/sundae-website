...
| CLM-004 | `Built with inputs from operators representing 250+ locations` | Section 7 headline | **APPROVED PUBLIC** | Sales pipeline | Robert | No | Resolved 2026-05: conservative phrasing — "inputs from operators representing" avoids implying all 250+ are actively connected. Do not upgrade to "250+ operators on the platform" without a defined active-numerator. |
