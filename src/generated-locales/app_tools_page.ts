  ...
  "localizedCopy": {
    "de": {
      "hero": {
        ...
        "title": "Restaurant-Rechner & Bewertungen",
        "description": "Schnelle, kostenlose Tools zur Analyse der Leistung Ihres Restaurants. Keine Anmeldung erforderlich."
      },
      "tools": [
        {
    ...
    "fr": {
      "hero": {
        ...
        "title": "Calculatrices et Évaluations de Restaurant",
        "description": "Outils rapides et gratuits pour analyser la performance de votre restaurant. Aucune inscription requise."
      },
      "tools": [
        {
    ...
    "es": {
      "hero": {
        ...
        "description": "Herramientas rápidas y gratuitas para analizar el rendimiento de tu restaurante. No se requiere registro."
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "primary": "Reserva una demostración",
        "secondary": "Explora productos"
      }
    },
    "nl": {
      "hero": {
        "badge": "Gratis Tools",
        "title": "Restaurantcalculators & Beoordelingen",
        "description": "Snelle, gratis tools om de prestaties van uw restaurant te analyseren. Geen aanmelding vereist."
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "description": "Deze rekenmachines zijn slechts het begin. Ontdek wat Sundae kan doen met jouw volledige data.",
        "primary": "Boek een Demo",
        "secondary": "Verken Producten"
      }
    },
    "pt": {
      "hero": {
        "badge": "Ferramentas Gratuitas",
        "title": "Calculadoras e Avaliações de Restaurantes",
        "description": "Ferramentas rápidas e gratuitas para analisar o desempenho do seu restaurante. Não é necessário cadastro."
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "description": "Esses calculadores são apenas o começo. Veja o que o Sundae pode fazer com seus dados completos.",
    ...
    "ar": {
      ...
      "cta": {
        ...
        "description": "هذه الآلات الحاسبة هي مجرد البداية. اكتشف ما يمكن أن تفعله Sundae ببياناتك الكاملة.",
    ...
    "ur": {
      "hero": {
        "badge": "مفت ٹولز",
        "title": "ریسٹورنٹ کیلکولیٹرز اور تشخیصات",
        "description": "اپنے ریسٹورنٹ کی کارکردگی کا تجزیہ کرنے کے لیے فوری، مفت ٹولز۔ سائن اپ کی ضرورت نہیں۔"
      },
      "tools": [
        {
      ...
      "cta": {
        "title": "گہرے بصیرت کے لیے تیار ہیں؟",
        "description": "یہ کیلکولیٹر صرف آغاز ہیں۔ دیکھیں کہ Sundae آپ کے مکمل ڈیٹا کے ساتھ کیا کر سکتا ہے۔",
        "primary": "ڈیمو بک کریں",
        "secondary": "مصنوعات کا جائزہ لیں"
      }
    },
    "hi": {
      "hero": {
        "badge": "नि:शुल्क उपकरण",
        "title": "रेस्टोरेंट कैलकुलेटर और आकलन",
        "description": "अपने रेस्टोरेंट के प्रदर्शन का विश्लेषण करने के लिए त्वरित, नि:शुल्क उपकरण। साइन-अप की आवश्यकता नहीं।"
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "description": "ये कैलकुलेटर सिर्फ शुरुआत हैं। देखें कि Sundae आपके पूरे डेटा के साथ क्या कर सकता है।",
    ...
    "it": {
      "hero": {
        ...
        "title": "Calcolatori e Valutazioni per Ristoranti",
        "description": "Strumenti rapidi e gratuiti per analizzare le performance del tuo ristorante. Nessuna registrazione richiesta."
      },
      "tools": [
        {
      ...
      "cta": {
        "title": "Pronto per approfondimenti più dettagliati?",
    ...
    "zh-Hans": {
      "hero": {
        "badge": "免费工具",
        "title": "餐厅计算器与评估",
        "description": "快速、免费的工具来分析您餐厅的表现。无需注册。"
      },
      "tools": [
        {
          "title": "劳动力成本百分比计算器",
      ...
      "cta": {
        "title": "准备深入洞察吗？",
        "description": "这些计算器只是开始。看看Sundae如何利用您的完整数据。",
        "primary": "预约演示",
        "secondary": "探索产品"
      }
    },
    "ko": {
      "hero": {
        "badge": "무료 도구",
        "title": "레스토랑 계산기 및 평가",
        "description": "레스토랑 성과를 분석할 수 있는 빠르고 무료 도구입니다. 가입이 필요 없습니다."
      },
      "tools": [
        {
          "title": "노동 비용 % 계산기",
      ...
      "cta": {
        "title": "더 깊은 인사이트를 원하신가요?",
        "description": "이 계산기는 시작에 불과합니다. Sundae가 귀하의 전체 데이터로 무엇을 할 수 있는지 확인해 보세요.",
        "primary": "데모 예약",
        "secondary": "제품 탐색"
      }
    },
    "tr": {
      "hero": {
        ...
        "title": "Restoran Hesaplayıcıları ve Değerlendirmeleri",
        "description": "Restoranınızın performansını analiz etmek için hızlı, ücretsiz araçlar. Kayıt gerektirmez."
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "description": "Bu hesap makineleri sadece başlangıç. Sundae'nin tam verilerinizle neler yapabileceğini görün.",
        "primary": "Demo Rezervasyonu Yap",
        "secondary": "Ürünleri Keşfet"
      }
    },
    "pl": {
      "hero": {
        "badge": "Darmowe Narzędzia",
        "title": "Kalkulatory i Oceny Restauracji",
        "description": "Szybkie, darmowe narzędzia do analizy wydajności Twojej restauracji. Rejestracja nie jest wymagana."
      },
      "tools": [
        {
        ...
        },
        {
          ...
          "features": [
            "Punkt równowagi",
            "Marża wkładu",
            "Wskazówki dotyczące rentowności"
          ],
          "button": "Otwórz narzędzie"
        },
        {
      ...
      "cta": {
        ...
        "description": "Te kalkulatory to dopiero początek. Zobacz, co Sundae może zrobić z Twoimi danymi.",
        "primary": "Umów się na Demo",
        "secondary": "Zbadaj Produkty"
      }
    },
    "id": {
      "hero": {
        "badge": "Alat Gratis",
        "title": "Kalkulator & Penilaian Restoran",
        "description": "Alat cepat dan gratis untuk menganalisis kinerja restoran Anda. Tidak perlu mendaftar."
      },
      "tools": [
        {
    ...
    "ja": {
      "hero": {
        "badge": "無料ツール",
        "title": "レストラン計算機と評価",
        "description": "レストランのパフォーマンスを分析するための迅速で無料のツール。サインアップは不要です。"
      },
      "tools": [
        {
          "title": "労働コスト % 計算機",
      ...
      "cta": {
        "title": "より深い洞察の準備はできていますか？",
        "description": "これらの計算機は始まりに過ぎません。Sundaeがあなたの全データで何ができるかを見てみましょう。",
        "primary": "デモを予約",
        "secondary": "製品を探る"
      }
    },
    "ro": {
      "hero": {
        "badge": "Instrumente Gratuite",
        "title": "Calculatoare și Evaluări pentru Restaurante",
        "description": "Instrumente rapide și gratuite pentru a analiza performanța restaurantului tău. Nu este necesară înregistrarea."
      },
      "tools": [
        {
        ...
        },
        {
          ...
          "features": [
            ...
            "Informații despre rentabilitate"
          ],
          "button": "Deschide instrumentul"
        },
        {
    ...
    "sv": {
      "hero": {
        ...
        "title": "Restaurang Kalkylatorer & Bedömningar",
        "description": "Snabba, gratis verktyg för att analysera din restaurangs prestanda. Ingen registrering krävs."
      },
      "tools": [
        {
    ...
    "bn": {
      "hero": {
        "badge": "মুক্ত সরঞ্জাম",
        "title": "রেস্তোরাঁর ক্যালকুলেটর ও মূল্যায়ন",
        "description": "আপনার রেস্তোরাঁর কার্যকারিতা বিশ্লেষণের জন্য দ্রুত, মুক্ত সরঞ্জাম। সাইন আপের প্রয়োজন নেই।"
      },
      "tools": [
        {
    ...
    "th": {
      "hero": {
        "badge": "เครื่องมือฟรี",
        "title": "เครื่องคำนวณและการประเมินผลร้านอาหาร",
        "description": "เครื่องมือวิเคราะห์ประสิทธิภาพร้านอาหารของคุณอย่างรวดเร็วและฟรี ไม่ต้องลงทะเบียน."
      },
      "tools": [
        {
        ...
        },
        {
          ...
          "features": [
            ...
            "ข้อมูลเชิงลึกเกี่ยวกับความสามารถในการทำกำไร"
          ],
          "button": "เปิดเครื่องมือ"
        },
        {
      ...
      "cta": {
        ...
        "description": "เครื่องคำนวณเหล่านี้เป็นเพียงจุดเริ่มต้น ดูว่า Sundae สามารถทำอะไรได้บ้างกับข้อมูลทั้งหมดของคุณ.",
        "primary": "จองการสาธิต",
    ...
    "vi": {
      "hero": {
        ...
        "title": "Máy Tính & Đánh Giá Nhà Hàng",
        "description": "Công cụ nhanh chóng, miễn phí để phân tích hiệu suất của nhà hàng của bạn. Không cần đăng ký."
      },
      "tools": [
        {
    ...
    "ms": {
      "hero": {
        "badge": "Alat Percuma",
        "title": "Pengira & Penilaian Restoran",
        "description": "Alat cepat dan percuma untuk menganalisis prestasi restoran anda. Tiada pendaftaran diperlukan."
      },
      "tools": [
        {
      ...
      "cta": {
        ...
        "description": "Pengira ini hanyalah permulaan. Lihat apa yang Sundae boleh lakukan dengan data penuh anda.",
        "primary": "Tempah Demo",
