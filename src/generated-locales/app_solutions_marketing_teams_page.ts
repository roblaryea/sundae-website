...
export const generatedLocalCopy = {
  "localizedCopy": {
    ...
    "ar": {
      ...
      "outcomes": [
        ...
        },
        {
          ...
          "description": "يُظهر Cross-Intelligence مجموعات القنوات التي تتضاعف مع بعضها البعض، وليس فقط المجموعات التي تعمل بمفردها.",
          "icon": "performance"
        },
        {
    ...
    "hi": {
      ...
      "howTitle": "Sundae मार्केटिंग लीड के लिए कैसे काम करता है",
      ...
      "outcomes": [
        ...
        },
        {
          ...
          "description": "Cross-Intelligence दिखाता है कि कौन से चैनल संयोजन एक-दूसरे को गुणा करते हैं - न कि केवल कौन सा अकेले काम करता है।",
          "icon": "performance"
        },
        {
    ...
    "ja": {
      ...
      "howTitle": "マーケティング リードにとってSundaeがどのように機能するか",
      ...
      "outcomes": [
        ...
        {
          "title": "複合的なスタックチャネル",
          "description": "Cross-Intelligenceは、どのチャネルが単独で機能するかだけでなく、どのチャネルの組み合わせが相互に作用するかを示します。",
          "icon": "performance"
        },
        {
