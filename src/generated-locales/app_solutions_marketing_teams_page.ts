// Generated website local copy overrides for src/app/solutions/marketing-teams/page.tsx.
  ...
  "localizedCopy": {
    "fr": {
      ...
      "challenges": [
        ...
        {
          "title": "Le signal du marché local ignoré",
          "description": "Prix des concurrents, météo, événements : rien de tout cela n'apparaît dans le brief de la marque.",
          "icon": "tour de guet"
        }
      ],
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Perspectives · Performance marketing",
          "icon": "commercialisation"
        },
        {
          ...
          "product": "Perspectives · Marketing",
          "icon": "performances"
        },
        {
      ...
      "outcomes": [
        {
          ...
          "description": "Éliminez les dépenses du canal sous-performant avant la clôture du mois, pas après.",
          "icon": "vitesse"
        },
        {
        ...
        {
          "title": "Empiler les canaux qui composent",
          "description": "Cross-Intelligence montre quelles combinaisons de canaux se multiplient les unes les autres, et pas seulement lesquelles fonctionnent seules.",
          "icon": "performances"
        },
        {
          "title": "Des briefs de marque fondés sur le signal du marché",
          "description": "Des plans élaborés en sachant ce que font les concurrents et le marché local, et pas seulement en fonction des dépenses du mois dernier.",
          "icon": "soutien"
        }
      ],
    ...
    "es": {
      ...
      "primaryCta": "Reserve un recorrido de marketing",
      ...
      "challenges": [
        ...
        {
          "title": "Se ignora la señal del mercado local",
          "description": "Precios de la competencia, clima, eventos: nada de eso aparece en el resumen de la marca.",
          "icon": "atalaya"
        }
      ],
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Perspectivas · Rendimiento de marketing",
          "icon": "márketing"
        },
        {
          ...
          "product": "Perspectivas · Marketing",
          "icon": "rendimiento"
        },
        {
          "title": "La inteligencia cruzada encuentra la sinergia",
        ...
        {
          "title": "Señal del mercado en el resumen",
          "description": "Promociones de la competencia, eventos locales, clima: todo en el resumen de la mañana para que el plan de campaña refleje el mercado, no solo el calendario.",
          "product": "Watchtower",
          "icon": "atalaya"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "Saque el gasto del canal de bajo rendimiento antes de que cierre el mes, no después.",
          "icon": "velocidad"
        },
        {
        ...
        {
          "title": "Apilar canales que componen",
          "description": "Cross-Intelligence muestra qué combinaciones de canales se multiplican entre sí, no sólo cuáles funcionan por sí solas.",
          "icon": "rendimiento"
        },
        {
          "title": "Informes de marca basados en la señal del mercado",
          "description": "Los planes se construyen sabiendo lo que están haciendo los competidores y el mercado local, no solo el gasto del mes pasado.",
          "icon": "apoyo"
        }
      ],
      ...
      "ctaButton": "Reserve un recorrido de marketing"
    },
    "de": {
      ...
      "howTitle": "So funktioniert Sundae für Marketing-Leads",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Einblicke · Marketingleistung",
          "icon": "Marketing"
        },
        {
    ...
    "ar": {
      ...
      "problemsTitle": "حيث تتسرب ميزانية التسويق",
      "problemsDescription": "يهبط عائد الاستثمار متأخرًا بأسبوع. يتم إدخال خطة الشهر المقبل قبل ظهور بيانات هذا الشهر.",
      "challenges": [
        {
          "title": "يصل عائد الاستثمار بعد الإنفاق",
          "description": "يتم الإسناد في الأسبوع التالي للحملة. أنت تخطط بالفعل للواحدة التالية.",
          "icon": "التسويق"
        },
        {
        ...
        {
          "title": "تم تحديد مزيج القنوات على أساس الغريزة",
          "description": "الولاء، ووسائل التواصل الاجتماعي المدفوعة، والبحث، والبريد الإلكتروني - يستمر مزيج الأسبوع الماضي بشكل افتراضي، وليس عن طريق التحليل.",
          "icon": "الأداء"
        },
        {
          "title": "تم تجاهل إشارة السوق المحلية",
          "description": "أسعار المنافسين، والطقس، والأحداث - لا يظهر أي منها في ملخص العلامة التجارية.",
          "icon": "برج المراقبة"
        }
      ],
      "howTitle": "كيف يعمل Sundae لتسويق العملاء المحتملين",
      ...
      "howSundaeHelps": [
        ...
        {
          "title": "يجد الذكاء المتبادل التآزر",
        ...
        {
          "title": "إشارة السوق في الموجز",
          "description": "العروض الترويجية للمنافسين، والأحداث المحلية، والطقس - كل ذلك في موجز الصباح، لذا فإن خطة الحملة تعكس السوق، وليس التقويم فقط.",
          "product": "Watchtower",
          "icon": "برج المراقبة"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "انقل الإنفاق من القناة ذات الأداء الضعيف قبل إغلاق الشهر - وليس بعده.",
          "icon": "السرعة"
        },
        {
        ...
        {
          "title": "كومة القنوات التي تتراكم",
          "description": "يُظهر الذكاء المتقاطع مجموعات القنوات التي تتضاعف مع بعضها البعض، وليس فقط المجموعات التي تعمل بمفردها.",
          "icon": "الأداء"
        },
        {
          "title": "ملخصات العلامة التجارية ترتكز على إشارة السوق",
          "description": "يتم وضع الخطط من خلال معرفة ما يفعله المنافسون والسوق المحلية، وليس فقط إنفاق الشهر الماضي.",
          "icon": "الدعم"
        }
      ],
    ...
    "pt": {
      ...
      "howTitle": "Como o Sundae funciona para leads de marketing",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Insights · Desempenho de marketing",
          "icon": "marketing"
        },
        {
      ...
      "outcomes": [
        {
          ...
          "description": "Retire os gastos do canal de baixo desempenho antes do encerramento do mês, e não depois.",
          "icon": "velocidade"
        },
        {
      ...
      "challenges": [
        {
          ...
          "description": "Attributie landt de week na de campagne. Je bent de volgende al aan het plannen.",
          "icon": "marketing"
        },
        {
        ...
        {
          "title": "Lokaal marktsignaal genegeerd",
          "description": "Prijzen van concurrenten, het weer, evenementen: niets daarvan komt terug in de merkopdracht.",
          "icon": "uitkijktoren"
        }
      ],
      "howTitle": "Hoe Sundae werkt voor marketingleads",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Inzichten · Marketingprestaties",
          "icon": "marketing"
        },
        {
        ...
        {
          "title": "Marktsignaal in het kort",
          "description": "Promoties van concurrenten, lokale evenementen, het weer: allemaal in de ochtendbrief, zodat het campagneplan de markt weerspiegelt, en niet alleen de kalender.",
          "product": "Watchtower",
          "icon": "uitkijktoren"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "Verplaats de uitgaven uit het slecht presterende kanaal vóór het einde van de maand, en niet erna.",
          "icon": "snelheid"
        },
        {
    ...
    "ur": {
      ...
      "problemsTitle": "جہاں مارکیٹنگ کا بجٹ لیک ہو جاتا ہے۔",
      "problemsDescription": "ROI ایک ہفتہ تاخیر سے اترتا ہے۔ اس مہینے کا ڈیٹا آنے سے پہلے اگلے مہینے کا منصوبہ تیار ہو جاتا ہے۔",
      "challenges": [
        {
          "title": "خرچ کے بعد ROI آتا ہے۔",
          "description": "مہم کے ایک ہفتے بعد انتساب اترتا ہے۔ آپ پہلے سے ہی اگلے کی منصوبہ بندی کر رہے ہیں۔",
          "icon": "مارکیٹنگ"
        },
        {
        ...
        {
          "title": "مقامی مارکیٹ کے سگنل کو نظر انداز کر دیا گیا۔",
          "description": "مسابقتی قیمتوں کا تعین، موسم، واقعات - اس میں سے کوئی بھی برانڈ بریف میں ظاہر نہیں ہوتا ہے۔",
          "icon": "واچ ٹاور"
        }
      ],
      "howTitle": "سنڈی مارکیٹنگ لیڈز کے لیے کس طرح کام کرتا ہے۔",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "بصیرت · مارکیٹنگ کی کارکردگی",
          "icon": "مارکیٹنگ"
        },
        {
          ...
          "product": "بصیرت · مارکیٹنگ",
          "icon": "کارکردگی"
        },
        {
          "title": "کراس انٹیلی جنس ہم آہنگی تلاش کرتا ہے",
          "description": "وفاداری + دوپہر کے کھانے کا کمبو 2.3× تلاش میں تبدیل ہوتا ہے۔ کراس انٹیلی جنس ان جوڑیوں کو ظاہر کرتی ہے تاکہ آپ چینلز کو اسٹیک کریں، متوازی طور پر نہ چلائیں۔",
          "product": "Cross-Intelligence",
          "icon": "ذہانت"
        },
        {
          "title": "مختصر میں مارکیٹ سگنل",
          "description": "مدمقابل پروموز، مقامی تقریبات، موسم - سب کچھ صبح کے مختصر وقت میں تاکہ مہم کا منصوبہ صرف کیلنڈر کی نہیں بلکہ مارکیٹ کی عکاسی کرتا ہے۔",
          "product": "Watchtower",
          "icon": "واچ ٹاور"
        }
      ],
      "outcomesTitle": "مارکیٹنگ کے لئے کیا تبدیلیاں",
      "outcomesDescription": "دوبارہ مختص کریں جب کہ یہ اہمیت رکھتا ہے، مارجن کو ثابت کریں نہ کہ صرف احاطہ کرتا ہے۔",
      "outcomes": [
        {
        ...
        {
          "title": "اپنے لیے ادا کی گئی مہمات کو ثابت کریں۔",
          "description": "مارجن سے منسوب ROI انہی نمبروں کے ساتھ مالی اعانت کے لیے مارکیٹنگ کے اخراجات کا دفاع کرتا ہے جس میں وہ رہتے ہیں۔",
          "icon": "مالکان"
        },
        {
          "title": "اسٹیک چینلز جو مرکب کرتے ہیں۔",
          "description": "کراس انٹیلی جنس سے پتہ چلتا ہے کہ کون سے چینل کے مجموعے ایک دوسرے کو ضرب دیتے ہیں — نہ صرف یہ کہ کون اکیلے کام کرتا ہے۔",
          "icon": "کارکردگی"
        },
        {
      ...
      "challenges": [
        {
          ...
          "description": "L'attribuzione arriva la settimana successiva alla campagna. Stai già programmando il prossimo.",
        ...
        {
          "title": "Il segnale del mercato locale è stato ignorato",
          "description": "Prezzi della concorrenza, meteo, eventi: niente di tutto ciò compare nel brief del marchio.",
          "icon": "torre di guardia"
        }
      ],
      "howTitle": "Come funziona Sundae per i lead di marketing",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Approfondimenti · Performance di marketing",
          "icon": "commercializzazione"
        },
        {
          ...
          "product": "Approfondimenti · Marketing",
          "icon": "prestazione"
        },
        {
          "title": "Cross-Intelligence trova la sinergia",
          "description": "La combinazione fedeltà + pranzo converte a 2,3× la sola ricerca. Cross-Intelligence fa emergere questi accoppiamenti in modo da impilare i canali, non eseguirli in parallelo.",
          "product": "Cross-Intelligence",
          "icon": "intelligenza"
        },
        {
          "title": "Segnale di mercato nel brief",
          "description": "Promozioni della concorrenza, eventi locali, meteo: tutto nel brief mattutino in modo che il piano della campagna rifletta il mercato, non solo il calendario.",
          "product": "Watchtower",
          "icon": "torre di guardia"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "Sposta la spesa dal canale con performance inferiori prima della chiusura del mese, non dopo.",
          "icon": "velocità"
        },
        {
        ...
        {
          "title": "Impila i canali che si compongono",
          "description": "Cross-Intelligence mostra quali combinazioni di canali si moltiplicano a vicenda, non solo quali funzionano da sole.",
          "icon": "prestazione"
        },
        {
          "title": "Brief del marchio basati sul segnale del mercato",
          "description": "Piani costruiti sapendo cosa stanno facendo i concorrenti e il mercato locale, non solo la spesa del mese scorso.",
          "icon": "supporto"
        }
      ],
    ...
    "hi": {
      ...
      "problemsTitle": "जहां मार्केटिंग बजट लीक हो जाता है",
      "problemsDescription": "आरओआई एक सप्ताह देरी से लैंड करता है। इस महीने का डेटा आने से पहले अगले महीने का प्लान आ जाता है।",
      "challenges": [
        {
          "title": "खर्च के बाद आरओआई आता है",
          "description": "अभियान के एक सप्ताह बाद एट्रिब्यूशन उतरता है। आप पहले से ही अगली योजना बना रहे हैं।",
          "icon": "मार्केटिंग"
        },
        {
        ...
        {
          "title": "चैनल मिक्स का निर्णय वृत्ति के आधार पर लिया गया",
          "description": "वफ़ादारी, सशुल्क सामाजिक, खोज, ईमेल - पिछले सप्ताह का मिश्रण डिफ़ॉल्ट रूप से जारी रहता है, विश्लेषण द्वारा नहीं।",
          "icon": "प्रदर्शन"
        },
        {
          "title": "स्थानीय बाज़ार संकेत को नज़रअंदाज़ किया गया",
          "description": "प्रतिस्पर्धी मूल्य निर्धारण, मौसम, घटनाएँ - इनमें से कुछ भी ब्रांड संक्षिप्त में दिखाई नहीं देता है।",
          "icon": "प्रहरीदुर्ग"
        }
      ],
      "howTitle": "संडे मार्केटिंग लीड के लिए कैसे काम करता है",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "अंतर्दृष्टि · विपणन प्रदर्शन",
          "icon": "मार्केटिंग"
        },
        {
          ...
          "product": "अंतर्दृष्टि · मार्केटिंग",
          "icon": "प्रदर्शन"
        },
        {
          "title": "क्रॉस-इंटेलिजेंस तालमेल ढूंढता है",
          "description": "लॉयल्टी + लंच कॉम्बो अकेले 2.3× खोज पर परिवर्तित होता है। क्रॉस-इंटेलिजेंस इन जोड़ियों को सतह पर लाता है ताकि आप चैनलों को ढेर कर दें, उन्हें समानांतर में न चलाएं।",
          "product": "Cross-Intelligence",
          "icon": "बुद्धि"
        },
        {
          "title": "संक्षेप में बाजार संकेत",
          "description": "प्रतिस्पर्धी प्रोमो, स्थानीय कार्यक्रम, मौसम - सब सुबह की संक्षिप्त जानकारी में, इसलिए अभियान योजना केवल कैलेंडर नहीं, बल्कि बाज़ार को प्रतिबिंबित करती है।",
          "product": "Watchtower",
          "icon": "प्रहरीदुर्ग"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "महीना ख़त्म होने से पहले ख़राब प्रदर्शन वाले चैनल से ख़र्च को हटा दें - उसके बाद नहीं।",
          "icon": "गति"
        },
        {
        ...
        {
          "title": "उस यौगिक को स्टैक चैनल करें",
          "description": "क्रॉस-इंटेलिजेंस दिखाता है कि कौन से चैनल संयोजन एक-दूसरे को गुणा करते हैं - न कि केवल कौन सा अकेले काम करता है।",
          "icon": "प्रदर्शन"
        },
        {
          "title": "ब्रांड ब्रीफ बाजार संकेत पर आधारित है",
          "description": "प्रतिस्पर्धी और स्थानीय बाज़ार क्या कर रहे हैं, यह जानकर योजनाएँ बनाई गईं - न कि केवल पिछले महीने का खर्च।",
          "icon": "समर्थन"
        }
      ],
    ...
    "zh-Hans": {
      ...
      "howSundaeHelps": [
        ...
        {
          "title": "交叉智能找到协同作用",
          "description": "忠诚度 + 午餐组合的转化率仅为搜索量的 2.3 倍。交叉智能显示这些配对，以便您堆叠通道，而不是并行运行它们。",
          "product": "Cross-Intelligence",
          "icon": "智力"
        },
        {
      ...
      "outcomes": [
        {
          "title": "重新分配广告活动中的预算",
          "description": "在月底之前（而不是之后）将支出从表现不佳的渠道转移出去。",
          "icon": "速度"
        },
        {
          "title": "证明营销活动是物有所值的",
        ...
        {
          "title": "复合的堆栈通道",
          "description": "交叉智能显示哪些渠道组合可以相互叠加——而不仅仅是哪些单独发挥作用。",
          "icon": "表现"
        },
        {
          "title": "以市场信号为基础的品牌简介",
          "description": "制定计划时要了解竞争对手和当地市场的情况，而不仅仅是上个月的支出。",
          "icon": "支持"
        }
      ],
      "ctaTitle": "查看动态的频道组合。",
    ...
    "tr": {
      ...
      "problemsTitle": "Pazarlama bütçesinin sızdığı yer",
      "problemsDescription": "Yatırım getirisi bir hafta geç geliyor. Gelecek ayın planı bu ayın verilerinden önce devreye giriyor.",
      "challenges": [
        {
          "title": "Yatırım getirisi harcamadan sonra gelir",
          "description": "İlişkilendirme kampanyadan sonraki hafta gerçekleşir. Zaten bir sonrakini planlıyorsun.",
          "icon": "pazarlama"
        },
        {
        ...
        {
          "title": "Yerel pazar sinyali göz ardı edildi",
          "description": "Rakip fiyatları, hava durumu, etkinlikler; bunların hiçbiri marka brifinginde görünmüyor.",
          "icon": "gözetleme kulesi"
        }
      ],
      "howTitle": "Sundae, pazarlama potansiyel müşterileri için nasıl çalışır?",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Analizler · Pazarlama Performansı",
          "icon": "pazarlama"
        },
        {
          ...
          "product": "Analizler · Pazarlama",
          "icon": "performans"
        },
        {
          "title": "Çapraz İstihbarat sinerjiyi buluyor",
        ...
        {
          "title": "Kısaca piyasa sinyali",
          "description": "Rakip tanıtımları, yerel etkinlikler, hava durumu - hepsi sabah özeti olduğundan kampanya planı yalnızca takvimi değil pazarı da yansıtır.",
          "product": "Watchtower",
          "icon": "gözetleme kulesi"
        }
      ],
      ...
      "outcomes": [
        ...
        },
        {
          ...
          "description": "Çapraz Zeka, yalnızca hangilerinin tek başına işe yaradığını değil, hangi kanal kombinasyonlarının birbirini çoğalttığını gösterir.",
          "icon": "performans"
        },
        {
          "title": "Piyasa sinyallerine dayanan marka özetleri",
          "description": "Planlar, yalnızca geçen ayki harcamaları değil, rakiplerin ve yerel pazarın ne yaptığını bilerek oluşturuldu.",
          "icon": "destek"
        }
      ],
    ...
    "pl": {
      ...
      "challenges": [
        {
          ...
          "description": "Atrybucja następuje tydzień po kampanii. Już planujesz następny.",
          "icon": "marketingu"
        },
        {
      ...
      "howTitle": "Jak Sundae działa na potencjalnych klientów marketingowych",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Spostrzeżenia · Wyniki marketingowe",
          "icon": "marketingu"
        },
        {
          ...
          "product": "Spostrzeżenia · Marketing",
          "icon": "wydajność"
        },
        {
          "title": "Cross-Inteligence znajduje synergię",
      ...
      "outcomes": [
        {
          ...
          "description": "Przenieś wydatki z kanału o niższych wynikach przed zamknięciem miesiąca, a nie później.",
          "icon": "prędkość"
        },
        {
        ...
        {
          "title": "Układaj kanały, które się łączą",
          "description": "Cross-Intelligence pokazuje, które kombinacje kanałów się zwielokrotniają, a nie tylko te, które działają samodzielnie.",
          "icon": "wydajność"
        },
        {
    ...
    "ko": {
      ...
      "problemsTitle": "마케팅 예산이 새는 곳",
      "problemsDescription": "ROI는 일주일 늦게 도착합니다. 이번 달 데이터보다 다음 달 계획이 먼저 들어갑니다.",
      "challenges": [
        {
          "title": "ROI는 지출 후에 도착합니다.",
          "description": "기여는 캠페인 다음 주에 시작됩니다. 당신은 이미 다음 계획을 세우고 있습니다.",
          "icon": "마케팅"
        },
        {
          "title": "계산에서 순마진이 누락됨",
        ...
        {
          "title": "현지 시장 신호가 무시됨",
          "description": "경쟁사 가격, 날씨, 이벤트 등 그 어느 것도 브랜드 개요에 표시되지 않습니다.",
          "icon": "망루"
        }
      ],
      "howTitle": "순대가 마케팅 리드를 위해 일하는 방식",
      ...
      "howSundaeHelps": [
        ...
        {
          "title": "간략한 시장 신호",
          "description": "경쟁사 프로모션, 지역 이벤트, 날씨 등이 모두 아침 요약에 포함되므로 캠페인 계획에는 달력뿐만 아니라 시장도 반영됩니다.",
          "product": "Watchtower",
          "icon": "망루"
        }
      ],
      ...
      "outcomes": [
        {
          "title": "캠페인 내 예산 재할당",
          "description": "월말이 끝나기 전에 실적이 저조한 채널에서 지출을 이동하세요.",
          "icon": "속도"
        },
        {
        ...
        {
          "title": "합성되는 스택 채널",
          "description": "Cross-Intelligence는 어떤 채널 조합이 단독으로 작동하는지뿐만 아니라 어떤 채널 조합이 서로 증가하는지 보여줍니다.",
          "icon": "성능"
        },
        {
          "title": "시장 신호에 기반한 브랜드 개요",
          "description": "지난 달 지출뿐만 아니라 경쟁업체와 현지 시장이 무엇을 하고 있는지 파악하여 계획을 세웠습니다.",
          "icon": "지원하다"
        }
      ],
    ...
    "ja": {
      ...
      "problemsTitle": "マーケティング予算が漏れる場所",
      "problemsDescription": "ROI の到達は 1 週間遅れます。今月のデータが反映される前に、来月の計画が反映されます。",
      "challenges": [
        {
          "title": "ROIは支出後に得られる",
          "description": "アトリビューションはキャンペーンの翌週に表示されます。すでに次の計画を立てているんですね。",
          "icon": "マーケティング"
        },
        {
        ...
        {
          "title": "地元市場のシグナルは無視される",
          "description": "競合他社の価格設定、天候、イベントなど、ブランド概要には一切記載されていません。",
          "icon": "望楼"
        }
      ],
      "howTitle": "マーケティング リードにとってサンデーがどのように機能するか",
      ...
      "howSundaeHelps": [
        ...
        {
          "title": "ブリーフでの市場シグナル",
          "description": "競合他社のプロモーション、地元のイベント、天気など、すべてが朝の簡潔な情報にまとめられるため、キャンペーン計画はカレンダーだけでなく市場を反映します。",
          "product": "Watchtower",
          "icon": "望楼"
        }
      ],
      ...
      "outcomes": [
        {
          ...
          "description": "月が終わる前ではなく、パフォーマンスの低いチャネルから支出を移動します。",
          "icon": "速度"
        },
        {
        ...
        {
          "title": "複合的なスタックチャネル",
          "description": "クロスインテリジェンスは、どのチャネルが単独で機能するかだけでなく、どのチャネルの組み合わせが相互に作用するかを示します。",
          "icon": "パフォーマンス"
        },
        {
          "title": "市場シグナルに基づいたブランド概要",
          "description": "先月の支出だけでなく、競合他社や地元市場の動向を把握して計画を立てました。",
          "icon": "サポート"
        }
      ],
    ...
    "id": {
      ...
      "challenges": [
        {
          ...
          "description": "Atribusi diterima seminggu setelah kampanye. Anda sudah merencanakan yang berikutnya.",
          "icon": "pemasaran"
        },
        {
      ...
      "howTitle": "Bagaimana Sundae bekerja untuk prospek pemasaran",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Wawasan · Kinerja Pemasaran",
          "icon": "pemasaran"
        },
        {
          ...
          "product": "Wawasan · Pemasaran",
          "icon": "kinerja"
        },
        {
          "title": "Lintas Intelijen menemukan sinergi",
    ...
    "vi": {
      ...
      "problemsTitle": "Trường hợp ngân sách tiếp thị bị rò rỉ",
      "problemsDescription": "ROI hạ cánh muộn một tuần. Kế hoạch của tháng tới sẽ có trước khi có dữ liệu của tháng này.",
      "challenges": [
        {
          "title": "ROI đến sau khi chi tiêu",
          "description": "Ghi công sẽ diễn ra vào tuần sau chiến dịch. Bạn đã lên kế hoạch cho việc tiếp theo.",
          "icon": "tiếp thị"
        },
        {
        ...
        {
          "title": "Kết hợp kênh được quyết định theo bản năng",
          "description": "Lòng trung thành, mạng xã hội trả phí, tìm kiếm, email - sự kết hợp của tuần trước tiếp tục theo mặc định, không phải theo phân tích.",
          "icon": "hiệu suất"
        },
        {
          "title": "Tín hiệu thị trường địa phương bị bỏ qua",
          "description": "Giá cả của đối thủ cạnh tranh, thời tiết, sự kiện - không điều nào trong số đó xuất hiện trong bản tóm tắt thương hiệu.",
          "icon": "tháp canh"
        }
      ],
      "howTitle": "Sundae hoạt động như thế nào đối với các khách hàng tiềm năng tiếp thị",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Thông tin chuyên sâu · Hiệu suất tiếp thị",
          "icon": "tiếp thị"
        },
        {
          ...
          "product": "Thông tin chuyên sâu · Tiếp thị",
          "icon": "hiệu suất"
        },
        {
          "title": "Trí tuệ chéo tìm thấy sức mạnh tổng hợp",
      ...
      "outcomes": [
        ...
        {
          "title": "Xếp chồng các kênh kết hợp",
          "description": "Cross-Intelligence cho thấy sự kết hợp kênh nào sẽ nhân lên lẫn nhau - không chỉ hoạt động riêng lẻ.",
          "icon": "hiệu suất"
        },
        {
      ...
      "challenges": [
        {
          ...
          "description": "Atribuirea ajunge în săptămâna după campanie. Îl plănuiești deja pe următorul.",
          "icon": "marketing"
        },
        {
        ...
        {
          "title": "Semnalul pieței locale ignorat",
          "description": "Prețurile concurenței, vremea, evenimentele - nimic nu apare în brief-ul mărcii.",
          "icon": "turn de veghe"
        }
      ],
      "howTitle": "Cum funcționează Sundae pentru clienții potențiali de marketing",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Performanțe de marketing",
          "icon": "marketing"
        },
        {
      ...
      "outcomes": [
        {
          ...
          "description": "Mutați cheltuielile de pe canalul cu performanțe slabe înainte de închiderea lunii, nu după.",
          "icon": "viteza"
        },
        {
    ...
    "sv": {
      ...
      "problemsTitle": "Där marknadsföringsbudgeten läcker",
      "problemsDescription": "ROI landar en vecka för sent. Nästa månads plan går in innan månadens data gör det.",
      "challenges": [
        {
        ...
        {
          "title": "Lokal marknadssignal ignoreras",
          "description": "Konkurrentens priser, väder, evenemang - inget av det syns i varumärkesrapporten.",
          "icon": "vakttorn"
        }
      ],
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Insikter · Marknadsföringsprestanda",
          "icon": "marknadsföring"
        },
        {
          ...
          "product": "Insikter · Marknadsföring",
          "icon": "prestanda"
        },
        {
      ...
      "outcomes": [
        ...
        {
          "title": "Stapla kanaler som sammansätter",
          "description": "Cross-Intelligence visar vilka kanalkombinationer som multiplicerar varandra - inte bara vilka som fungerar ensamma.",
          "icon": "prestanda"
        },
        {
    ...
    "bn": {
      ...
      "problemsTitle": "যেখানে মার্কেটিং বাজেট ফাঁস হয়",
      "problemsDescription": "ROI এক সপ্তাহ দেরিতে ল্যান্ড করে। এই মাসের ডেটা আসার আগেই পরের মাসের প্ল্যান চলে যায়।",
      "challenges": [
        {
          "title": "ব্যয়ের পরে ROI আসে",
          "description": "প্রচারের পর সপ্তাহে অ্যাট্রিবিউশন আসে। আপনি ইতিমধ্যে পরবর্তী পরিকল্পনা করছেন.",
          "icon": "মার্কেটিং"
        },
        {
        ...
        {
          "title": "স্থানীয় বাজার সংকেত উপেক্ষা",
          "description": "প্রতিযোগী মূল্য, আবহাওয়া, ইভেন্ট - এর কোনটিই ব্র্যান্ড ব্রিফে দেখা যায় না।",
          "icon": "প্রহরী টাওয়ার"
        }
      ],
      "howTitle": "কিভাবে Sundae মার্কেটিং লিডের জন্য কাজ করে",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "অন্তর্দৃষ্টি · বিপণন কর্মক্ষমতা",
          "icon": "মার্কেটিং"
        },
        {
          ...
          "product": "অন্তর্দৃষ্টি · বিপণন",
          "icon": "কর্মক্ষমতা"
        },
        {
          "title": "ক্রস ইন্টেলিজেন্স সিনার্জি খুঁজে পায়",
          "description": "আনুগত্য + লাঞ্চ কম্বো 2.3× এ একা অনুসন্ধানে রূপান্তরিত হয়। ক্রস-ইনটেলিজেন্স এই পেয়ারিংগুলিকে সারফেস করে যাতে আপনি চ্যানেলগুলিকে স্ট্যাক করেন, সেগুলিকে সমান্তরালে না চালান৷",
          "product": "Cross-Intelligence",
          "icon": "বুদ্ধিমত্তা"
        },
        {
      ...
      "outcomes": [
        {
          ...
          "description": "মাস বন্ধ হওয়ার আগে কম পারফরমিং চ্যানেল বন্ধ করে দিন - পরে নয়।",
          "icon": "গতি"
        },
        {
        ...
        },
        {
          ...
          "description": "ক্রস-ইনটেলিজেন্স দেখায় কোন চ্যানেলের সংমিশ্রণগুলি একে অপরকে বহুগুণ করে — শুধুমাত্র কোনটি একা কাজ করে না।",
          "icon": "কর্মক্ষমতা"
        },
        {
    ...
    "th": {
      ...
      "problemsTitle": "ที่งบประมาณการตลาดรั่วไหล",
      "problemsDescription": "ROI ล่าช้าไปหนึ่งสัปดาห์ แผนของเดือนหน้าจะดำเนินการก่อนที่ข้อมูลของเดือนนี้จะเกิดขึ้น",
      "challenges": [
        {
          "title": "ROI จะมาถึงหลังจากการใช้จ่าย",
          "description": "การระบุแหล่งที่มาจะเกิดขึ้นในสัปดาห์หลังแคมเปญ คุณกำลังวางแผนครั้งต่อไปแล้ว",
          "icon": "การตลาด"
        },
        {
      ...
      "howTitle": "Sundae ทำงานอย่างไรเพื่อโอกาสในการขายทางการตลาด",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "ข้อมูลเชิงลึก · ประสิทธิภาพทางการตลาด",
          "icon": "การตลาด"
        },
        {
        ...
        {
          "title": "สัญญาณตลาดในช่วงสั้นๆ",
          "description": "การโปรโมตของคู่แข่ง กิจกรรมในท้องถิ่น สภาพอากาศ ทั้งหมดนี้สรุปในช่วงเช้า ดังนั้นแผนแคมเปญจึงสะท้อนถึงตลาด ไม่ใช่แค่ปฏิทิน",
          "product": "Watchtower",
          "icon": "หอสังเกตการณ์"
        }
      ],
      ...
      "outcomes": [
        ...
        {
          "title": "ซ้อนช่องที่ประกอบกัน",
          "description": "Cross-Intelligence แสดงให้เห็นว่าการรวมช่องสัญญาณใดจะทวีคูณซึ่งกันและกัน ไม่ใช่แค่ช่องใดที่ใช้งานได้เพียงอย่างเดียว",
          "icon": "ประสิทธิภาพการทำงาน"
        },
        {
    ...
    "ms": {
      ...
      "problemsTitle": "Di mana bajet pemasaran bocor",
      "problemsDescription": "ROI mendarat lewat seminggu. Pelan bulan depan masuk sebelum data bulan ini masuk.",
      "challenges": [
        {
          "title": "ROI tiba selepas perbelanjaan",
          "description": "Atribusi tiba seminggu selepas kempen. Anda sudah merancang yang seterusnya.",
          "icon": "pemasaran"
        },
        {
      ...
      "howTitle": "Cara Sundae berfungsi untuk petunjuk pemasaran",
      ...
      "howSundaeHelps": [
        {
          ...
          "product": "Wawasan · Prestasi Pemasaran",
          "icon": "pemasaran"
        },
        {
        ...
        {
          "title": "Kepintaran Silang mencari sinergi",
          "description": "Kombo kesetiaan + makan tengah hari bertukar pada 2.3× carian sahaja. Kepintaran Silang memaparkan gandingan ini supaya anda menyusun saluran, bukan menjalankannya secara selari.",
          "product": "Cross-Intelligence",
          "icon": "kecerdasan"
        },
        {
      ...
      "outcomes": [
        ...
        },
        {
          ...
          "description": "Kepintaran Silang menunjukkan gabungan saluran yang mendarab antara satu sama lain — bukan sahaja yang berfungsi secara bersendirian.",
          "icon": "prestasi"
        },
        {
