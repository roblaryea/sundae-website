  ...
  "localizedCopy": {
    "de": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "MARKT KONTEXT",
          "title": "Der Markt erklärt die Lücke.",
    ...
    "es": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "title": "La ubicación está $3,800 por debajo de lo pronosticado.",
          "body": "La mano de obra sigue en el nivel base, así que el margen se está erosionando cada hora."
        },
        {
          "shortLabel": "Contexto del mercado",
          "eyebrow": "CONTEXTO DEL MERCADO",
          "title": "El mercado explica la brecha.",
      ...
      "visualLabels": {
        ...
        "coach": "Sundae Coach",
        "coachBody": "Ajusta un turno de cocinero de 11 a 2 si la cobertura lo permite. Promociona el combo de almuerzo de $11.99 a través de la lealtad.",
        "coachProjection": "Impacto proyectado: recuperar parte de la brecha si se ejecuta antes del pico de almuerzo.",
    ...
    "nl": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLAN VS WERKELIJKE CIJFERS",
          "title": "De locatie ligt $3.800 achter op de prognose.",
          "body": "Het personeel is nog steeds op basisniveau, waardoor de marge elk uur afneemt."
        },
        {
          "shortLabel": "Marktcontext",
          "eyebrow": "MARKTCONTEXT",
          "title": "De markt verklaart de kloof.",
    ...
    "ar": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "الخطة مقابل الفعلي",
          "title": "الموقع متأخر بمقدار 3,800 دولار عن التوقعات.",
          "body": "لا يزال العمال يعملون وفقًا للحد الأدنى، لذا فإن الهامش يتآكل مع مرور الوقت."
        },
        {
          "shortLabel": "سياق السوق",
          "eyebrow": "سياق السوق",
          "title": "السوق يفسر الفجوة.",
      ...
      "visualLabels": {
        ...
        "forecast": "التوقعات",
        "actualRunRate": "معدل التشغيل الفعلي",
        "laborNote": "العمالة لا تزال على المستوى الأساسي - عدد الموظفين زائد لهذا الحجم.",
        "watchtower": "Watchtower",
    ...
    "fr": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PRÉVISIONS VS RÉEL",
          "title": "L'emplacement est en retard de 3 800 $ par rapport aux prévisions.",
          "body": "Le personnel est toujours à la base, donc la marge s'érode à chaque heure."
        },
        {
          "shortLabel": "Contexte du marché",
          "eyebrow": "CONTEXTE DU MARCHÉ",
          "title": "Le marché explique l'écart.",
    ...
    "pt": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLANEJADO VS REAL",
          "title": "A localização está $3,800 abaixo da previsão.",
          "body": "A equipe ainda está na linha de base, então a margem está se deteriorando a cada hora."
        },
        {
          "shortLabel": "Contexto de mercado",
          "eyebrow": "CONTEXTO DE MERCADO",
          "title": "O mercado explica a diferença.",
      ...
      "dimensions": [
        {
          "shortLabel": "क्या हुआ",
          "eyebrow": "क्या हुआ",
          "title": "कवर्स 22% नीचे हैं।",
          "body": "औसत चेक स्थिर है, इसलिए समस्या ट्रैफिक है - मूल्य निर्धारण नहीं।"
        },
        {
          "shortLabel": "योजना बनाम वास्तविकता",
          "eyebrow": "योजना बनाम वास्तविकता",
          "title": "स्थान पूर्वानुमान से $3,800 पीछे है।",
          "body": "श्रम अभी भी आधार स्तर पर है, इसलिए मार्जिन हर घंटे घट रहा है।"
        },
        {
          "shortLabel": "बाजार संदर्भ",
          "eyebrow": "बाजार संदर्भ",
          "title": "बाजार अंतर को स्पष्ट करता है।",
    ...
    "ur": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "منصوبہ بمقابلہ حقیقت",
          "title": "یہ مقام پیش گوئی سے $3,800 پیچھے ہے۔",
          "body": "مزدوری ابھی بھی بنیادی سطح پر ہے، لہذا مارجن ہر گھنٹے میں کم ہو رہا ہے۔"
        },
        {
          "shortLabel": "مارکیٹ کا سیاق و سباق",
          "eyebrow": "مارکیٹ کا سیاق و سباق",
          "title": "مارکیٹ فرق کی وضاحت کرتی ہے۔",
    ...
    "it": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PIANO VS REALE",
          "title": "La posizione è $3,800 sotto le previsioni.",
          "body": "Il personale è ancora al livello base, quindi il margine si sta erodendo di ora in ora."
        },
        {
          "shortLabel": "Contesto di mercato",
          "eyebrow": "CONTESTO DI MERCATO",
          "title": "Il mercato spiega il divario.",
    ...
    "pl": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLAN VS RZECZYWISTOŚĆ",
          "title": "Lokal jest o 3 800 USD poniżej prognozy.",
          "body": "Zatrudnienie wciąż jest na poziomie podstawowym, więc marża maleje z każdą godziną."
        },
        {
    ...
    "tr": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLAN VS GERÇEK",
          "title": "Konum, tahminin $3,800 gerisinde.",
          "body": "İş gücü hala temel seviyede, bu yüzden marj her saat eriyor."
        },
        {
          "shortLabel": "Pazar bağlamı",
          "eyebrow": "PAZAR BAĞLAMI",
          "title": "Pazar, farkı açıklıyor.",
    ...
    "zh-Hans": {
      ...
      "dimensions": [
        ...
        },
        {
          "shortLabel": "计划与实际",
          "eyebrow": "计划与实际",
          "title": "该地点落后于预测$3,800。",
          "body": "劳动力仍然维持在基线水平，因此利润率每小时都在下降。"
        },
        {
          "shortLabel": "市场背景",
          "eyebrow": "市场背景",
    ...
    "vi": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "KẾ HOẠCH SO VỚI THỰC TẾ",
          "title": "Địa điểm đang thiếu $3,800 so với dự báo.",
          "body": "Nhân sự vẫn được bố trí theo mức cơ bản, vì vậy biên lợi nhuận đang giảm dần theo giờ."
        },
        {
          "shortLabel": "Bối cảnh thị trường",
          "eyebrow": "BỐI CẢNH THỊ TRƯỜNG",
          "title": "Thị trường giải thích khoảng cách.",
    ...
    "id": {
      ...
      "dimensions": [
        ...
        {
          "shortLabel": "Konteks pasar",
          "eyebrow": "KONTEKS PASAR",
          "title": "Pasar menjelaskan kesenjangan.",
    ...
    "ja": {
      ...
      "visualLabels": {
        ...
        "coach": "Sundae Coach",
        "coachBody": "カバレッジが許す場合、11時から2時のラインクックシフトを1つ調整してください。$11.99のランチコンボをロイヤリティを通じてプッシュしてください。",
        "coachProjection": "予測される影響：ランチピーク前に実行すればギャップの一部を回復します。",
        "illustrative": "例示的"
      }
    },
    "ro": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLAN VS REALITATE",
          "title": "Locația este cu 3.800 $ sub prognoză.",
          "body": "Forța de muncă este încă la nivelul de bază, așa că marja se erodează cu fiecare oră."
        },
        {
          "shortLabel": "Context de piață",
          "eyebrow": "CONTEXT DE PIAȚĂ",
          "title": "Piața explică diferența.",
    ...
    "sv": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "PLAN VS VERKLIGHET",
          "title": "Platsen ligger $3,800 bakom prognosen.",
          "body": "Arbetskraften är fortfarande bemannad till baslinjen, så marginalen minskar varje timme."
        },
        {
          "shortLabel": "Marknadskontext",
          "eyebrow": "MARKNADSKONTEXT",
          "title": "Marknaden förklarar skillnaden.",
    ...
    "bn": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "পরিকল্পনা বনাম বাস্তব",
          "title": "অবস্থান পূর্বাভাসের থেকে $3,800 পিছিয়ে।",
          "body": "শ্রম এখনও বেসলাইনে রয়েছে, তাই মার্জিন প্রতি ঘণ্টায় কমছে।"
        },
        {
          "shortLabel": "বাজারের প্রেক্ষাপট",
          "eyebrow": "বাজারের প্রেক্ষাপট",
          "title": "বাজারটি ফাঁকটি ব্যাখ্যা করে।",
    ...
    "th": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "แผนกับจริง",
          "title": "สถานที่ขาดทุน $3,800 จากการคาดการณ์.",
          "body": "แรงงานยังคงอยู่ในระดับพื้นฐาน ดังนั้นกำไรจึงลดลงตามเวลา."
        },
        {
          "shortLabel": "บริบทตลาด",
          "eyebrow": "บริบทตลาด",
          "title": "ตลาดอธิบายช่องว่าง.",
    ...
    "ko": {
      ...
      "dimensions": [
        ...
        },
        {
          "shortLabel": "계획 vs 실제",
          "eyebrow": "계획 vs 실제",
          "title": "위치가 예측보다 $3,800 부족합니다.",
          "body": "인력은 여전히 기준에 맞춰 배치되어 있어 마진이 시간마다 줄어들고 있습니다."
        },
        {
          "shortLabel": "시장 맥락",
          "eyebrow": "시장 맥락",
      ...
      "visualLabels": {
        ...
        "forecast": "예측",
        "actualRunRate": "실제 실행률",
        "laborNote": "인력은 여전히 기준선에 있으며, 이 물량에 비해 과다 배치되었습니다.",
        "watchtower": "Watchtower",
        "watchtowerItem1": "어제 2km 이내의 3개 경쟁업체가 점심 콤보를 $9.99로 인하했습니다.",
        "watchtowerItem2": "사무실 타워 화재 훈련이 11시부터 12시까지 2블록 떨어진 곳에서 예정되어 있습니다.",
        "coach": "Sundae Coach",
        "coachBody": "커버가 가능하다면 11시부터 2시까지 한 명의 라인 요리사 교대를 조정하세요. 충성도를 통해 $11.99 점심 콤보를 홍보하세요.",
        "coachProjection": "예상 영향: 점심 피크 전에 실행하면 일부 격차를 회복할 수 있습니다.",
        "illustrative": "예시"
      }
    },
    "ms": {
      ...
      "dimensions": [
        ...
        },
        {
          ...
          "eyebrow": "RANCANGAN VS SEBENAR",
          "title": "Lokasi $3,800 di belakang ramalan.",
          "body": "Tenaga kerja masih di tahap asas, jadi margin semakin menipis setiap jam."
        },
        {
          "shortLabel": "Konteks pasaran",
          "eyebrow": "KONTEKS PASARAN",
          "title": "Pasaran menerangkan jurang.",
