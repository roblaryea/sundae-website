...
export const generatedLocalCopy = {
  "localizedCopy": {
    "fr": {
      ...
      "titleLine2": "Comme si vous étiez dans l'un d'entre eux.",
      "description": "Visibilité des équipes en direct sur chaque site. Pacing signale le point de vente qui a besoin de vous en ce moment. Pas d'attente pour le récapitulatif de vendredi.",
      ...
      "howDescription": "Une vue en direct de chaque équipe, de chaque serveur, de chaque point de vente.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 minutes. Vos emplacements. Le changement que vous auriez géré différemment.",
      "ctaButton": "Réservez une visite régionale"
    },
    "ar": {
      "badge": "للمديرين الإقليميين ومديري المناطق",
      "titleLine1": "تشغيل اثني عشر منفذا.",
      "titleLine2": "كأنك واقف في واحدة.",
      "description": "رؤية التحول المباشر عبر كل موقع. تشير السرعة إلى المنفذ الذي يحتاجك الآن. لا تنتظر خلاصة الجمعة.",
      ...
      "howDescription": "عرض مباشر واحد لكل وردية، وكل خادم، وكل منفذ.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 دقيقة. المواقع الخاصة بك. التحول الذي كنت ستتعامل معه بشكل مختلف.",
    ...
    "es": {
      ...
      "howDescription": "Una vista en vivo de cada turno, cada servidor, cada punto de venta.",
      "howSundaeHelps": [
        {
    ...
    "nl": {
      ...
      "titleLine1": "Voer twaalf verkooppunten uit.",
      "titleLine2": "Alsof je er in staat.",
      "description": "Live ploegzicht op elke locatie. Pacing markeert het stopcontact dat je nu nodig heeft. Je hoeft niet te wachten op de samenvatting van vrijdag.",
      ...
      "howDescription": "Eén liveweergave van elke dienst, elke server, elk stopcontact.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 minuten. Uw locaties. De dienst die je anders zou hebben aangepakt.",
      "ctaButton": "Boek een Regionale Walk-through"
    },
    "pt": {
      "badge": "Para gerentes regionais e de área",
      "titleLine1": "Execute doze pontos de venda.",
      "titleLine2": "Como se você estivesse em um.",
      "description": "Visibilidade do turno ao vivo em todos os locais. O ritmo sinaliza a saída que precisa de você agora. Não há espera pela recapitulação de sexta-feira.",
      "primaryCta": "Agende um passeio regional",
      "secondaryCta": "Veja a demonstração de operações",
      "problemsEyebrow": "O QUE TE RETIRA",
      ...
      "howDescription": "Uma visualização ao vivo de cada turno, cada servidor, cada ponto de venda.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 minutos. Suas localizações. A mudança que você teria tratado de forma diferente.",
      "ctaButton": "Agende um passeio regional"
    },
    "de": {
      "badge": "Für Regional- und Gebietsmanager",
      "titleLine1": "Betreiben Sie zwölf Filialen.",
      "titleLine2": "Als stünde man in einem.",
      "description": "Live-Schichttransparenz an jedem Standort. Pacing markiert die Steckdose, die Sie gerade braucht. Kein Warten auf die Zusammenfassung vom Freitag.",
      ...
      "howDescription": "Eine Live-Ansicht jeder Schicht, jedes Servers, jeder Filiale.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 Minuten. Ihre Standorte. Die Schicht hättest du anders gehandhabt.",
      "ctaButton": "Buchen Sie einen regionalen Rundgang"
    },
    "ur": {
      "badge": "علاقائی اور ایریا مینیجرز کے لیے",
      "titleLine1": "بارہ آؤٹ لیٹس چلائیں۔",
      "titleLine2": "جیسے آپ ایک میں کھڑے ہیں۔",
      "description": "ہر جگہ پر لائیو شفٹ کی مرئیت۔ پیسنگ اس آؤٹ لیٹ کو جھنڈا دیتی ہے جس کی ابھی آپ کو ضرورت ہے۔ جمعہ کی تکرار کا انتظار نہیں۔",
      ...
      "howDescription": "ہر شفٹ، ہر سرور، ہر آؤٹ لیٹ کا ایک لائیو منظر۔",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 منٹ آپ کے مقامات۔ جس شفٹ کو آپ نے مختلف طریقے سے سنبھالا ہوگا۔",
      "ctaButton": "ریجنل واک تھرو بک کریں۔"
    },
    "hi": {
      "badge": "क्षेत्रीय एवं क्षेत्रीय प्रबंधकों के लिए",
      "titleLine1": "बारह आउटलेट चलाएँ.",
      "titleLine2": "जैसे आप एक में खड़े हों.",
      "description": "हर स्थान पर लाइव शिफ्ट दृश्यता। पेसिंग उस आउटलेट को चिह्नित करता है जिसे अभी आपकी आवश्यकता है। शुक्रवार के पुनर्कथन का इंतज़ार नहीं।",
    ...
    "it": {
      ...
      "description": "Visibilità dei turni in tempo reale in ogni sede. Il ritmo segnala lo sbocco che ha bisogno di te in questo momento. Nessuna attesa per il riepilogo di venerdì.",
      ...
      "howDescription": "Una visione dal vivo di ogni turno, ogni server, ogni punto vendita.",
      "howSundaeHelps": [
        {
    ...
    "zh-Hans": {
      "badge": "对于区域和区域经理",
      "titleLine1": "经营十二家分店。",
      "titleLine2": "就像你站在其中一样。",
      "description": "每个位置的实时班次可见性。节奏标记了现在需要您的出口。无需等待周五回顾。",
      "primaryCta": "预约区域巡查",
      "secondaryCta": "查看操作演示",
      ...
      "ctaDescription": "30分钟。您的位置。你会以不同的方式处理这种转变。",
      "ctaButton": "预约区域巡查"
    },
    "pl": {
      "badge": "Dla menedżerów regionalnych i lokalnych",
      "titleLine1": "Prowadzić dwanaście placówek.",
      "titleLine2": "Jakbyś w jednym stał.",
      "description": "Widoczność zmiany na żywo w każdej lokalizacji. Pacing oznacza punkt sprzedaży, który Cię teraz potrzebuje. Nie trzeba czekać na piątkowe podsumowanie.",
      ...
      "howDescription": "Jeden podgląd na żywo każdej zmiany, każdego serwera i każdego gniazdka.",
      "howSundaeHelps": [
        {
    ...
    "tr": {
      ...
      "titleLine1": "On iki satış noktasını çalıştırın.",
      "titleLine2": "Sanki birinde duruyormuşsun gibi.",
      "description": "Her lokasyonda canlı vardiya görünürlüğü. Pacing, şu anda size ihtiyacı olan çıkışı işaretler. Cuma özetini beklemenize gerek yok.",
      ...
      "howDescription": "Her vardiyanın, her sunucunun, her satış noktasının canlı görüntüsü.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 dakika. Konumlarınız. Sizin farklı şekilde ele alacağınız değişim.",
      "ctaButton": "Bölgesel İnceleme Rezervasyonu Yapın"
    },
    "ko": {
      "badge": "지역 및 지역 관리자용",
      "titleLine1": "12개의 매장을 운영하세요.",
      "titleLine2": "당신이 하나에 서있는 것처럼.",
      "description": "모든 위치에서 실시간 교대근무 가시성을 제공합니다. 페이싱은 지금 당장 필요한 콘센트를 표시합니다. 금요일 요약을 기다리지 마세요.",
      ...
      "ctaDescription": "30분. 귀하의 위치. 당신이 다르게 처리했을 교대 근무.",
      "ctaButton": "지역별 체험 예약"
    },
    "id": {
      ...
      "description": "Visibilitas shift langsung di setiap lokasi. Mondar-mandir menandai outlet yang membutuhkan Anda saat ini. Tidak perlu menunggu rekap hari Jumat.",
      ...
      "howDescription": "Satu tayangan langsung setiap shift, setiap server, setiap outlet.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 menit. Lokasi Anda. Pergeseran yang akan Anda tangani secara berbeda.",
      "ctaButton": "Pesan Walk-through Regional"
    },
    "ja": {
      "badge": "地域およびエリアマネージャー向け",
      "titleLine1": "12店舗を運営。",
      "titleLine2": "まるでひとつに立っているような。",
      "description": "あらゆる場所でのライブシフトの可視性。ペーシングは、今あなたを必要としているアウトレットにフラグを立てます。金曜日の総括を待つ必要はありません。",
    ...
    "vi": {
      "badge": "Dành cho người quản lý khu vực và khu vực",
      "titleLine1": "Chạy mười hai cửa hàng.",
      "titleLine2": "Giống như bạn đang đứng trong một.",
      "description": "Khả năng hiển thị ca trực tiếp trên mọi địa điểm. Nhịp độ đánh dấu lối thoát cần bạn ngay bây giờ. Không cần chờ đợi bản tóm tắt thứ Sáu.",
      ...
      "howDescription": "Một chế độ xem trực tiếp về mọi ca, mọi máy chủ, mọi cửa hàng.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 phút. Vị trí của bạn. Sự thay đổi mà bạn sẽ xử lý khác nhau.",
      "ctaButton": "Đặt chuyến tham quan khu vực"
    },
    "bn": {
      "badge": "আঞ্চলিক ও এরিয়া ম্যানেজারদের জন্য",
      "titleLine1": "বারোটি আউটলেট চালান।",
      "titleLine2": "যেন আপনি এক জায়গায় দাঁড়িয়ে আছেন।",
      "description": "প্রতিটি অবস্থান জুড়ে লাইভ শিফট দৃশ্যমানতা। পেসিং সেই আউটলেটটিকে পতাকা দেয় যা এই মুহূর্তে আপনার প্রয়োজন। শুক্রবার রিক্যাপের জন্য অপেক্ষা করা নেই।",
      ...
      "problemsDescription": "অনেক সাইট, পর্যাপ্ত সময় না, অনেক তথ্য পরে সত্য.",
      "challenges": [
        {
      ...
      "howDescription": "প্রতিটি শিফট, প্রতিটি সার্ভার, প্রতিটি আউটলেটের একটি লাইভ ভিউ।",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 মিনিট আপনার অবস্থান. যে শিফটটি আপনি অন্যভাবে পরিচালনা করতেন।",
      "ctaButton": "একটি আঞ্চলিক ওয়াক-থ্রু বুক করুন"
    },
    "ro": {
      "badge": "Pentru managerii regionali și de zonă",
      "titleLine1": "Conduceți douăsprezece prize.",
      "titleLine2": "De parcă ai sta într-una.",
      "description": "Vizibilitate live în schimburi în fiecare locație. Pacing semnalează priza care are nevoie de tine chiar acum. Fără așteptări pentru recapitularea de vineri.",
      "primaryCta": "Rezervați o prezentare regională",
      "secondaryCta": "Vedeți demonstrația operațiunilor",
      "problemsEyebrow": "CE TE ÎNTINEȘTE",
      ...
      "howDescription": "O vizualizare live pentru fiecare schimb, fiecare server, fiecare priză.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 de minute. Locațiile dvs. Schimbarea pe care ai fi gestionat-o altfel.",
      "ctaButton": "Rezervați o prezentare regională"
    },
    "sv": {
      "badge": "För region- och områdeschefer",
      "titleLine1": "Kör tolv uttag.",
      "titleLine2": "Som att du står i ett.",
      "description": "Live-skiftsynlighet över alla platser. Pacing flaggar uttaget som behöver dig just nu. Ingen väntan på fredagens sammanfattning.",
      "primaryCta": "Boka en regional genomgång",
      "secondaryCta": "Se Ops Demo",
      "problemsEyebrow": "VAD STRÄMMER DIG",
      ...
      "howDescription": "En livevy av varje skift, varje server, varje uttag.",
      "howSundaeHelps": [
        {
    ...
    "ms": {
      ...
      "description": "Keterlihatan peralihan langsung merentasi setiap lokasi. Pacing menandakan kedai yang memerlukan anda sekarang. Tidak perlu menunggu ulangan Jumaat.",
      ...
      "howDescription": "Satu paparan langsung setiap syif, setiap pelayan, setiap saluran keluar.",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 minit. Lokasi anda. Peralihan yang anda akan kendalikan secara berbeza.",
      "ctaButton": "Tempah Walk-through Serantau"
    },
    "th": {
      "badge": "สำหรับผู้จัดการระดับภูมิภาคและระดับพื้นที่",
      "titleLine1": "วิ่งสิบสองสาขา",
      "titleLine2": "เหมือนคุณกำลังยืนอยู่ในที่เดียว",
      "description": "การมองเห็นกะสดทั่วทุกสถานที่ Pacing ส่งสัญญาณถึงร้านที่ต้องการคุณในตอนนี้ ไม่ต้องรอสรุปวันศุกร์",
      ...
      "howDescription": "มุมมองสดเดียวของทุกกะ ทุกเซิร์ฟเวอร์ ทุกร้าน",
      "howSundaeHelps": [
        {
      ...
      "ctaDescription": "30 นาที สถานที่ของคุณ การเปลี่ยนแปลงที่คุณจะจัดการแตกต่างออกไป",
