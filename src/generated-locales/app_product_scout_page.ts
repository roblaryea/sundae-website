// Generated website local copy overrides for src/app/product/scout/page.tsx.
...
export const generatedLocalCopy = {
  "localizedScoutCopy": {
    ...
    "fr": {
      ...
      "integrationsDescription": "La plupart des intégrations prennent moins de 5 minutes. Clé OAuth ou API : authentifiez-vous et c'est parti.",
      "integrations": [
        {
      ...
      "steps": [
        ...
        },
        {
          "step": "2",
          "title": "Normaliser",
          "description": "Scout mappe chaque source de données sur un schéma cohérent, nettoie les incohérences et comble automatiquement les lacunes."
        },
        {
          "step": "3",
          "title": "Analyser",
          "description": "Les données unifiées circulent dans des tableaux de bord, des alertes et des recommandations. Pas d'exportation, pas de saisie manuelle."
        }
      ],
      "ctaTitle": "Arrêtez d'exporter. Commencez à vous connecter.",
      "ctaDescription": "Découvrez comment Scout unifie les données de votre restaurant dans une seule démo.",
      "ctaPrimary": "Réservez une démo",
      "ctaSecondary": "Voir tous les produits"
    },
    "pt": {
      "heroBadge": "Scout - Camada de Dados",
      ...
      "integrationsDescription": "A maioria das integrações leva menos de 5 minutos. Chave OAuth ou API - autentique e pronto.",
      "integrations": [
        {
      ...
      "steps": [
        ...
        },
        {
          "step": "2",
          "title": "Normalizar",
          "description": "O Scout mapeia cada fonte de dados para um esquema consistente, limpa inconsistências e preenche lacunas automaticamente."
        },
        {
          "step": "3",
          "title": "Analisar",
          "description": "Os dados unificados fluem para painéis, alertas e recomendações. Sem exportações, sem entrada manual."
        }
      ],
      "ctaTitle": "Pare de exportar. Comece a conectar.",
      "ctaDescription": "Veja como o Scout unifica os dados do seu restaurante em uma única demonstração.",
    ...
    "nl": {
      ...
      "featuresHeading": "Wat Scout doet",
      ...
      "integrationsDescription": "De meeste integraties duren minder dan 5 minuten. OAuth of API-sleutel - authenticeer en ga aan de slag.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Authenticeren",
          "description": "Verbind uw platforms met OAuth of API-sleutel. De meeste integraties duren minder dan 5 minuten - er is geen engineering vereist."
        },
        {
          "step": "2",
          "title": "Normaliseren",
          "description": "Scout wijst elke gegevensbron toe aan een consistent schema, ruimt inconsistenties op en vult gaten automatisch op."
        },
        {
          "step": "3",
          "title": "Analyseer",
          "description": "Uniforme gegevens stromen naar dashboards, waarschuwingen en aanbevelingen. Geen export, geen handmatige invoer."
        }
      ],
      "ctaTitle": "Stop met exporteren. Begin met verbinden.",
      "ctaDescription": "Bekijk hoe Scout uw restaurantgegevens samenbrengt in één demo.",
    ...
    "de": {
      ...
      "steps": [
        ...
        },
        {
          "step": "2",
          "title": "Normalisieren",
          "description": "Scout ordnet jede Datenquelle einem konsistenten Schema zu, bereinigt Inkonsistenzen und füllt Lücken automatisch."
        },
        {
          "step": "3",
          "title": "Analysieren",
          "description": "Einheitliche Daten fließen in Dashboards, Warnungen und Empfehlungen. Keine Exporte, keine manuelle Eingabe."
        }
      ],
      "ctaTitle": "Stoppen Sie den Export. Beginnen Sie mit der Verbindung.",
      "ctaDescription": "Sehen Sie, wie Scout Ihre Restaurantdaten in einer einzigen Demo vereinheitlicht.",
    ...
    "es": {
      ...
      "ctaDescription": "Vea cómo Scout unifica los datos de su restaurante en una sola demostración.",
    ...
    "ur": {
      ...
      "integrationsDescription": "زیادہ تر انضمام میں 5 منٹ سے کم وقت لگتا ہے۔ OAuth یا API کلید - تصدیق کریں اور جائیں۔",
      "integrations": [
        {
    ...
    "it": {
      ...
      "integrationsDescription": "La maggior parte delle integrazioni richiedono meno di 5 minuti. OAuth o chiave API: autenticati e vai.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Autenticarsi",
          "description": "Connetti le tue piattaforme con OAuth o chiave API. La maggior parte delle integrazioni richiedono meno di 5 minuti e non è richiesta alcuna attività di ingegneria."
        },
        {
          "step": "2",
          "title": "Normalizzare",
          "description": "Scout associa ogni origine dati a uno schema coerente, elimina le incoerenze e colma automaticamente le lacune."
        },
        {
          "step": "3",
          "title": "Analizzare",
          "description": "I dati unificati confluiscono in dashboard, avvisi e consigli. Nessuna esportazione, nessun inserimento manuale."
        }
      ],
      "ctaTitle": "Interrompi l'esportazione. Inizia a connetterti.",
      "ctaDescription": "Scopri come Scout unifica i dati del tuo ristorante in un'unica demo.",
      ...
      "steps": [
        {
          "step": "1",
          "title": "प्रमाणित करें",
          "description": "अपने प्लेटफ़ॉर्म को OAuth या API कुंजी से कनेक्ट करें। अधिकांश एकीकरणों में 5 मिनट से कम समय लगता है - किसी इंजीनियरिंग की आवश्यकता नहीं है।"
        },
        {
          "step": "2",
          "title": "सामान्य करें",
    ...
    "tr": {
      ...
      "featuresHeading": "Scout Ne Yapar?",
      ...
      "integrationsDescription": "Entegrasyonların çoğu 5 dakikadan az sürer. OAuth veya API anahtarı - kimlik doğrulaması yapın ve devam edin.",
      "integrations": [
        {
      ...
      "steps": [
        {
          ...
          "description": "Platformlarınızı OAuth veya API anahtarıyla bağlayın. Entegrasyonların çoğu 5 dakikadan kısa sürer; mühendislik gerektirmez."
        },
        {
          "step": "2",
          "title": "Normalleştir",
          "description": "Scout, her veri kaynağını tutarlı bir şemayla eşler, tutarsızlıkları temizler ve boşlukları otomatik olarak doldurur."
        },
        {
          "step": "3",
          "title": "Analiz et",
          "description": "Birleştirilmiş veriler kontrol panellerine, uyarılara ve önerilere akar. Dışa aktarma yok, manuel giriş yok."
        }
      ],
      "ctaTitle": "Dışa Aktarmayı Durdurun. Bağlanmaya Başlayın.",
      "ctaDescription": "Scout'un restoran verilerinizi tek bir demoda nasıl birleştirdiğini görün.",
    ...
    "zh-Hans": {
      ...
      "integrationsDescription": "大多数集成只需不到 5 分钟。 OAuth 或 API 密钥 - 进行身份验证并开始。",
      "integrations": [
        {
          "category": "销售点",
          "systems": [
      ...
      "steps": [
        {
          "step": "1",
          "title": "认证",
          "description": "使用 OAuth 或 API 密钥连接您的平台。大多数集成只需不到 5 分钟 - 无需进行任何工程设计。"
        },
        {
          "step": "2",
          "title": "标准化",
          "description": "Scout 将每个数据源映射到一致的架构、清除不一致并自动填补空白。"
        },
        {
          "step": "3",
          "title": "分析",
          "description": "统一的数据流入仪表板、警报和建议。无需导出，无需手动输入。"
        }
      ],
      "ctaTitle": "停止导出。开始连接。",
      "ctaDescription": "了解 Scout 如何在单个演示中统一您的餐厅数据。",
      "ctaPrimary": "预订演示",
      "ctaSecondary": "查看所有产品"
    },
    "pl": {
      ...
      "integrationsDescription": "Większość integracji zajmuje mniej niż 5 minut. Klucz OAuth lub API - uwierzytelnij się i gotowe.",
      "integrations": [
        {
      ...
      "steps": [
        ...
        },
        {
          "step": "2",
          "title": "Normalizuj",
          "description": "Scout mapuje każde źródło danych na spójny schemat, usuwa niespójności i automatycznie uzupełnia luki."
        },
        {
          "step": "3",
          "title": "Analizuj",
          "description": "Ujednolicone dane przepływają do pulpitów nawigacyjnych, alertów i rekomendacji. Żadnego eksportu, żadnego ręcznego wprowadzania."
        }
      ],
      "ctaTitle": "Zatrzymaj eksport. Rozpocznij łączenie.",
      "ctaDescription": "Zobacz, jak Scout ujednolica dane dotyczące Twojej restauracji w jednej wersji demonstracyjnej.",
    ...
    "ja": {
      ...
      "integrationsDescription": "ほとんどの統合には 5 分もかかりません。 OAuth または API キー - 認証して実行します。",
      "integrations": [
        {
          "category": "販売時点管理",
          "systems": [
      ...
      "steps": [
        {
          "step": "1",
          "title": "認証する",
          "description": "OAuth または API キーを使用してプラットフォームを接続します。ほとんどの統合は 5 分以内に完了し、エンジニアリングは必要ありません。"
        },
        {
          "step": "2",
          "title": "正規化",
          "description": "Scout は、すべてのデータ ソースを一貫したスキーマにマッピングし、不一致を解消し、ギャップを自動的に埋めます。"
        },
        {
          "step": "3",
          "title": "分析する",
          "description": "統合されたデータは、ダッシュボード、アラート、推奨事項に流れます。エクスポートや手動入力はありません。"
        }
      ],
      "ctaTitle": "エクスポートを停止します。接続を開始します。",
      "ctaDescription": "Scout がレストラン データを 1 つのデモでどのように統合するかをご覧ください。",
      "ctaPrimary": "デモを予約する",
    ...
    "id": {
      ...
      "integrationsDescription": "Sebagian besar integrasi membutuhkan waktu kurang dari 5 menit. Kunci OAuth atau API - autentikasi dan lanjutkan.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Otentikasi",
          "description": "Hubungkan platform Anda dengan OAuth atau kunci API. Sebagian besar integrasi memerlukan waktu kurang dari 5 menit - tidak diperlukan rekayasa."
        },
        {
          "step": "2",
          "title": "Normalisasi",
          "description": "Scout memetakan setiap sumber data ke skema yang konsisten, membersihkan inkonsistensi, dan mengisi kesenjangan secara otomatis."
        },
        {
          "step": "3",
          "title": "Analisis",
          "description": "Data terpadu mengalir ke dasbor, peringatan, dan rekomendasi. Tidak ada ekspor, tidak ada entri manual."
        }
      ],
      "ctaTitle": "Berhenti Mengekspor. Mulai Menghubungkan.",
      "ctaDescription": "Lihat bagaimana Scout menyatukan data restoran Anda dalam satu demo.",
      ...
      "steps": [
        {
          "step": "1",
          "title": "인증하다",
          "description": "OAuth 또는 API 키를 사용하여 플랫폼을 연결하세요. 대부분의 통합은 5분 이내에 완료되며 엔지니어링이 필요하지 않습니다."
        },
        {
          "step": "2",
          "title": "정규화",
          "description": "Scout는 모든 데이터 소스를 일관된 스키마에 매핑하고, 불일치를 정리하고, 공백을 자동으로 채웁니다."
        },
        {
          "step": "3",
          "title": "분석하다",
          "description": "통합된 데이터는 대시보드, 경고, 권장 사항으로 흘러갑니다. 내보내기도, 수동 입력도 없습니다."
        }
      ],
      "ctaTitle": "내보내기를 중지합니다. 연결을 시작하세요.",
      "ctaDescription": "Scout가 단일 데모로 레스토랑 데이터를 통합하는 방법을 알아보세요.",
      "ctaPrimary": "데모 예약",
    ...
    "ro": {
      ...
      "integrationsDescription": "Majoritatea integrărilor durează mai puțin de 5 minute. OAuth sau cheie API - autentificați-vă și mergeți.",
      "integrations": [
        {
      ...
      "steps": [
        {
          ...
          "description": "Conectați-vă platformele cu OAuth sau cheie API. Majoritatea integrărilor durează mai puțin de 5 minute - nu necesită inginerie."
        },
        {
          "step": "2",
          "title": "Normalizați",
          "description": "Scout mapează fiecare sursă de date la o schemă consecventă, curăță inconsecvențele și completează automat golurile."
        },
        {
          "step": "3",
          "title": "Analizează",
      ...
      "ctaTitle": "Opriți exportul. Începeți conectarea.",
      "ctaDescription": "Vedeți cum Scout unifică datele restaurantelor dvs. într-o singură demonstrație.",
    ...
    "vi": {
      ...
      "integrationsDescription": "Hầu hết các quá trình tích hợp chỉ mất dưới 5 phút. Khóa OAuth hoặc API - xác thực và đi.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Xác thực",
          "description": "Kết nối nền tảng của bạn với khóa OAuth hoặc API. Hầu hết quá trình tích hợp chỉ mất dưới 5 phút - không yêu cầu kỹ thuật."
        },
        {
          "step": "2",
        ...
        },
        {
          "step": "3",
          "title": "Phân tích",
          "description": "Dữ liệu hợp nhất chảy vào trang tổng quan, cảnh báo và đề xuất. Không xuất, không nhập thủ công."
        }
      ],
      "ctaTitle": "Dừng xuất khẩu. Bắt đầu kết nối.",
      "ctaDescription": "Xem cách Scout thống nhất dữ liệu nhà hàng của bạn trong một bản demo duy nhất.",
    ...
    "sv": {
      ...
      "integrationsDescription": "De flesta integrationer tar under 5 minuter. OAuth- eller API-nyckel - autentisera och gå.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Autentisera",
          "description": "Anslut dina plattformar med OAuth- eller API-nyckel. De flesta integrationer tar under 5 minuter - ingen teknik krävs."
        },
        {
          "step": "2",
          "title": "Normalisera",
          "description": "Scout mappar varje datakälla till ett konsekvent schema, rensar inkonsekvenser och fyller luckor automatiskt."
        },
        {
          "step": "3",
          "title": "Analysera",
          "description": "Enhetlig data flödar till instrumentpaneler, varningar och rekommendationer. Inga exporter, ingen manuell inmatning."
        }
      ],
      "ctaTitle": "Sluta exportera. Börja ansluta.",
      "ctaDescription": "Se hur Scout förenar din restaurangdata i en enda demo.",
      ...
      "steps": [
        {
          "step": "1",
          "title": "প্রমাণীকরণ",
          "description": "OAuth বা API কী দিয়ে আপনার প্ল্যাটফর্মগুলিকে সংযুক্ত করুন৷ বেশিরভাগ ইন্টিগ্রেশনে 5 মিনিটের কম সময় লাগে - কোন ইঞ্জিনিয়ারিং এর প্রয়োজন নেই।"
        },
        {
          "step": "2",
          "title": "স্বাভাবিক করা",
        ...
        },
        {
          "step": "3",
          "title": "বিশ্লেষণ করুন",
          "description": "ইউনিফাইড ডেটা ড্যাশবোর্ড, সতর্কতা এবং সুপারিশগুলিতে প্রবাহিত হয়। কোন রপ্তানি, কোন ম্যানুয়াল এন্ট্রি."
        }
      ],
      "ctaTitle": "রপ্তানি বন্ধ করুন। সংযোগ করা শুরু করুন।",
      "ctaDescription": "দেখুন কিভাবে Scout আপনার রেস্টুরেন্টের ডেটা একক ডেমোতে একত্রিত করে।",
    ...
    "th": {
      ...
      "integrationsDescription": "การรวมระบบส่วนใหญ่ใช้เวลาไม่เกิน 5 นาที คีย์ OAuth หรือ API - ตรวจสอบสิทธิ์และไป",
      "integrations": [
        {
          "category": "จุดขาย",
          "systems": [
      ...
      "steps": [
        {
          "step": "1",
          "title": "ตรวจสอบสิทธิ์",
          "description": "เชื่อมต่อแพลตฟอร์มของคุณด้วยคีย์ OAuth หรือ API การรวมระบบส่วนใหญ่ใช้เวลาไม่เกิน 5 นาที - ไม่ต้องใช้วิศวกรรม"
        },
        {
          "step": "2",
          "title": "ทำให้เป็นมาตรฐาน",
          "description": "Scout แมปทุกแหล่งข้อมูลเข้ากับสคีมาที่สอดคล้องกัน ทำความสะอาดความไม่สอดคล้องกัน และเติมช่องว่างโดยอัตโนมัติ"
        },
        {
          "step": "3",
          "title": "วิเคราะห์",
          "description": "ข้อมูลแบบรวมจะไหลเข้าสู่แดชบอร์ด การแจ้งเตือน และคำแนะนำ ไม่มีการส่งออก ไม่มีการป้อนข้อมูลด้วยตนเอง"
        }
      ],
      "ctaTitle": "หยุดการส่งออก เริ่มการเชื่อมต่อ",
      "ctaDescription": "ดูว่า Scout รวมข้อมูลร้านอาหารของคุณในการสาธิตเพียงครั้งเดียวได้อย่างไร",
    ...
    "ms": {
      ...
      "integrationsDescription": "Kebanyakan penyepaduan mengambil masa kurang dari 5 minit. Kunci OAuth atau API - sahkan dan pergi.",
      "integrations": [
        {
      ...
      "steps": [
        {
          "step": "1",
          "title": "Sahkan",
          "description": "Sambungkan platform anda dengan kunci OAuth atau API. Kebanyakan penyepaduan mengambil masa di bawah 5 minit - tiada kejuruteraan diperlukan."
        },
        {
          "step": "2",
          "title": "normalkan",
        ...
        },
        {
          "step": "3",
          "title": "Menganalisis",
          "description": "Data bersatu mengalir ke papan pemuka, makluman dan pengesyoran. Tiada eksport, tiada kemasukan manual."
        }
      ],
      "ctaTitle": "Berhenti Mengeksport. Mula Menyambung.",
      "ctaDescription": "Lihat cara Scout menyatukan data restoran anda dalam satu demo.",
