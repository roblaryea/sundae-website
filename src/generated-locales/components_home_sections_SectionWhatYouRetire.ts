...
export const generatedLocalCopy = {
  "localizedCopy": {
    "de": {
      ...
      "todaysStack": [
        "Power BI / Tableau / Looker-Dashboards auf POS-Exporten",
        "Handgepflegte Tabellen, die das Team nie öffnet",
        "Eigene Analysten-Warteschlange für tägliche Fragen",
        "Sechs Lieferantenportale gleichzeitig geöffnet",
    ...
    "nl": {
      ...
      "todaysStack": [
        "Power BI / Tableau / Looker-dashboards op POS-exports",
        "Handgemaakte spreadsheets die het team nooit opent",
        "Een eigen analistenwachtrij voor dagelijkse vragen",
    ...
    "ar": {
      ...
      "todaysStack": [
        "لوحات معلومات Power BI / Tableau / Looker تعتمد على تصديرات POS",
        "جداول بيانات مُعدّة يدويًا لا يفتحها الفريق",
        "طابور محلّلين مخصّص للأسئلة اليومية",
        "ستة بوابات موردين مفتوحة في آنٍ واحد",
    ...
    "pt": {
      ...
      "todaysStack": [
        "Dashboards do Power BI / Tableau / Looker sobre exportações do POS",
        "Planilhas feitas à mão que a equipe nunca abre",
        "Fila de analistas dedicada para perguntas do dia a dia",
    ...
    "fr": {
      ...
      "todaysStack": [
        "Tableaux de bord Power BI / Tableau / Looker sur des exports POS",
        "Des tableurs faits à la main que l'équipe n'ouvre jamais",
        "Une file d'attente d'analystes dédiée aux questions quotidiennes",
    ...
    "es": {
      ...
      "todaysStack": [
        "Dashboards de Power BI / Tableau / Looker sobre exportaciones del POS",
        "Hojas de cálculo hechas a mano que el equipo nunca abre",
        "Una cola de analistas dedicada a las preguntas del día a día",
    ...
    "hi": {
      ...
      "todaysStack": [
        ...
        "हाथ से बनाई गई स्प्रेडशीट्स जिन्हें टीम कभी नहीं खोलती",
        "रोज़मर्रा के सवालों के लिए समर्पित विश्लेषक कतार",
        "एक साथ खुले छह वेंडर पोर्टल",
    ...
    "ur": {
      ...
      "todaysStack": [
        "POS ایکسپورٹس پر Power BI / Tableau / Looker ڈیش بورڈز",
        "ہاتھ سے بنائی گئی اسپریڈشیٹس جو ٹیم کبھی نہیں کھولتی",
        "روزمرہ سوالات کے لیے مخصوص تجزیہ کاروں کی قطار",
        "بیک وقت کھلے چھ وینڈر پورٹلز",
    ...
    "it": {
      ...
      "withSundaeLabel": "Con Sundae",
      "todaysStack": [
        "Dashboard Power BI / Tableau / Looker basate su esportazioni POS",
        "Fogli di calcolo creati a mano che il team non apre mai",
        "Una coda di analisti dedicata alle domande quotidiane",
    ...
    "zh-Hans": {
      ...
      "todaysStack": [
        "基于 POS 导出数据的 Power BI / Tableau / Looker 仪表板",
        "团队从不打开的手工电子表格",
        "为日常问题专设的分析师排队队列",
        "同时打开的六个供应商门户",
        "每周复盘会议，而非实时行动"
    ...
    "pl": {
      ...
      "todaysStack": [
        "Pulpity Power BI / Tableau / Looker oparte na eksportach z POS",
        "Ręcznie tworzone arkusze kalkulacyjne, których zespół nigdy nie otwiera",
        "Dedykowana kolejka analityków do codziennych pytań",
    ...
    "ja": {
      ...
      "todaysStack": [
        "POSエクスポートに基づくPower BI / Tableau / Lookerのダッシュボード",
        "チームが決して開かない手作業のスプレッドシート",
        "日々の質問のための専任アナリストの行列",
        "同時に開いた6つのベンダーポータル",
    ...
    "id": {
      ...
      "todaysStack": [
        "Dasbor Power BI / Tableau / Looker dari ekspor POS",
        "Spreadsheet buatan tangan yang tidak pernah dibuka tim",
        "Antrean analis khusus untuk pertanyaan harian",
    ...
    "vi": {
      ...
      "todaysStack": [
        "Bảng điều khiển Power BI / Tableau / Looker dựa trên dữ liệu xuất từ POS",
        "Bảng tính làm thủ công mà đội ngũ chẳng bao giờ mở",
        "Hàng đợi nhà phân tích riêng cho các câu hỏi hằng ngày",
        "Sáu cổng nhà cung cấp mở cùng lúc",
    ...
    "tr": {
      ...
      "todaysStack": [
        "POS dışa aktarımlarına dayanan Power BI / Tableau / Looker panoları",
        "Ekibin hiç açmadığı, elle hazırlanmış tablolar",
        "Günlük sorular için ayrılmış analist kuyruğu",
    ...
    "ro": {
      ...
      "todaysStack": [
        "Dashboard-uri Power BI / Tableau / Looker pe baza exporturilor din POS",
        "Foi de calcul făcute manual pe care echipa nu le deschide niciodată",
        "O coadă de analiști dedicată întrebărilor zilnice",
    ...
    "ko": {
      ...
      "todaysStack": [
        "POS 내보내기 데이터에 기반한 Power BI / Tableau / Looker 대시보드",
        "팀이 한 번도 열지 않는 수작업 스프레드시트",
        "일상적인 질문을 위한 전담 분석가 대기열",
        "동시에 열려 있는 여섯 개의 공급업체 포털",
        "실시간 대응 대신 주간 요약 회의"
      ],
      "withSundae": [
    ...
    "sv": {
      ...
      "todaysStack": [
        ...
        "Handgjorda kalkylblad som teamet aldrig öppnar",
        "En dedikerad analytikerkö för dagliga frågor",
    ...
    "th": {
      ...
      "todaysStack": [
        "แดชบอร์ด Power BI / Tableau / Looker ที่อ้างอิงข้อมูลส่งออกจาก POS",
        "สเปรดชีตที่ทำด้วยมือซึ่งทีมไม่เคยเปิด",
        "คิวนักวิเคราะห์เฉพาะสำหรับคำถามประจำวัน",
    ...
    "bn": {
      ...
      "todaysStack": [
        "POS এক্সপোর্টের উপর ভিত্তি করে Power BI / Tableau / Looker ড্যাশবোর্ড",
        "হাতে তৈরি স্প্রেডশিট যা টিম কখনও খোলে না",
        "দৈনন্দিন প্রশ্নের জন্য নিবেদিত বিশ্লেষক কিউ",
        "একসাথে খোলা ছয়টি ভেন্ডর পোর্টাল",
    ...
    "ms": {
      ...
      "withSundaeLabel": "Dengan Sundae",
      "todaysStack": [
        "Papan pemuka Power BI / Tableau / Looker berdasarkan eksport POS",
        "Hamparan buatan tangan yang tidak pernah dibuka oleh pasukan",
        "Barisan penganalisis khusus untuk soalan harian",
        "Enam portal pembekal dibuka serentak",
