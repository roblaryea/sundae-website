// Generated locale overrides for src/app/crew/timeAttendance — transcreated (review prose before release).
...
export const generatedLocalCopy = {
  ...
  "ar": {
    ...
    "heroProof": [
      {
        "value": "لمسة لتسجيل الدخول",
        "label": "لا ساعة دوام تشتريها"
      },
      {
        "value": "في الموقع فقط",
        "label": "لا تسجيل دخول من المنزل"
      },
      {
        "value": "فحص الوجه",
        "label": "الشخص الصحيح، في كل مرة"
      },
      {
        "value": "ساعات نظيفة",
        "label": "مباشرة إلى الرواتب"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "استراحات صادقة",
        "body": "يؤكّد الموظفون استراحات الطعام والراحة عند تسجيل الخروج، فيصمد سجل الدوام أمام أي تدقيق عمالي.",
        "chips": [
          "الاستراحات مسجَّلة",
          "جاهز للتدقيق",
          "متوافق"
      ...
      {
        "title": "التصحيحات والاعتماد",
        "body": "نسيت تسجيل الدخول؟ خطوة تصحيحٍ بسيطة مع اعتماد المدير تعني ساعاتٍ نظيفة قبل أن تصل إلى الرواتب أصلاً.",
        "chips": [
          "صحّح تسجيلات الدخول الفائتة",
          "اعتماد المدير",
          "ساعات نظيفة"
        ]
      },
    ...
    "howEyebrow": "كيف تعمل",
    "howTitle": "سجّل الدخول، خذ استراحتك، واحصل على أجرٍ صحيح.",
    "howSteps": [
      {
        "title": "سجّل الدخول في الموقع",
        "body": "فحص وجهٍ سريع يؤكّد الشخص الصحيح، في المطعم، لحظة بدء المناوبة."
      },
      {
        "title": "سجّل الاستراحة",
        "body": "يؤكّد الموظفون استراحاتهم عند تسجيل الخروج، فيكون كل سجل دوام صادقاً وجاهزاً للتدقيق."
      },
      {
        "title": "معتمد إلى الرواتب",
    ...
    "ctaTitle": "سجّل الحقيقة.",
    "ctaDescription": "30 دقيقة، فروعك. شاهد تسجيل الدخول في الموقع، والاستراحات الصادقة، والساعات النظيفة وهي تتدفق إلى الرواتب وWorkforce Health.",
  ...
  "fr": {
    ...
    "heroProof": [
      {
        "value": "Un geste pour pointer",
        "label": "aucune pointeuse à acheter"
      },
      {
        "value": "Sur site uniquement",
        "label": "pas de pointage depuis chez soi"
      },
      {
        "value": "Reconnaissance faciale",
        "label": "la bonne personne, à chaque fois"
      },
      {
        "value": "Heures propres",
        "label": "directement en paie"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Pauses honnêtes",
        "body": "Le personnel confirme ses pauses repas et repos au moment du pointage de sortie, pour que la feuille de temps tienne face à un contrôle du travail.",
        "chips": [
          "Pauses enregistrées",
          "Prêt pour l'audit",
          "Conforme"
      ...
      },
      {
        ...
        "body": "Oubli de pointage ? Une simple étape de correction plus une validation du manager garantissent des heures propres avant même qu'elles n'atteignent la paie.",
        "chips": [
          "Corriger les oublis",
          "Validation manager",
          "Heures propres"
    ...
    "howTitle": "Pointez, prenez votre pause, soyez payé juste.",
    "howSteps": [
      {
        "title": "Pointez sur site",
        "body": "Une rapide reconnaissance faciale confirme la bonne personne, au restaurant, dès le début du service."
      },
      {
        "title": "Enregistrez la pause",
        "body": "Le personnel confirme ses pauses au pointage de sortie, pour que chaque feuille de temps soit honnête et prête pour l'audit."
      },
      {
        "title": "Validé vers la paie",
    ...
    "ctaTitle": "Pointez la vérité.",
    "ctaDescription": "30 minutes, vos établissements. Découvrez le pointage sur site, les pauses honnêtes et des heures propres qui passent en paie et dans Workforce Health.",
  ...
  "es": {
    ...
    "heroProof": [
      {
        "value": "Un toque para fichar",
        "label": "sin reloj que comprar"
      },
      {
        "value": "Solo en el local",
        "label": "nada de fichar desde casa"
      },
      {
        "value": "Verificación facial",
        "label": "la persona correcta, siempre"
      },
      {
        "value": "Horas limpias",
        "label": "directas a nómina"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Descansos honestos",
        "body": "El personal confirma sus descansos de comida y pausa al fichar la salida, para que la hoja de horas aguante una inspección laboral.",
        "chips": [
      ...
      {
        "title": "Correcciones y visto bueno",
        "body": "¿Olvidaste fichar? Un sencillo paso de corrección más el visto bueno del manager significa horas limpias antes de que lleguen a nómina.",
        "chips": [
          "Corrige fichajes olvidados",
          "Visto bueno del manager",
          "Horas limpias"
        ]
      },
      {
    ...
    "howTitle": "Ficha, toma tu descanso, cobra bien.",
    "howSteps": [
      {
        "title": "Ficha en el local",
        "body": "Una rápida verificación facial confirma la persona correcta, en el restaurante, en cuanto empieza el turno."
      },
      {
        "title": "Registra el descanso",
        "body": "El personal confirma sus descansos al fichar la salida, para que cada hoja de horas sea honesta y esté lista para auditoría."
      },
      {
        "title": "Aprobado a nómina",
    ...
    "ctaTitle": "Ficha la verdad.",
    "ctaDescription": "30 minutos, tus locales. Mira el fichaje en el local, los descansos honestos y las horas limpias fluyendo a nómina y a Workforce Health.",
  ...
  "de": {
    ...
    "heroProof": [
      {
        "value": "Tippen zum Einstempeln",
        "label": "keine Stechuhr nötig"
      },
      {
        "value": "Nur vor Ort",
        "label": "kein Einstempeln von zu Hause"
      },
      {
        "value": "Gesichts-Check",
        "label": "die richtige Person, jedes Mal"
      },
      {
        "value": "Saubere Stunden",
        "label": "direkt in die Lohnabrechnung"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Ehrliche Pausen",
        "body": "Mitarbeitende bestätigen ihre Mahlzeiten- und Ruhepausen beim Ausstempeln, damit der Stundenzettel einer Arbeitsprüfung standhält.",
        "chips": [
          "Pausen erfasst",
          "Prüfungsbereit",
          "Konform"
      ...
      {
        "title": "Korrekturen & Freigabe",
        "body": "Einstempeln vergessen? Ein einfacher Korrekturschritt plus Manager-Freigabe sorgt für saubere Stunden, bevor sie überhaupt die Lohnabrechnung erreichen.",
        "chips": [
          "Fehlstempel korrigieren",
          "Manager-Freigabe",
          "Saubere Stunden"
        ]
      },
    ...
    "howTitle": "Einstempeln, Pause machen, korrekt bezahlt werden.",
    "howSteps": [
      {
        "title": "Vor Ort einstempeln",
        "body": "Ein kurzer Gesichts-Check bestätigt die richtige Person, im Restaurant, sobald die Schicht beginnt."
      },
      {
        "title": "Pause erfassen",
        "body": "Mitarbeitende bestätigen ihre Pausen beim Ausstempeln, damit jeder Stundenzettel ehrlich und prüfungsbereit ist."
      },
      {
        "title": "Freigegeben in die Lohnabrechnung",
    ...
    "ctaTitle": "Stempeln Sie die Wahrheit.",
    "ctaDescription": "30 Minuten, Ihre Standorte. Erleben Sie Einstempeln vor Ort, ehrliche Pausen und saubere Stunden, die in Lohnabrechnung und Workforce Health fließen.",
  ...
  "nl": {
    ...
    "heroProof": [
      {
        "value": "Tik om in te klokken",
        "label": "geen prikklok te kopen"
      },
      {
        "value": "Alleen op locatie",
        "label": "geen inklokken van thuis"
      },
      {
        "value": "Gezichtscontrole",
        "label": "de juiste persoon, elke keer"
      },
      {
        "value": "Schone uren",
        "label": "direct de salarisadministratie in"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Eerlijke pauzes",
        "body": "Medewerkers bevestigen hun eet- en rustpauzes bij het uitklokken, zodat de urenstaat een arbeidsinspectie doorstaat.",
        "chips": [
          "Pauzes vastgelegd",
          "Inspectieklaar",
          "Conform"
      ...
      {
        "title": "Correcties & akkoord",
        "body": "Inklokken vergeten? Een simpele correctiestap plus akkoord van een manager zorgt voor schone uren voordat ze de salarisadministratie bereiken.",
        "chips": [
          "Gemiste klokmomenten",
          "Akkoord manager",
          "Schone uren"
        ]
      },
    ...
    "howTitle": "Inklokken, pauze nemen, juist uitbetaald worden.",
    "howSteps": [
      {
        "title": "Inklokken op locatie",
        "body": "Een snelle gezichtscontrole bevestigt de juiste persoon, in het restaurant, zodra de dienst begint."
      },
      {
        "title": "Pauze vastleggen",
        "body": "Medewerkers bevestigen hun pauzes bij het uitklokken, zodat elke urenstaat eerlijk en inspectieklaar is."
      },
      {
        "title": "Goedgekeurd naar salaris",
    ...
    "ctaTitle": "Klok de waarheid.",
    "ctaDescription": "30 minuten, jouw vestigingen. Zie inklokken op locatie, eerlijke pauzes en schone uren die de salarisadministratie en Workforce Health in stromen.",
  ...
  "pt": {
    ...
    "heroProof": [
      {
        "value": "Toque para picar o ponto",
        "label": "sem relógio de ponto para comprar"
      },
      {
        "value": "Só no local",
        "label": "sem picar o ponto de casa"
      },
      {
        "value": "Verificação facial",
        "label": "a pessoa certa, sempre"
      },
      {
        "value": "Horas limpas",
        "label": "direto para a folha de pagamento"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Pausas honestas",
        "body": "Os colaboradores confirmam as pausas de refeição e descanso ao sair, para o registo de horas resistir a uma auditoria laboral.",
        "chips": [
          "Pausas registadas",
      ...
      {
        "title": "Correções & validação",
        "body": "Esqueceu-se de picar o ponto? Um passo simples de correção mais a validação do gestor garante horas limpas antes de chegarem à folha de pagamento.",
        "chips": [
          "Corrigir pontos em falta",
          "Validação do gestor",
          "Horas limpas"
        ]
      },
    ...
    "howTitle": "Pique o ponto, faça a pausa, receba certo.",
    "howSteps": [
      {
        "title": "Picar o ponto no local",
        "body": "Uma verificação facial rápida confirma a pessoa certa, no restaurante, no momento em que o turno começa."
      },
      {
        "title": "Registar a pausa",
        "body": "Os colaboradores confirmam as pausas ao sair, para cada registo de horas ser honesto e pronto para auditoria."
      },
      {
        "title": "Aprovado para a folha",
    ...
    "ctaTitle": "Pique a verdade.",
    "ctaDescription": "30 minutos, as suas unidades. Veja o ponto no local, pausas honestas e horas limpas a fluir para a folha de pagamento e o Workforce Health.",
  ...
  "hi": {
    ...
    "heroProof": [
      {
        "value": "टैप कर क्लॉक-इन",
        "label": "कोई पंच क्लॉक ख़रीदने की ज़रूरत नहीं"
      },
      {
        "value": "सिर्फ़ ऑन-साइट",
        "label": "घर से क्लॉक-इन नहीं"
      },
      {
        "value": "फ़ेस चेक",
        "label": "हर बार सही व्यक्ति"
      },
      {
        "value": "साफ़ घंटे",
        "label": "सीधे पेरोल में"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "ईमानदार ब्रेक",
        "body": "स्टाफ क्लॉक-आउट पर अपने भोजन और आराम के ब्रेक की पुष्टि करते हैं, ताकि टाइमशीट लेबर ऑडिट में खरी उतरे।",
        "chips": [
          "ब्रेक लॉग",
          "ऑडिट-तैयार",
          "नियम-अनुरूप"
      ...
      {
        "title": "सुधार और साइन-ऑफ",
        "body": "क्लॉक-इन करना भूल गए? एक आसान सुधार-स्टेप और मैनेजर का साइन-ऑफ मतलब पेरोल तक पहुँचने से पहले ही साफ़ घंटे।",
        "chips": [
          "छूटे क्लॉक-इन सुधारें",
          "मैनेजर साइन-ऑफ",
          "साफ़ घंटे"
        ]
      },
    ...
    "howTitle": "क्लॉक-इन करें, ब्रेक लें, सही भुगतान पाएँ।",
    "howSteps": [
      {
        "title": "ऑन-साइट क्लॉक-इन",
        "body": "एक झटपट फ़ेस चेक पुष्टि करता है कि सही व्यक्ति, रेस्तराँ पर, ठीक शिफ़्ट शुरू होते ही।"
      },
      {
        "title": "ब्रेक लॉग करें",
        "body": "स्टाफ क्लॉक-आउट पर अपने ब्रेक की पुष्टि करते हैं, ताकि हर टाइमशीट ईमानदार और ऑडिट-तैयार हो।"
      },
      {
        "title": "मंज़ूरी के बाद पेरोल में",
    ...
    "ctaTitle": "सच को क्लॉक करें।",
    "ctaDescription": "30 मिनट, आपके आउटलेट। ऑन-साइट क्लॉक-इन, ईमानदार ब्रेक, और साफ़ घंटों को पेरोल और Workforce Health में जाते देखें।",
  ...
  "ur": {
    ...
    "heroProof": [
      {
        "value": "ٹیپ کر کے کلاک ان",
        "label": "کوئی پنچ کلاک خریدنے کی ضرورت نہیں"
      },
      {
        "value": "صرف آن سائٹ",
        "label": "گھر سے کلاک ان نہیں"
      },
      {
        "value": "فیس چیک",
        "label": "ہر بار صحیح شخص"
      },
      {
        "value": "صاف گھنٹے",
        "label": "سیدھے پے رول میں"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "ایماندار بریک",
        "body": "اسٹاف کلاک آؤٹ پر اپنے کھانے اور آرام کے بریک کی تصدیق کرتے ہیں، تاکہ ٹائم شیٹ لیبر آڈٹ میں پوری اترے۔",
        "chips": [
          "بریک لاگ",
          "آڈٹ کے لیے تیار",
          "ضابطے کے مطابق"
      ...
      {
        "title": "اصلاح اور سائن آف",
        "body": "کلاک ان کرنا بھول گئے؟ ایک آسان اصلاح کا قدم اور مینیجر کا سائن آف یعنی پے رول تک پہنچنے سے پہلے ہی صاف گھنٹے۔",
        "chips": [
          "چھوٹے کلاک ان درست کریں",
          "مینیجر سائن آف",
          "صاف گھنٹے"
        ]
      },
    ...
    "howTitle": "کلاک ان کریں، بریک لیں، صحیح ادائیگی پائیں۔",
    "howSteps": [
      {
        "title": "آن سائٹ کلاک ان",
        "body": "ایک فوری فیس چیک تصدیق کرتا ہے کہ صحیح شخص، ریستوران پر، ٹھیک شفٹ شروع ہوتے ہی۔"
      },
      {
        "title": "بریک لاگ کریں",
        "body": "اسٹاف کلاک آؤٹ پر اپنے بریک کی تصدیق کرتے ہیں، تاکہ ہر ٹائم شیٹ ایماندار اور آڈٹ کے لیے تیار ہو۔"
      },
      {
        "title": "منظوری کے بعد پے رول میں",
    ...
    "ctaTitle": "سچ کو کلاک کریں۔",
    "ctaDescription": "30 منٹ، آپ کے آؤٹ لیٹس۔ آن سائٹ کلاک ان، ایماندار بریک، اور صاف گھنٹوں کو پے رول اور Workforce Health میں جاتے دیکھیں۔",
  ...
  "it": {
    ...
    "heroProof": [
      {
        "value": "Timbri con un tocco",
        "label": "nessun marcatempo da comprare"
      },
      {
        "value": "Solo in sede",
        "label": "niente timbrature da casa"
      },
      {
        "value": "Controllo del volto",
        "label": "la persona giusta, ogni volta"
      },
      {
        "value": "Ore pulite",
        "label": "dritte nel payroll"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Pause oneste",
        "body": "Il personale conferma le pause pasto e di riposo all'uscita, così il cartellino regge a un controllo sul lavoro.",
        "chips": [
          "Pause registrate",
          "Pronto per audit",
          "A norma"
      ...
      {
        "title": "Correzioni e approvazione",
        "body": "Dimenticato di timbrare? Un semplice passo di correzione più l'approvazione del manager: ore pulite ancora prima che arrivino al payroll.",
        "chips": [
          "Correggi timbrature mancate",
      ...
      },
      {
        ...
        "chips": [
          ...
          "Niente da ridigitare"
        ]
      }
    ],
    "howEyebrow": "Come funziona",
    "howTitle": "Timbra, fai la pausa, vieni pagato giusto.",
    "howSteps": [
      {
        "title": "Timbra in sede",
        "body": "Un rapido controllo del volto conferma la persona giusta, nel locale, nell'istante in cui inizia il turno."
      },
      {
        "title": "Registra la pausa",
        "body": "Il personale conferma le pause all'uscita, così ogni cartellino è onesto e pronto per un audit."
      },
      {
        "title": "Approvate al payroll",
    ...
    "ctaTitle": "Timbra la verità.",
    "ctaDescription": "30 minuti, i tuoi locali. Guarda la timbratura in sede, le pause oneste e le ore pulite confluire in payroll e Workforce Health.",
  ...
  "pl": {
    ...
    "heroProof": [
      {
        "value": "Dotknij, by odbić",
        "label": "bez kupowania zegara"
      },
      {
        "value": "Tylko na miejscu",
        "label": "żadnego odbijania z domu"
      },
      {
        "value": "Skan twarzy",
        "label": "właściwa osoba, za każdym razem"
      },
      {
        "value": "Czyste godziny",
        "label": "prosto do płac"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Uczciwe przerwy",
        "body": "Pracownicy potwierdzają przerwy na posiłek i odpoczynek przy odbiciu wyjścia, więc karta pracy obroni się w kontroli pracy.",
        "chips": [
          "Przerwy zapisane",
          "Gotowe na audyt",
          "Zgodne z prawem"
      ...
      {
        "title": "Poprawki i akceptacja",
        "body": "Zapomniałeś odbić wejście? Prosty krok poprawki plus akceptacja menedżera dają czyste godziny, zanim w ogóle trafią do płac.",
        "chips": [
          "Popraw brakujące odbicia",
          "Akceptacja menedżera",
          "Czyste godziny"
        ]
      },
      {
    ...
    "howTitle": "Odbij, zrób przerwę, dostań właściwą wypłatę.",
    "howSteps": [
      {
        "title": "Odbij na miejscu",
        "body": "Szybki skan twarzy potwierdza właściwą osobę, w restauracji, w chwili rozpoczęcia zmiany."
      },
      {
        "title": "Zarejestruj przerwę",
        "body": "Pracownicy potwierdzają przerwy przy odbiciu wyjścia, więc każda karta pracy jest uczciwa i gotowa na audyt."
      },
      {
        "title": "Zatwierdzone do płac",
    ...
    "ctaTitle": "Odbij prawdę.",
    "ctaDescription": "30 minut, Twoje lokale. Zobacz odbicie na miejscu, uczciwe przerwy i czyste godziny płynące do płac i Workforce Health.",
  ...
  "tr": {
    ...
    "heroProof": [
      {
        "value": "Dokun, giriş yap",
        "label": "alınacak saat cihazı yok"
      },
      {
        "value": "Yalnızca yerinde",
        "label": "evden giriş yok"
      },
      {
        "value": "Yüz kontrolü",
        "label": "her seferinde doğru kişi"
      },
      {
        "value": "Temiz saatler",
        "label": "doğrudan bordroya"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Dürüst molalar",
        "body": "Personel yemek ve dinlenme molalarını çıkışta onaylar; böylece puantaj bir iş denetiminde ayakta kalır.",
        "chips": [
          "Molalar kayıtlı",
          "Denetime hazır",
          "Mevzuata uygun"
      ...
      {
        "title": "Düzeltmeler ve onay",
        "body": "Giriş yapmayı unuttunuz mu? Basit bir düzeltme adımı artı yönetici onayı, bordroya ulaşmadan önce temiz saatler demek.",
        "chips": [
          "Eksik girişleri düzelt",
          "Yönetici onayı",
          "Temiz saatler"
        ]
      },
    ...
    "howTitle": "Giriş yap, molanı al, doğru ödemeni al.",
    "howSteps": [
      {
        "title": "Yerinde giriş yapın",
        "body": "Hızlı bir yüz kontrolü, vardiya başladığı anda restoranda doğru kişiyi doğrular."
      },
      {
        "title": "Molayı kaydedin",
        "body": "Personel molalarını çıkışta onaylar; böylece her puantaj dürüst ve denetime hazır olur."
      },
      {
        "title": "Onaylanıp bordroya",
    ...
    "ctaTitle": "Gerçeği kaydedin.",
    "ctaDescription": "30 dakika, sizin şubeleriniz. Yerinde girişi, dürüst molaları ve bordroya ile Workforce Health'e akan temiz saatleri görün.",
  ...
  "zh-Hans": {
    ...
    "features": [
      ...
      {
        "title": "如实记录休息",
        "body": "员工在下班打卡时确认用餐和休息时间,这样工时表经得起劳动稽核。",
        "chips": [
          "休息已记录",
          "随时备查",
          "合规"
      ...
      {
        "title": "补卡与签核",
        "body": "忘记打卡?一个简单的补卡步骤加上管理者签核,工时在进入薪资前就已干净。",
        "chips": [
          "补漏打卡",
          "管理者签核",
          "干净工时"
    ...
    "howEyebrow": "运作方式",
    "howTitle": "打卡、休息、拿到该拿的薪水。",
    "howSteps": [
      {
        "title": "到岗打卡",
        "body": "一次快速人脸核验,在班次开始的那一刻确认对的人、身处餐厅。"
      },
      {
        "title": "记录休息",
        "body": "员工在下班打卡时确认休息,这样每份工时表都如实、随时备查。"
      },
      {
        "title": "核准入薪资",
    ...
    "ctaEyebrow": "别再对账打卡了",
    "ctaTitle": "打下真相。",
    "ctaDescription": "30 分钟,用你的门店。看到岗打卡、如实休息,以及干净工时如何流入薪资与 Workforce Health。",
  ...
  "ja": {
    ...
    "heroLine1": "本当に信頼できる、",
    "heroLine2": "労働時間。",
    "description": "Crew Time & Attendance は、どんなスマホもタイムレコーダーに変えます。スタッフは店舗にいるときだけ打刻し、顔認証ですばやく本人確認、休憩も記録。だから給与に届く時間はクリーンで、自信を持って示せます。",
    ...
    "featuresEyebrow": "Time & Attendance の中身",
    "featuresTitle": "すべての時間を、証明できる。",
    "featuresDescription": "チームのスマホに宿るタイムレコーダー。店舗で本人確認し、休憩に正直で、給与へ直結します。",
    "features": [
      {
        "title": "どんなスマホでも打刻",
        "body": "購入も設置もいらないハードウェア。スタッフは自分のスマホで打刻でき、電波が途切れても打刻は保存され、オンラインに戻った瞬間に同期します。",
        "chips": [
          "どんなスマホでも",
          "オフライン対応",
          "ハード不要"
      ...
      {
        "title": "店舗にいるときだけ",
        "body": "打刻できる前に、本人が実際に店舗にいることを確認。だからソファからシフトを始めることはできません。",
        "chips": [
          "店舗内だけ",
          "なりすまし不可",
          "店舗ごと"
      ...
      {
        "title": "顔認証・指紋認証",
        "body": "すばやい顔認証または指紋認証で本人の打刻を確認。友人の代理打刻はできません。",
        "chips": [
          "顔認証",
          "指紋認証",
          "本人確認"
      ...
      {
        "title": "正直な休憩",
        "body": "スタッフは退勤時に食事・休憩を確認するので、勤怠記録は労務監査にも耐えます。",
        "chips": [
          "休憩を記録",
          "監査対応",
          "コンプラ準拠"
      ...
      {
        "title": "修正・承認",
        "body": "打刻を忘れた? 簡単な修正ステップとマネージャー承認で、給与に届く前にクリーンな時間に。",
        "chips": [
          "打刻漏れ修正",
          "マネージャー承認",
          "クリーンな時間"
      ...
      {
        "title": "給与へ直結",
        "body": "承認された時間は自動で給与へ。通常・残業も計算済みで、再入力は一切ありません。",
        "chips": [
          "自動で給与へ",
          "残業も計算済み",
          "再入力なし"
    ...
    "howEyebrow": "仕組み",
    "howTitle": "打刻して、休憩して、正しく支払われる。",
    "howSteps": [
      {
        "title": "店舗で打刻",
        "body": "すばやい顔認証が、シフト開始の瞬間に、店舗にいる本人を確認します。"
      },
      {
        "title": "休憩を記録",
        "body": "スタッフは退勤時に休憩を確認。だからどの勤怠記録も正直で、監査対応済みです。"
      },
      {
        "title": "承認して給与へ",
        "body": "マネージャーが漏れを修正して承認。残業も計算済みのクリーンな時間が給与へ流れます。"
      }
    ],
    "loopLine": "ライブの勤怠は、シフト開始の瞬間に Workforce Health へ。状況は常に最新です。",
    "creamEyebrow": "店舗で。確認済み。正直に。",
    "creamStatement": "現場が証明できる勤怠。",
    "creamLede": "悪い電波でも生き残り、自宅からは偽れず、すべての休憩を記録するタイムレコーダー。だから給与に届く時間は、自信を持って示せるものになります。",
    "relatedEyebrow": "Crew のその他",
    "relatedTitle": "Time & Attendance は、運用レイヤーのひとつのピースです。",
    "ctaEyebrow": "打刻の突き合わせをやめる",
    "ctaTitle": "真実を打刻する。",
    "ctaDescription": "30分、あなたの店舗で。店舗内打刻・正直な休憩・クリーンな時間が、給与と Workforce Health へ流れる様子をご覧ください。",
  ...
  "ko": {
    ...
    "features": [
      {
        "title": "어떤 휴대폰으로든 출근",
        "body": "구매하거나 설치할 하드웨어가 없습니다. 직원은 자기 휴대폰으로 출퇴근을 찍고, 신호가 끊겨도 출근 기록은 저장되어 온라인으로 돌아오는 순간 동기화됩니다.",
        "chips": [
          "모든 휴대폰",
          "오프라인 작동",
          "하드웨어 불필요"
      ...
      {
        "title": "정직한 휴게 시간",
        "body": "직원이 퇴근 시 식사 및 휴게 시간을 확인하므로, 근무 기록표가 노동 감사에도 통과합니다.",
        "chips": [
          "휴게 기록",
          "감사 대비",
          "규정 준수"
      ...
      {
        "title": "수정 & 승인",
        "body": "출근을 깜빡했나요? 간단한 수정 단계와 매니저 승인으로 급여에 도달하기 전에 깔끔한 시간이 됩니다.",
        "chips": [
          "출근 누락 수정",
          "매니저 승인",
          "깔끔한 시간"
    ...
    "howEyebrow": "작동 방식",
    "howTitle": "출근하고, 쉬고, 제대로 급여 받기.",
    "howSteps": [
      {
        "title": "현장에서 출근",
        "body": "빠른 얼굴 확인으로 근무 시작 순간에 매장에서 본인임을 확인합니다."
      },
      {
        "title": "휴게 기록",
        "body": "직원이 퇴근 시 휴게 시간을 확인하므로 모든 근무 기록표가 정직하고 감사에 대비됩니다."
      },
      {
        "title": "승인 후 급여로",
    ...
    "ctaTitle": "진실을 기록하세요.",
    "ctaDescription": "30분, 여러분의 매장으로. 현장 출근, 정직한 휴게, 급여와 Workforce Health로 흘러드는 깔끔한 시간을 보여 드립니다.",
  ...
  "id": {
    ...
    "heroProof": [
      {
        "value": "Ketuk untuk absen",
        "label": "tanpa beli mesin absen"
      },
      {
        "value": "Hanya di lokasi",
        "label": "tak bisa absen dari rumah"
      },
      {
        "value": "Pemindaian wajah",
        "label": "orang yang tepat, selalu"
      },
      {
        "value": "Jam kerja bersih",
        "label": "langsung ke payroll"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Istirahat yang jujur",
        "body": "Staf mengonfirmasi istirahat makan dan jeda saat absen keluar, jadi lembar waktu tahan terhadap audit ketenagakerjaan.",
        "chips": [
          "Istirahat tercatat",
          "Siap audit",
          "Patuh aturan"
      ...
      {
        "title": "Koreksi & persetujuan",
        "body": "Lupa absen masuk? Langkah koreksi sederhana plus persetujuan manajer memastikan jam kerja bersih sebelum sampai ke payroll.",
        "chips": [
          "Koreksi absen",
          "Persetujuan manajer",
          "Jam kerja bersih"
    ...
    "howTitle": "Absen masuk, ambil istirahat, gaji tepat.",
    "howSteps": [
      {
        "title": "Absen di lokasi",
        "body": "Pemindaian wajah cepat memastikan orang yang tepat, di restoran, tepat saat shift dimulai."
      },
      {
        "title": "Catat istirahat",
        "body": "Staf mengonfirmasi istirahat saat absen keluar, jadi setiap lembar waktu jujur dan siap audit."
      },
      {
        "title": "Disetujui ke payroll",
    ...
    "ctaTitle": "Catat kebenarannya.",
    "ctaDescription": "30 menit, dengan outlet Anda. Lihat absen di lokasi, istirahat yang jujur, dan jam kerja bersih mengalir ke payroll dan Workforce Health.",
  ...
  "vi": {
    ...
    "heroProof": [
      {
        "value": "Chạm để chấm công",
        "label": "không cần mua máy chấm công"
      },
      {
        "value": "Chỉ tại chỗ",
        "label": "không chấm công từ nhà"
      },
      {
        "value": "Quét mặt",
        "label": "đúng người, mọi lần"
      },
      {
        "value": "Giờ công sạch",
        "label": "thẳng vào bảng lương"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Giờ nghỉ trung thực",
        "body": "Nhân viên xác nhận giờ nghỉ ăn và nghỉ giải lao lúc chấm công ra, nên bảng công đứng vững trước mọi cuộc kiểm tra lao động.",
        "chips": [
          "Ghi giờ nghỉ",
          "Sẵn sàng kiểm toán",
          "Tuân thủ"
      ...
      {
        "title": "Sửa lỗi & ký duyệt",
        "body": "Quên chấm công? Một bước sửa đơn giản cộng với ký duyệt của quản lý cho bạn số giờ sạch trước khi tới bảng lương.",
        "chips": [
          "Sửa quên chấm công",
          "Quản lý ký duyệt",
          "Giờ công sạch"
    ...
    "howTitle": "Chấm công, nghỉ giải lao, trả lương đúng.",
    "howSteps": [
      {
        "title": "Chấm công tại chỗ",
        "body": "Một lần quét mặt nhanh xác nhận đúng người, tại nhà hàng, ngay khi ca bắt đầu."
      },
      {
        "title": "Ghi giờ nghỉ",
        "body": "Nhân viên xác nhận giờ nghỉ lúc chấm công ra, nên mọi bảng công đều trung thực và sẵn sàng kiểm toán."
      },
      {
        "title": "Duyệt vào bảng lương",
    ...
    "ctaTitle": "Chấm đúng sự thật.",
    "ctaDescription": "30 phút, với chi nhánh của bạn. Xem chấm công tại chỗ, giờ nghỉ trung thực, và số giờ sạch chảy vào bảng lương cùng Workforce Health.",
  ...
  "ro": {
    ...
    "heroProof": [
      {
        "value": "O atingere pentru pontaj",
        "label": "fără ceas de pontaj de cumpărat"
      },
      {
        "value": "Doar la fața locului",
        "label": "fără pontaj de acasă"
      },
      {
        "value": "Verificare facială",
        "label": "persoana potrivită, de fiecare dată"
      },
      {
        "value": "Ore curate",
        "label": "direct în salarizare"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Pauze sincere",
        "body": "Angajații își confirmă pauzele de masă și de odihnă la pontarea ieșirii, așa că fișa de pontaj rezistă unui control de muncă.",
        "chips": [
          "Pauze înregistrate",
      ...
      {
        "title": "Corecții & aprobare",
        "body": "Ai uitat să pontezi? Un pas simplu de corectare plus aprobarea managerului înseamnă ore curate înainte să ajungă vreodată la salarizare.",
        "chips": [
          "Corectează pontaje uitate",
    ...
    "howTitle": "Pontează, ia-ți pauza, fii plătit corect.",
    "howSteps": [
      {
        "title": "Pontează la fața locului",
        "body": "O verificare facială rapidă confirmă persoana potrivită, la restaurant, chiar în clipa în care începe tura."
      },
      {
        "title": "Înregistrează pauza",
        "body": "Angajații își confirmă pauzele la pontarea ieșirii, așa că fiecare fișă de pontaj e sinceră și pregătită pentru audit."
      },
      {
        "title": "Aprobat spre salarizare",
    ...
    "ctaTitle": "Pontează adevărul.",
    "ctaDescription": "30 de minute, locațiile tale. Vezi pontajul la fața locului, pauzele sincere și orele curate care curg în salarizare și Workforce Health.",
  ...
  "sv": {
    ...
    "heroProof": [
      {
        "value": "Tryck för att stämpla in",
        "label": "ingen stämpelklocka att köpa"
      },
      {
        "value": "Bara på plats",
        "label": "ingen instämpling hemifrån"
      },
      {
        "value": "Ansiktskontroll",
        "label": "rätt person, varje gång"
      },
      {
        "value": "Rena timmar",
        "label": "rakt in i lönen"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Ärliga raster",
        "body": "Personalen bekräftar sina mat- och vilraster vid utstämpling, så att tidrapporten håller för en arbetsrättslig granskning.",
        "chips": [
          "Raster loggade",
          "Redo för revision",
          "Regelefterlevt"
      ...
      {
        "title": "Rättningar & godkännande",
        "body": "Glömde att stämpla in? Ett enkelt rättningssteg plus ett chefsgodkännande ger rena timmar innan de någonsin når lönen.",
        "chips": [
          "Rätta missade instämplingar",
          "Chefsgodkännande",
          "Rena timmar"
        ]
      },
    ...
    "howTitle": "Stämpla in, ta din rast, få rätt lön.",
    "howSteps": [
      {
        "title": "Stämpla in på plats",
        "body": "En snabb ansiktskontroll bekräftar rätt person, på restaurangen, i samma stund passet börjar."
      },
      {
        "title": "Logga rasten",
        "body": "Personalen bekräftar sina raster vid utstämpling, så att varje tidrapport är ärlig och redo för revision."
      },
      {
        "title": "Godkänt till lönen",
    ...
    "ctaTitle": "Stämpla sanningen.",
    "ctaDescription": "30 minuter, dina enheter. Se instämpling på plats, ärliga raster och rena timmar som flödar in i lönen och Workforce Health.",
  ...
  "bn": {
    ...
    "heroProof": [
      {
        "value": "ট্যাপ করে ক্লক-ইন",
        "label": "পাঞ্চ ক্লক কিনতে হয় না"
      },
      {
        "value": "শুধু অন-সাইট",
        "label": "বাড়ি থেকে ক্লক-ইন নয়"
      },
      {
        "value": "ফেস চেক",
        "label": "প্রতিবারই সঠিক মানুষ"
      },
      {
        "value": "পরিষ্কার ঘণ্টা",
        "label": "সরাসরি পেরোলে"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "সৎ বিরতি",
        "body": "স্টাফরা ক্লক-আউটের সময় তাদের খাবার ও বিশ্রামের বিরতি নিশ্চিত করে, তাই টাইমশিট লেবার অডিটে টিকে থাকে।",
        "chips": [
          "বিরতি লগড",
          "অডিট-প্রস্তুত",
          "নিয়মসিদ্ধ"
      ...
      {
        "title": "সংশোধন ও সাইন-অফ",
        "body": "ক্লক-ইন করতে ভুলে গেছেন? একটা সহজ সংশোধন ধাপ আর ম্যানেজারের সাইন-অফ মানে পেরোলে পৌঁছানোর আগেই পরিষ্কার ঘণ্টা।",
        "chips": [
          "মিস হওয়া ক্লক-ইন সংশোধন",
          "ম্যানেজার সাইন-অফ",
          "পরিষ্কার ঘণ্টা"
        ]
      },
    ...
    "howTitle": "ক্লক-ইন করুন, বিরতি নিন, সঠিক বেতন পান।",
    "howSteps": [
      {
        "title": "অন-সাইটে ক্লক-ইন",
        "body": "শিফট শুরুর মুহূর্তে একটা দ্রুত ফেস চেক নিশ্চিত করে সঠিক মানুষ, রেস্তোরাঁতেই আছে।"
      },
      {
        "title": "বিরতি লগ করুন",
        "body": "স্টাফরা ক্লক-আউটের সময় বিরতি নিশ্চিত করে, তাই প্রতিটি টাইমশিট সৎ আর অডিট-প্রস্তুত।"
      },
      {
        "title": "অনুমোদিত হয়ে পেরোলে",
    ...
    "ctaTitle": "সত্যটাই ক্লক করুন।",
    "ctaDescription": "৩০ মিনিট, আপনার আউটলেট। দেখুন অন-সাইট ক্লক-ইন, সৎ বিরতি আর পরিষ্কার ঘণ্টা পেরোল ও Workforce Health-এ বইছে।",
    "ctaPrimary": "একটি Crew ওয়াকথ্রু বুক করুন",
    "ctaSecondary": "Sundae Crew ঘুরে দেখুন"
  },
  "th": {
    "badge": "Crew · Time & Attendance",
    "heroLine1": "ชั่วโมงงานที่คุณ",
    "heroLine2": "เชื่อถือได้จริง",
    "description": "Crew Time & Attendance เปลี่ยนมือถือทุกเครื่องให้เป็นเครื่องลงเวลา พนักงานลงเวลาเข้าได้ต่อเมื่ออยู่ที่ร้านเท่านั้น ยืนยันด้วยการสแกนใบหน้าอย่างรวดเร็ว และบันทึกเวลาพัก ชั่วโมงงานที่ส่งถึงระบบจ่ายเงินเดือนจึงสะอาดและยืนยันได้อย่างมั่นใจ",
    "primaryCta": "จองสาธิตการใช้งาน Crew",
    "secondaryCta": "ดู Crew ทำงานจริง",
    "heroProof": [
      {
        "value": "แตะเพื่อลงเวลา",
        "label": "ไม่ต้องซื้อเครื่องตอกบัตร"
      },
      {
        "value": "เฉพาะที่ร้าน",
        "label": "ลงเวลาจากบ้านไม่ได้"
      },
      {
        "value": "สแกนใบหน้า",
        "label": "คนที่ใช่ ทุกครั้ง"
      },
      {
        "value": "ชั่วโมงสะอาด",
        "label": "ตรงเข้าระบบจ่ายเงินเดือน"
      }
    ],
    "featuresEyebrow": "สิ่งที่มีใน Time & Attendance",
    "featuresTitle": "ทุกชั่วโมง พิสูจน์ได้",
    "featuresDescription": "เครื่องลงเวลาที่อยู่บนมือถือของทีมคุณ ยืนยันที่ร้าน ซื่อตรงเรื่องเวลาพัก และต่อตรงเข้าระบบจ่ายเงินเดือน",
    "features": [
      {
        "title": "ลงเวลาจากมือถือเครื่องไหนก็ได้",
        "body": "ไม่ต้องซื้อหรือติดตั้งฮาร์ดแวร์ พนักงานลงเวลาเข้าออกจากมือถือของตัวเอง และถ้าสัญญาณหลุด การลงเวลาจะถูกบันทึกไว้และซิงค์ทันทีที่กลับมาออนไลน์",
        "chips": [
          "ทุกมือถือ",
          "ใช้ออฟไลน์ได้",
          "ไม่ต้องมีฮาร์ดแวร์"
      ...
      {
        "title": "เฉพาะที่ร้านเท่านั้น",
        "body": "ยืนยันว่าคนอยู่ที่ร้านจริงก่อนจะลงเวลาเข้าได้ จึงเริ่มกะจากบนโซฟาไม่ได้",
        "chips": [
          "เฉพาะที่ร้าน",
          "ปลอมไม่ได้",
          "แยกตามสาขา"
      ...
      {
        "title": "สแกนใบหน้าหรือลายนิ้วมือ",
        "body": "สแกนใบหน้าหรือลายนิ้วมืออย่างรวดเร็ว ยืนยันว่าคนที่ใช่กำลังลงเวลา ไม่มีใครตอกบัตรแทนเพื่อน",
        "chips": [
          "สแกนใบหน้า",
          "ลายนิ้วมือ",
          "คนที่ใช่"
      ...
      {
        "title": "เวลาพักที่ซื่อตรง",
        "body": "พนักงานยืนยันเวลาพักรับประทานอาหารและพักผ่อนตอนลงเวลาออก ใบลงเวลาจึงผ่านการตรวจสอบด้านแรงงานได้",
        "chips": [
          "บันทึกเวลาพัก",
          "พร้อมตรวจสอบ",
          "ถูกระเบียบ"
      ...
      },
      {
        ...
        "body": "ลืมลงเวลาเข้าใช่ไหม ขั้นตอนแก้ไขง่าย ๆ พร้อมการอนุมัติจากผู้จัดการ หมายถึงชั่วโมงสะอาดก่อนถึงระบบจ่ายเงินเดือน",
        "chips": [
          "แก้การลงเวลาที่พลาด",
          "ผู้จัดการอนุมัติ",
          "ชั่วโมงสะอาด"
      ...
      {
        "title": "ตรงสู่ระบบจ่ายเงินเดือน",
        "body": "ชั่วโมงที่อนุมัติแล้วไหลเข้าระบบจ่ายเงินเดือนอัตโนมัติ คำนวณชั่วโมงปกติและล่วงเวลาให้เสร็จ ไม่ต้องพิมพ์ใหม่",
        "chips": [
          "เข้าเงินเดือนอัตโนมัติ",
          "จัดการล่วงเวลาแล้ว",
          "ไม่ต้องพิมพ์ใหม่"
        ]
      }
    ...
    "howTitle": "ลงเวลาเข้า พักให้พอ รับเงินถูกต้อง",
    "howSteps": [
      {
        "title": "ลงเวลาที่ร้าน",
        "body": "สแกนใบหน้าอย่างรวดเร็วยืนยันว่าเป็นคนที่ใช่ อยู่ที่ร้าน ในวินาทีที่กะเริ่ม"
      },
      {
        "title": "บันทึกเวลาพัก",
        "body": "พนักงานยืนยันเวลาพักตอนลงเวลาออก ใบลงเวลาทุกใบจึงซื่อตรงและพร้อมตรวจสอบ"
      },
      {
        "title": "อนุมัติเข้าเงินเดือน",
        "body": "ผู้จัดการแก้ไขจุดที่พลาดและอนุมัติ ชั่วโมงสะอาดไหลเข้าระบบจ่ายเงินเดือนพร้อมคำนวณล่วงเวลาแล้ว"
      }
    ],
    "loopLine": "การลงเวลาแบบสดไหลเข้า Workforce Health ทันทีที่กะเริ่ม ภาพรวมจึงเป็นปัจจุบันเสมอ",
    "creamEyebrow": "ที่ร้าน ยืนยันแล้ว ซื่อตรง",
    "creamStatement": "การลงเวลาที่หน้างานพิสูจน์ได้",
    "creamLede": "เครื่องลงเวลาที่ทนต่อสัญญาณแย่ ปลอมจากบ้านไม่ได้ และบันทึกทุกเวลาพัก ชั่วโมงที่ส่งถึงระบบจ่ายเงินเดือนจึงเป็นชั่วโมงที่คุณยืนยันได้อย่างมั่นใจ",
    "relatedEyebrow": "ส่วนที่เหลือของ Crew",
    "relatedTitle": "Time & Attendance เป็นเพียงชิ้นหนึ่งของชั้นปฏิบัติการ",
    "ctaEyebrow": "เลิกนั่งกระทบยอดเวลา",
    "ctaTitle": "ลงเวลาตามความจริง",
    "ctaDescription": "30 นาที กับสาขาของคุณ ดูการลงเวลาที่ร้าน เวลาพักที่ซื่อตรง และชั่วโมงสะอาดที่ไหลเข้าระบบจ่ายเงินเดือนและ Workforce Health",
  ...
  "ms": {
    ...
    "heroProof": [
      {
        "value": "Ketik untuk masuk",
        "label": "tiada jam ketik untuk dibeli"
      },
      {
        "value": "Di lokasi sahaja",
        "label": "tiada ketik masuk dari rumah"
      },
      {
        "value": "Imbasan wajah",
        "label": "orang yang betul, setiap kali"
      },
      {
        "value": "Jam yang bersih",
        "label": "terus ke gaji"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Rehat yang jujur",
        "body": "Staf mengesahkan rehat makan dan rehat mereka semasa ketik keluar, jadi kad waktu bertahan dalam audit buruh.",
        "chips": [
          "Rehat dicatat",
          "Sedia diaudit",
          "Patuh peraturan"
      ...
      {
        "title": "Pembetulan & pengesahan",
        "body": "Terlupa ketik masuk? Langkah pembetulan mudah dan pengesahan pengurus bermakna jam yang bersih sebelum ia sampai ke gaji.",
        "chips": [
          "Betulkan ketik tertinggal",
          "Pengesahan pengurus",
          "Jam yang bersih"
        ]
      },
    ...
    "howTitle": "Ketik masuk, ambil rehat, dibayar dengan betul.",
    "howSteps": [
      {
        "title": "Ketik masuk di lokasi",
        "body": "Imbasan wajah pantas mengesahkan orang yang betul, di restoran, pada saat syif bermula."
      },
      {
        "title": "Catat rehat",
        "body": "Staf mengesahkan rehat mereka semasa ketik keluar, jadi setiap kad waktu jujur dan sedia diaudit."
      },
      {
        "title": "Diluluskan ke gaji",
    ...
    "ctaTitle": "Ketik kebenaran.",
    "ctaDescription": "30 minit, cawangan anda. Lihat ketik masuk di lokasi, rehat yang jujur, dan jam bersih mengalir ke gaji dan Workforce Health.",
