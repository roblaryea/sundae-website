    ...
    "fr": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse repère les anomalies dès le service et les rattache au serveur, au moment de la journée, à l'établissement ou au comportement qui les provoque."
        },
        {
    ...
    "es": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse detecta patrones de anomalías durante el turno y los atribuye al camarero, la franja horaria, el local o el comportamiento que los provoca."
        },
        {
    ...
    "pt": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "O Pulse sinaliza padrões de exceção durante o turno e os atribui ao garçom, período do dia, unidade ou comportamento que os provoca."
        },
        {
    ...
    "it": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse segnala gli scostamenti già durante il turno e li attribuisce al cameriere, alla fascia oraria, al locale o al comportamento che li provoca."
        },
        {
    ...
    "tr": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse, istisna örüntülerini daha vardiya sürerken işaretler ve bunları garsona, günün saatine, şubeye veya tetikleyen davranışa bağlar."
        },
        {
    ...
    "pl": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse oznacza wzorce wyjątków już podczas zmiany i przypisuje je do kelnera, pory dnia, lokalu lub zachowania, które je powoduje."
        },
        {
    ...
    "ja": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulseはシフト中に例外パターンを検知し、その原因となった接客スタッフ・時間帯・店舗・行動に結び付けて示します。"
        },
        {
    ...
    "ko": {
      ...
      "industryClaims": [
        ...
        },
        {
          ...
          "sundae": "Pulse는 근무 중에 예외 패턴을 포착해, 이를 유발한 서빙 직원, 시간대, 매장, 행동에 연결해 보여줍니다."
        },
        {
