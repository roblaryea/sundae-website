// Generated locale overrides for src/app/crew/payroll — transcreated (review prose before release).
...
export const generatedLocalCopy = {
  ...
  "ar": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "ولاية ومقاطعة ومدينة"
      },
      {
        "value": "جاهز لنهاية العام",
        "label": "النماذج الصحيحة، في كل مكان"
      },
      {
        "value": "يُراجَع أولاً",
        "label": "قبل أن يتقاضى أحدٌ أجره"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "نهاية العام، مُنجَزة",
        "body": "النماذج الضريبية السنوية التي يتوقعها الموظفون والجهات الرسمية في كل دولة - تُولَّد، لا تُلاحَق في جدول بيانات.",
        "chips": [
          "نماذج سنوية",
          "لكل دولة",
          "بلا تخبّط"
      ...
      {
        "title": "الساعات تُسحَب لك",
        "body": "تأتي الساعات المعتمدة مباشرة من Time & Attendance والعمل الإضافي محسوبٌ سلفاً - بلا إعادة إدخالٍ بين الأنظمة.",
        "chips": [
          "من تسجيلات الدخول",
          "العمل الإضافي محسوب",
          "بلا إعادة إدخال"
      ...
      {
        "title": "كل عملية، قابلة للدفاع",
        "body": "معاينة بلغةٍ واضحة وسجلٌ ورقي لكل عملية دفع يحلّان محل الأخذ والرد - فيصمد كل إقفال أمام أي تدقيق.",
        "chips": [
          "معاينة واضحة",
          "سجل ورقي",
          "جاهز للتدقيق"
  ...
  "fr": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "États, provinces & villes"
      },
      {
        "value": "Prêt en fin d'année",
        "label": "les bons formulaires, partout"
      },
      {
        "value": "Vérifié d'abord",
        "label": "avant tout versement"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Fin d'année, gérée",
        "body": "Les formulaires fiscaux annuels attendus par les employés et les autorités dans chaque pays - générés, pas traqués dans un tableur.",
        "chips": [
          "Formulaires annuels",
          "Par pays",
          "Sans précipitation"
      ...
      {
        "title": "Les heures récupérées pour vous",
        "body": "Les heures validées viennent directement de Time & Attendance, heures sup déjà calculées - aucune ressaisie entre les systèmes.",
        "chips": [
          "Depuis les pointages",
          "Heures sup calculées",
          "Sans ressaisie"
        ]
      },
      {
        "title": "Chaque traitement, défendable",
        "body": "Un aperçu en langage clair et une piste d'audit pour chaque traitement remplacent les allers-retours - pour que chaque clôture tienne face à un contrôle.",
        "chips": [
          "Aperçu clair",
          "Piste d'audit",
          "Prêt pour l'audit"
  ...
  "es": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "estados, provincias y ciudades"
      },
      {
        "value": "Listo a fin de año",
        "label": "los formularios correctos, en todas partes"
      },
      {
        "value": "Revisado primero",
        "label": "antes de que cobre nadie"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Fin de año, resuelto",
        "body": "Los formularios fiscales anuales que esperan los empleados y las autoridades en cada país - generados, no perseguidos en una hoja de cálculo.",
        "chips": [
          "Formularios anuales",
          "Por país",
          "Sin agobios"
      ...
      {
        "title": "Las horas, traídas por ti",
        "body": "Las horas aprobadas llegan directas desde Time & Attendance con las extra ya calculadas - sin reescribir entre sistemas.",
        "chips": [
          "Desde los fichajes",
      ...
      {
        "title": "Cada cierre, defendible",
        "body": "Una vista previa en lenguaje claro y un rastro documental por cada cierre sustituyen el ir y venir - para que cada cierre aguante una revisión.",
        "chips": [
          "Vista previa clara",
          "Rastro documental",
  ...
  "de": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "Bundesstaaten, Provinzen & Städte"
      },
      {
        "value": "Jahresend-bereit",
        "label": "die richtigen Formulare, überall"
      },
      {
        "value": "Erst geprüft",
        "label": "bevor jemand bezahlt wird"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Jahresende, erledigt",
        "body": "Die jährlichen Steuerformulare, die Mitarbeitende und Behörden in jedem Land erwarten - generiert, nicht in einer Tabelle zusammengesucht.",
        "chips": [
          "Jahresformulare",
          "Pro Land",
          "Kein Stress"
      ...
      {
        "title": "Stunden für Sie übernommen",
        "body": "Freigegebene Stunden kommen direkt aus Time & Attendance, mit bereits berechneten Überstunden - kein erneutes Eintippen zwischen Systemen.",
        "chips": [
          "Aus Stempeldaten",
      ...
      {
        "title": "Jeder Lauf, belegbar",
        "body": "Eine verständliche Vorschau und ein Beleg-Pfad für jeden Lohnlauf ersetzen das Hin und Her - damit jeder Abschluss einer Prüfung standhält.",
        "chips": [
          "Klare Vorschau",
          "Beleg-Pfad",
          "Prüfungsbereit"
  ...
  "nl": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "staten, provincies & steden"
      },
      {
        "value": "Jaareind-klaar",
        "label": "de juiste formulieren, overal"
      },
      {
        "value": "Eerst gecontroleerd",
        "label": "voordat iemand betaald wordt"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Jaareinde, geregeld",
        "body": "De jaarlijkse belastingformulieren die medewerkers en autoriteiten in elk land verwachten - gegenereerd, niet bij elkaar gezocht in een spreadsheet.",
        "chips": [
          "Jaarformulieren",
          "Per land",
          "Geen gedoe"
      ...
      {
        "title": "Uren voor je opgehaald",
        "body": "Goedgekeurde uren komen rechtstreeks uit Time & Attendance met overuren al uitgerekend - niets opnieuw intypen tussen systemen.",
        "chips": [
          "Uit klokmomenten",
          "Overuren geregeld",
          "Geen overtypen"
      ...
      {
        "title": "Elke run, verdedigbaar",
        "body": "Een begrijpelijke preview en een papieren spoor voor elke loonrun vervangen het heen-en-weer - zodat elke afsluiting een controle doorstaat.",
        "chips": [
          "Heldere preview",
          "Papieren spoor",
          "Inspectieklaar"
  ...
  "pt": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "estados, províncias & cidades"
      },
      {
        "value": "Pronto para o fim de ano",
        "label": "os formulários certos, em todo o lado"
      },
      {
        "value": "Conferido primeiro",
        "label": "antes de alguém receber"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Fim de ano, resolvido",
        "body": "Os formulários fiscais anuais que colaboradores e autoridades esperam em cada país - gerados, não caçados numa folha de cálculo.",
        "chips": [
          "Formulários anuais",
          "Por país",
          "Sem correrias"
      ...
      {
        "title": "Horas puxadas por si",
        "body": "As horas aprovadas vêm diretamente do Time & Attendance com as horas extra já calculadas - sem redigitar entre sistemas.",
        "chips": [
          "Dos registos de ponto",
          "Horas extra resolvidas",
          "Sem redigitar"
        ]
      },
      {
        "title": "Cada processamento, defensável",
        "body": "Uma pré-visualização em linguagem clara e um rasto documental para cada processamento substituem o vaivém - para cada fecho resistir a uma conferência.",
        "chips": [
          "Pré-visualização clara",
          "Rasto documental",
  ...
  "hi": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "राज्य, प्रांत और शहर"
      },
      {
        "value": "साल-अंत तैयार",
        "label": "हर जगह सही फ़ॉर्म"
      },
      {
        "value": "पहले जाँच",
        "label": "किसी को भुगतान से पहले"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "साल का अंत, संभाला हुआ",
        "body": "हर देश में कर्मचारी और अधिकारी जो सालाना टैक्स फ़ॉर्म चाहते हैं - तैयार किए हुए, स्प्रेडशीट में ढूँढे हुए नहीं।",
        "chips": [
          "सालाना फ़ॉर्म",
          "हर देश के लिए",
          "कोई आपाधापी नहीं"
      ...
      {
        "title": "घंटे आपके लिए खींचे हुए",
        "body": "मंज़ूर घंटे सीधे Time & Attendance से आते हैं, ओवरटाइम पहले से हिसाब किया हुआ - सिस्टमों के बीच कुछ दोबारा टाइप नहीं।",
        "chips": [
          "क्लॉक-इन से",
          "ओवरटाइम तय",
          "दोबारा टाइप नहीं"
      ...
      {
        "title": "हर रन, बचाव लायक़",
        "body": "हर पे-रन के लिए सरल भाषा में प्रीव्यू और एक पेपर ट्रेल आगे-पीछे की झंझट की जगह ले लेते हैं - ताकि हर क्लोज़ जाँच में खरा उतरे।",
        "chips": [
          "सरल प्रीव्यू",
          "पेपर ट्रेल",
          "ऑडिट-तैयार"
  ...
  "ur": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "ریاستیں، صوبے اور شہر"
      },
      {
        "value": "سال کے آخر کے لیے تیار",
        "label": "ہر جگہ صحیح فارم"
      },
      {
        "value": "پہلے جانچ",
        "label": "کسی کو ادائیگی سے پہلے"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "سال کا آخر، سنبھالا ہوا",
        "body": "ہر ملک میں ملازم اور حکام جو سالانہ ٹیکس فارم چاہتے ہیں - تیار کیے ہوئے، اسپریڈ شیٹ میں ڈھونڈے ہوئے نہیں۔",
        "chips": [
          "سالانہ فارم",
          "ہر ملک کے لیے",
          "کوئی افراتفری نہیں"
      ...
      {
        "title": "گھنٹے آپ کے لیے کھینچے ہوئے",
        "body": "منظور شدہ گھنٹے سیدھے Time & Attendance سے آتے ہیں، اوور ٹائم پہلے سے حساب کیا ہوا - سسٹمز کے درمیان کچھ دوبارہ ٹائپ نہیں۔",
        "chips": [
          "کلاک ان سے",
          "اوور ٹائم طے",
          "دوبارہ ٹائپ نہیں"
      ...
      {
        "title": "ہر رن، قابلِ دفاع",
        "body": "ہر پے رن کے لیے سادہ زبان میں پیش منظر اور ایک پیپر ٹریل آگے پیچھے کی جھنجھٹ کی جگہ لے لیتے ہیں - تاکہ ہر کلوز جانچ میں پورا اترے۔",
        "chips": [
          "سادہ پیش منظر",
          "پیپر ٹریل",
          "آڈٹ کے لیے تیار"
  ...
  "it": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "stati, province e città"
      },
      {
        "value": "Pronti a fine anno",
        "label": "i moduli giusti, ovunque"
      },
      {
        "value": "Prima il controllo",
        "label": "prima che qualcuno sia pagato"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Fine anno, gestito",
        "body": "I moduli fiscali annuali che dipendenti e autorità si aspettano in ogni paese - generati, non rincorsi in un foglio di calcolo.",
        "chips": [
          "Moduli annuali",
          "Per ogni paese",
          "Nessuna corsa"
      ...
      {
        "title": "Ore importate per te",
        "body": "Le ore approvate arrivano dritte da Time & Attendance con lo straordinario già calcolato - nessun reinserimento tra sistemi.",
        "chips": [
          "Dalle timbrature",
      ...
      {
        "title": "Ogni elaborazione, difendibile",
        "body": "Un'anteprima in linguaggio chiaro e una tracciabilità per ogni elaborazione sostituiscono il continuo avanti e indietro - così ogni chiusura regge a un controllo.",
        "chips": [
          "Anteprima chiara",
          "Tracciabilità",
          "Pronto per audit"
  ...
  "pl": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "stanów, prowincji i miast"
      },
      {
        "value": "Gotowe na koniec roku",
        "label": "właściwe formularze, wszędzie"
      },
      {
        "value": "Najpierw sprawdzone",
        "label": "zanim ktokolwiek dostanie wypłatę"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Koniec roku ogarnięty",
        "body": "Roczne formularze podatkowe, których w każdym kraju oczekują pracownicy i urzędy - generowane, nie wyłuskiwane z arkusza.",
        "chips": [
          "Formularze roczne",
          "Per kraj",
          "Bez pośpiechu"
      ...
      {
        "title": "Godziny zaciągane za Ciebie",
        "body": "Zatwierdzone godziny przychodzą prosto z Time & Attendance z już policzonymi nadgodzinami - bez przepisywania między systemami.",
        "chips": [
          "Z odbić",
      ...
      {
        "title": "Każde naliczenie do obrony",
        "body": "Podgląd w prostym języku i ślad audytowy dla każdego naliczenia zastępują wymianę maili - więc każde zamknięcie obroni się w kontroli.",
        "chips": [
          "Prosty podgląd",
          "Ślad audytowy",
          "Gotowe na audyt"
  ...
  "tr": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "eyalet, il ve şehir"
      },
      {
        "value": "Yıl sonuna hazır",
        "label": "her yerde doğru formlar"
      },
      {
        "value": "Önce kontrol",
        "label": "kimse ödenmeden önce"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Yıl sonu halledilir",
        "body": "Her ülkede çalışanların ve kurumların beklediği yıllık vergi formları - bir tabloda aranmaz, üretilir.",
        "chips": [
          "Yıllık formlar",
          "Ülkeye özel",
          "Telaş yok"
      ...
      {
        "title": "Saatler sizin için çekilir",
        "body": "Onaylanan saatler doğrudan Time & Attendance'tan fazla mesai zaten hesaplanmış hâlde gelir - sistemler arasında yeniden giriş yok.",
        "chips": [
          "Girişlerden",
          "Fazla mesai hesaplı",
          "Yeniden yazma yok"
      ...
      {
        "title": "Her hesaplama savunulabilir",
        "body": "Her bordro hesabı için sade dildeki bir önizleme ve bir kayıt izi, gidip gelmelerin yerini alır - böylece her kapanış bir denetimde ayakta kalır.",
        "chips": [
          "Sade önizleme",
          "Kayıt izi",
          "Denetime hazır"
  ...
  "zh-Hans": {
    ...
    "features": [
      ...
      {
        "title": "年终,一手包办",
        "body": "各国员工和当局所期望的年度税务表单 -  - 直接生成,无需在表格里翻找。",
        "chips": [
          "年度表单",
          "按国家",
          "不必手忙脚乱"
      ...
      {
        "title": "工时自动为你拉取",
        "body": "已核准的工时直接来自 Time & Attendance,加班已算好 -  - 系统之间无需重新录入。",
        "chips": [
          "源自打卡",
          "加班已算清",
          "无需重录"
      ...
      {
        "title": "每次核算,皆可站得住脚",
        "body": "每次发薪核算都配有通俗易懂的预览和一条记录轨迹,取代来回沟通 -  - 所以每次结账都经得起核查。",
        "chips": [
          "通俗预览",
          "记录轨迹",
          "随时备查"
  ...
  "ja": {
    ...
    "features": [
      ...
      {
        "title": "年末も、おまかせ",
        "body": "各国で従業員と当局が求める年次の税書類を、表計算で追いかけるのではなく、生成します。",
        "chips": [
          "年次書類",
          "国ごと",
          "ドタバタなし"
      ...
      {
        "title": "時間は自動で取り込み",
        "body": "承認された時間は残業も計算済みで Time & Attendance から直接。システム間の再入力はありません。",
        "chips": [
          "打刻から",
          "残業も計算済み",
          "再入力なし"
      ...
      {
        "title": "すべての処理に裏付け",
        "body": "わかりやすいプレビューと各処理の証跡が、やり取りを置き換えます。だからどの締めも、チェックに耐えます。",
        "chips": [
          "明快なプレビュー",
          "証跡",
          "監査対応"
  ...
  "ko": {
    ...
    "features": [
      ...
      {
        "title": "연말 처리, 완료",
        "body": "각 나라에서 직원과 당국이 요구하는 연간 세무 서식 - 스프레드시트에서 쫓아다니는 게 아니라 자동 생성됩니다.",
        "chips": [
          "연간 서식",
          "나라별",
          "허둥대지 않음"
      ...
      {
        "title": "시간은 자동으로 연동",
        "body": "승인된 시간이 초과근무까지 계산되어 Time & Attendance에서 곧바로 들어옵니다 - 시스템 간 재입력이 없습니다.",
        "chips": [
          "출근 기록 연동",
          "초과근무 정리",
          "재입력 불필요"
      ...
      {
        "title": "모든 급여 산정, 근거 확실",
        "body": "각 급여 산정의 쉬운 설명 미리보기와 기록이 주고받기를 대체합니다 - 그래서 모든 마감이 점검을 견딥니다.",
        "chips": [
          "쉬운 미리보기",
          "기록 추적",
          "감사 대비"
  ...
  "id": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "negara bagian, provinsi & kota"
      },
      {
        "value": "Siap akhir tahun",
        "label": "formulir tepat, di mana saja"
      },
      {
        "value": "Diperiksa dulu",
        "label": "sebelum siapa pun digaji"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Akhir tahun, beres",
        "body": "Formulir pajak tahunan yang diharapkan karyawan dan otoritas di tiap negara - dibuat otomatis, bukan dikejar-kejar di spreadsheet.",
        "chips": [
          "Formulir tahunan",
          "Per negara",
          "Tanpa panik"
      ...
      {
        "title": "Jam kerja ditarik untuk Anda",
        "body": "Jam kerja yang disetujui datang langsung dari Time & Attendance dengan lembur sudah terhitung - tanpa input ulang antar sistem.",
        "chips": [
          "Dari absensi",
          "Lembur beres",
          "Tanpa ketik ulang"
      ...
      {
        "title": "Setiap proses, bisa dipertanggungjawabkan",
        "body": "Pratinjau berbahasa jelas dan jejak dokumen untuk tiap proses gaji menggantikan tarik-ulur - jadi setiap penutupan tahan diperiksa.",
        "chips": [
          "Pratinjau jelas",
          "Jejak dokumen",
          "Siap audit"
  ...
  "vi": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "bang, tỉnh & thành phố"
      },
      {
        "value": "Sẵn sàng cuối năm",
        "label": "đúng biểu mẫu, ở mọi nơi"
      },
      {
        "value": "Kiểm tra trước",
        "label": "trước khi ai đó được trả lương"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Cuối năm, lo trọn",
        "body": "Các biểu mẫu thuế thường niên mà nhân viên và cơ quan chức năng mong đợi ở từng nước - được tạo ra, chứ không phải lùng sục trong bảng tính.",
        "chips": [
          "Biểu mẫu năm",
          "Theo quốc gia",
          "Không cuống cuồng"
      ...
      {
        "title": "Giờ công kéo vào sẵn cho bạn",
        "body": "Giờ đã duyệt đến thẳng từ Time & Attendance với làm thêm đã tính sẵn - không gõ lại giữa các hệ thống.",
        "chips": [
          "Từ chấm công",
          "Tính sẵn làm thêm",
          "Không gõ lại"
      ...
      {
        "title": "Mỗi kỳ lương, bảo vệ được",
        "body": "Bản xem trước bằng ngôn ngữ dễ hiểu và dấu vết lưu trữ cho từng kỳ lương thay cho cảnh tới lui - nên mỗi lần chốt đều đứng vững trước kiểm tra.",
        "chips": [
          "Xem trước dễ hiểu",
          "Dấu vết lưu trữ",
          "Sẵn sàng kiểm toán"
  ...
  "ro": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "state, provincii & orașe"
      },
      {
        "value": "Pregătit de sfârșit de an",
        "label": "formularele corecte, peste tot"
      },
      {
        "value": "Verificat întâi",
        "label": "înainte ca cineva să fie plătit"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Sfârșitul de an, rezolvat",
        "body": "Formularele fiscale anuale pe care angajații și autoritățile le așteaptă în fiecare țară - generate, nu vânate într-un tabel.",
        "chips": [
          "Formulare anuale",
          "Per țară",
          "Fără agitație"
      ...
      {
        "title": "Orele aduse pentru tine",
        "body": "Orele aprobate vin direct din Time & Attendance cu orele suplimentare deja calculate - fără retastare între sisteme.",
        "chips": [
          "Din pontaje",
      ...
      {
        "title": "Fiecare rulare, de neclintit",
        "body": "O previzualizare în limbaj simplu și o urmă documentară pentru fiecare rulare de salarii înlocuiesc dus-întorsul - așa că fiecare închidere rezistă la un control.",
        "chips": [
  ...
  "sv": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "delstater, provinser & städer"
      },
      {
        "value": "Årsskiftesklar",
        "label": "rätt blanketter, överallt"
      },
      {
        "value": "Granskat först",
        "label": "innan någon får betalt"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Årsskiftet, hanterat",
        "body": "De årliga skatteblanketterna som anställda och myndigheter förväntar sig i varje land - genererade, inte ihopjagade i ett kalkylark.",
        "chips": [
          "Årsblanketter",
          "Per land",
          "Ingen panik"
      ...
      {
        "title": "Timmar hämtade åt dig",
        "body": "Godkända timmar kommer direkt från Time & Attendance med övertiden redan uträknad - ingen omskrivning mellan system.",
        "chips": [
          "Från instämplingar",
          "Övertid uträknad",
          "Ingen omskrivning"
      ...
      {
        "title": "Varje körning, försvarbar",
        "body": "En förhandsgranskning på vanlig svenska och ett spår för varje lönekörning ersätter fram-och-tillbaka - så att varje avslut håller för en granskning.",
        "chips": [
          "Enkel förhandsgranskning",
          "Spårbar historik",
          "Redo för revision"
        ]
      }
  ...
  "bn": {
    ...
    "heroProof": [
      {
        "value": "৩৯+ দেশ",
        "label": "যুক্তরাষ্ট্র, কানাডা, যুক্তরাজ্য, EU ও GCC"
      },
      {
        "value": "১০০+",
        "label": "রাজ্য, প্রদেশ ও শহর"
      },
      {
        "value": "বছরশেষে প্রস্তুত",
        "label": "সঠিক ফর্ম, সর্বত্র"
      },
      {
        "value": "আগে যাচাই",
        "label": "কাউকে বেতন দেওয়ার আগে"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "বছরশেষ, সামলানো",
        "body": "প্রতিটি দেশে কর্মী ও কর্তৃপক্ষ যে বার্ষিক ট্যাক্স ফর্ম চায় - তা তৈরি হয়, স্প্রেডশিটে খুঁজে বেড়াতে হয় না।",
        "chips": [
          "বার্ষিক ফর্ম",
          "প্রতি দেশ",
          "কোনো হুড়োহুড়ি নেই"
      ...
      {
        "title": "ঘণ্টা আপনার হয়ে টানা",
        "body": "অনুমোদিত ঘণ্টা সরাসরি Time & Attendance থেকে আসে, ওভারটাইম হিসাব করা থাকে - সিস্টেমে সিস্টেমে নতুন করে টাইপ নেই।",
        "chips": [
          "ক্লক-ইন থেকে",
          "ওভারটাইম সমাধান",
          "নতুন টাইপিং নেই"
      ...
      {
        "title": "প্রতিটি রান, যুক্তিযুক্ত",
        "body": "প্রতিটি পে রানের সহজ-ভাষার প্রিভিউ আর কাগুজে নথি বারবার যোগাযোগের জায়গা নেয় - তাই প্রতিটি ক্লোজ যাচাইয়ে টিকে থাকে।",
        "chips": [
          "সহজ প্রিভিউ",
          "কাগুজে নথি",
          "অডিট-প্রস্তুত"
  ...
  "th": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "รัฐ จังหวัด และเมือง"
      },
      {
        "value": "พร้อมสิ้นปี",
        "label": "แบบฟอร์มที่ถูกต้อง ทุกที่"
      },
      {
        "value": "ตรวจก่อน",
        "label": "ก่อนจ่ายให้ใคร"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "สิ้นปี จัดการให้",
        "body": "แบบฟอร์มภาษีประจำปีที่พนักงานและทางการของแต่ละประเทศต้องการ สร้างให้ ไม่ต้องไล่หาในสเปรดชีต",
        "chips": [
          "แบบฟอร์มประจำปี",
          "แยกตามประเทศ",
          "ไม่ต้องวุ่นวาย"
      ...
      {
        "title": "ดึงชั่วโมงมาให้",
        "body": "ชั่วโมงที่อนุมัติแล้วมาตรงจาก Time & Attendance พร้อมคำนวณล่วงเวลาแล้ว ไม่ต้องคีย์ซ้ำระหว่างระบบ",
        "chips": [
          "จากการลงเวลา",
          "จัดการล่วงเวลาแล้ว",
          "ไม่ต้องพิมพ์ใหม่"
      ...
      {
        "title": "ทุกรอบจ่าย ยืนยันได้",
        "body": "ตัวอย่างแบบภาษาคนเข้าใจง่ายและร่องรอยเอกสารของแต่ละรอบจ่าย มาแทนการไปมาหลายรอบ ทุกการปิดรอบจึงผ่านการตรวจสอบได้",
        "chips": [
          "ตัวอย่างเข้าใจง่าย",
          "ร่องรอยเอกสาร",
          "พร้อมตรวจสอบ"
  ...
  "ms": {
    ...
    "heroProof": [
      ...
      {
        "value": "100+",
        "label": "negeri, wilayah & bandar"
      },
      {
        "value": "Sedia hujung tahun",
        "label": "borang yang betul, di mana-mana"
      },
      {
        "value": "Disemak dahulu",
        "label": "sebelum sesiapa dibayar"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Hujung tahun, diuruskan",
        "body": "Borang cukai tahunan yang dijangka pekerja dan pihak berkuasa di setiap negara - dijana, bukan dikejar dalam hamparan.",
        "chips": [
          "Borang tahunan",
          "Setiap negara",
          "Tiada kelam-kabut"
      ...
      {
        "title": "Jam ditarik masuk untuk anda",
        "body": "Jam yang diluluskan datang terus dari Time & Attendance dengan lebih masa sudah dikira - tiada kunci semula antara sistem.",
        "chips": [
          "Dari ketik masuk",
          "Lebih masa selesai",
          "Tiada taip semula"
      ...
      {
        "title": "Setiap larian, boleh dipertahankan",
        "body": "Pratonton dalam bahasa mudah dan jejak dokumen bagi setiap larian gaji menggantikan ulang-alik - jadi setiap penutupan bertahan dalam pemeriksaan.",
        "chips": [
          "Pratonton mudah",
          "Jejak dokumen",
          "Sedia diaudit"
