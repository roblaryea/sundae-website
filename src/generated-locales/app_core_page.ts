...
export const generatedLocalCopy = {
  "localizedCoreCopy": {
    "fr": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Ventes & Rythme",
            "description": "Suivi des ventes intrajournalières, KPI et visualisation des tendances horaires",
            "icon": "chart"
          },
          {
            "name": "Main-d'œuvre en Direct",
            "description": "Suivi de la main-d'œuvre intrajournalière, risque de heures supplémentaires et conformité des pauses",
            "icon": "benchmarking"
          },
          {
            "name": "Surveillance des Fuites",
            "description": "Surveillance en temps réel des annulations, compensations et remises par shift",
            "icon": "cost"
          },
          {
            "name": "Flux",
            "description": "Goulots d'étranglement de débit, arriérés et métriques de rythme de cuisine",
            "icon": "speed"
          },
          {
            "name": "Intelligence du Menu",
            "description": "Catalogue d'articles, matrice de classification (Étoiles/Travailleurs/Énigmes/Chiens)",
            "icon": "insights"
          },
          {
            "name": "Alertes & Playbooks",
            "description": "Flux de travail de réponse automatisés déclenchés par des exceptions",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Signaux de coaching au niveau du shift pour les Ventes, Fuites et Flux",
            "icon": "intelligence"
          },
          {
            "name": "Classement du Portefeuille",
            "description": "Comparaison de performance multi-sites avec suivi des séries",
            "icon": "multiLocation"
          },
          {
            "name": "Mode Wallboard",
            "description": "Affichage plein écran pour les cuisines ou les écrans de salle",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        ...
        "description": "Core se connecte à 12 domaines de données avec plus de 80 intégrations de fournisseurs.",
        "items": [
          {
            "category": "Systèmes de POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus de connecteurs de base de données directs",
            "icon": "integration"
          },
          {
            "category": "Main-d'œuvre",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
          ...
          {
            "category": "Livraison & Marketing",
            "examples": "Deliverect, Uber Eats, DoorDash, Meta, Google Ads, Mailchimp",
            "icon": "marketing"
          }
        ]
      },
      "modules": {
        "heading": "Ajouter des modules pour une intelligence spécialisée",
        "description": "Approfondissez Core avec des modules ciblés pour vos défis opérationnels spécifiques.",
        "items": [
          {
            "name": "Intelligence du travail",
            "description": "Optimisation des horaires en temps réel, demande de main-d'œuvre prédictive",
            "icon": "benchmarking"
          },
          {
            "name": "Intelligence des stocks",
            "description": "Suivi des déchets en temps réel, niveaux de par automatisés",
            "icon": "insights"
          },
          {
            "name": "Intelligence des achats",
            "description": "Optimisation des prix en temps réel, comparaison des fournisseurs",
            "icon": "marketing"
          },
          {
            "name": "Intelligence marketing",
            "description": "Suivi des campagnes en temps réel, surveillance du CAC",
            "icon": "growth"
          },
          {
            "name": "Intelligence des réservations",
            "description": "Modèles de réservation en temps réel, optimisation des tables",
            "icon": "operators"
          }
        ],
    ...
    "es": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Ventas y Ritmo",
            "description": "Ritmo de ventas intradía, KPIs y visualización de tendencias horarias",
            "icon": "chart"
          },
          {
            "name": "Labor en Vivo",
            "description": "Ritmo de mano de obra intradía, seguimiento de riesgo de horas extras y cumplimiento de descansos",
            "icon": "benchmarking"
          },
          {
            "name": "Monitoreo de Fugas",
            "description": "Monitoreo en tiempo real de anulaciones, compensaciones y descuentos por turno",
            "icon": "cost"
          },
          {
            "name": "Flujo",
            "description": "Cuellos de botella en el rendimiento, acumulación y métricas de ritmo de cocina",
            "icon": "speed"
          },
          {
            "name": "Inteligencia de Menú",
            "description": "Catálogo de artículos, matriz de clasificación (Estrellas/Plowhorses/Puzzles/Perros)",
            "icon": "insights"
          },
          {
            "name": "Alertas y Manuales de Respuesta",
            "description": "Flujos de trabajo de respuesta automatizados activados por excepciones",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Señales de entrenamiento a nivel de turno para Ventas, Fugas y Flujo",
            "icon": "intelligence"
          },
          {
            "name": "Tabla de Clasificación de Portafolio",
            "description": "Comparación de rendimiento entre múltiples locales con seguimiento de rachas",
            "icon": "multiLocation"
          },
          {
            "name": "Modo de Pantalla Completa",
            "description": "Pantalla completa para cocina o pantallas de atención al cliente",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        ...
        "description": "Core se conecta a través de 12 dominios de datos con más de 80 integraciones de proveedores.",
        "items": [
          {
            "category": "Sistemas POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, además de conectores de base de datos directos",
            "icon": "integration"
          },
          {
            "category": "Laboral/ Fuerza de Trabajo",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Inventario y Compras",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        ...
        "description": "Profundiza en Core con módulos enfocados en tus desafíos operativos específicos.",
        "items": [
          {
            "name": "Inteligencia Laboral",
            "description": "Optimización de horarios en tiempo real, demanda laboral predictiva",
            "icon": "benchmarking"
          },
          {
            "name": "Inteligencia de Inventario",
            "description": "Seguimiento de desperdicios en tiempo real, niveles de par automatizados",
            "icon": "insights"
          },
          {
            "name": "Inteligencia de Compras",
            "description": "Optimización de precios en tiempo real, comparación de proveedores",
            "icon": "marketing"
          },
          {
            "name": "Inteligencia de Marketing",
            "description": "Seguimiento de campañas en tiempo real, monitoreo de CAC",
            "icon": "growth"
          },
          {
            "name": "Inteligencia de Reservas",
            "description": "Patrones de reservas en tiempo real, optimización de mesas",
            "icon": "operators"
          }
        ],
    ...
    "de": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Verkäufe & Tempo",
            "description": "Intraday-Verkaufspacing, KPIs und stündliche Trendvisualisierung",
            "icon": "chart"
          },
          {
            "name": "Live-Arbeitskraft",
            "description": "Intraday-Arbeitskraft-Pacing, Überstundenrisikoverfolgung und Pauseneinhaltung",
            "icon": "benchmarking"
          },
          {
            "name": "Leckageüberwachung",
            "description": "Echtzeitüberwachung von Stornierungen, Kompensationen und Rabatten pro Schicht",
            "icon": "cost"
          },
          {
            "name": "Flow",
            "description": "Engpässe im Durchsatz, Rückstand und Küchen-Pacing-Metriken",
            "icon": "speed"
          },
          {
            "name": "Menü-Intelligenz",
            "description": "Artikelkatalog, Klassifikationsmatrix (Stars/Plowhorses/Puzzles/Dogs)",
            "icon": "insights"
          },
          {
            "name": "Benachrichtigungen & Playbooks",
            "description": "Automatisierte Reaktions-Workflows, die durch Ausnahmen ausgelöst werden",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Coaching-Signale auf Schichtebene für Verkäufe, Leckage und Flow",
            "icon": "intelligence"
          },
          {
            "name": "Portfolio-Leaderboard",
            "description": "Leistungsvergleich mehrerer Standorte mit Streak-Verfolgung",
            "icon": "multiLocation"
          },
          {
            "name": "Wallboard-Modus",
            "description": "Vollbildanzeige für Küchen- oder Front-of-House-Bildschirme",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Verbinden Sie Alle Ihre Systeme",
        "description": "Core verbindet sich über 12 Datenbereiche mit über 80 Anbieter-Integrationen.",
        "items": [
          {
            "category": "POS-Systeme",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus direkte Datenbankverbindungen",
            "icon": "integration"
          },
          {
            "category": "Personal/Arbeitskräfte",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Inventar & Einkauf",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        "heading": "Module für spezialisierte Intelligenz hinzufügen",
        "description": "Erweitern Sie Core mit fokussierten Modulen für Ihre spezifischen Betriebsherausforderungen.",
        "items": [
          {
            "name": "Arbeitskräfte-Intelligenz",
            "description": "Echtzeit-Planungsoptimierung, prognostizierter Arbeitskräftebedarf",
            "icon": "benchmarking"
          },
          {
            "name": "Bestands-Intelligenz",
            "description": "Echtzeit-Abfallverfolgung, automatisierte Mindestbestände",
            "icon": "insights"
          },
          {
            "name": "Einkaufs-Intelligenz",
            "description": "Echtzeit-Preisoptimierung, Anbieter-Vergleich",
            "icon": "marketing"
          },
          {
            "name": "Marketing-Intelligenz",
            "description": "Echtzeit-Kampagnenverfolgung, CAC-Überwachung",
            "icon": "growth"
          },
          {
            "name": "Reservierungs-Intelligenz",
            "description": "Echtzeit-Buchungsmuster, Tischoptimierung",
            "icon": "operators"
          }
        ],
    ...
    "nl": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Verkoop & Tempo",
            "description": "Intraday verkooptempo, KPI's en uurtrendvisualisatie",
            "icon": "chart"
          },
          {
            "name": "Arbeid Live",
            "description": "Intraday arbeidspacing, risico op overuren en naleving van pauzes",
            "icon": "benchmarking"
          },
          {
            "name": "Lekmonitoring",
            "description": "Realtime monitoring van annuleringen, compensaties en kortingen per shift",
            "icon": "cost"
          },
          {
            "name": "Flow",
            "description": "Doorvoerflessenhalzen, achterstanden en keuken pacing metrics",
            "icon": "speed"
          },
          {
            "name": "Menu-intelligentie",
            "description": "Itemcatalogus, classificatiematrix (Sterren/Plowhorses/Puzzels/Honden)",
            "icon": "insights"
          },
          {
            "name": "Waarschuwingen & Playbooks",
            "description": "Geautomatiseerde responsworkflows geactiveerd door uitzonderingen",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Coaching signalen op shift-niveau voor Verkoop, Lek en Flow",
            "icon": "intelligence"
          },
          {
            "name": "Portfolio Ranglijst",
            "description": "Prestatievergelijking tussen meerdere locaties met streak tracking",
            "icon": "multiLocation"
          },
          {
            "name": "Wallboard Modus",
            "description": "Volledig scherm voor keuken of front-of-house schermen",
            "icon": "canvas"
          }
        ]
      },
        ...
        "items": [
          {
            ...
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus directe databaseverbindingen",
            "icon": "integration"
          },
          {
            "category": "Arbeid/Arbeidskrachten",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Voorraad & Aankoop",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
        ...
        "items": [
          {
            ...
            "description": "Realtime planningoptimalisatie, voorspellende arbeidsvraag",
            "icon": "benchmarking"
          },
          {
            "name": "Voorraadintelligentie",
            "description": "Realtime afvaltracking, geautomatiseerde par-niveaus",
            "icon": "insights"
          },
          {
            "name": "Inkoopintelligentie",
            "description": "Realtime prijsoptimalisatie, leveranciersvergelijking",
            "icon": "marketing"
          },
          {
            "name": "Marketingintelligentie",
            "description": "Realtime campagne-tracking, CAC-monitoring",
            "icon": "growth"
          },
          {
            "name": "Reserveringsintelligentie",
            "description": "Realtime boekingspatronen, tafeloptimalisatie",
            "icon": "operators"
          }
        ],
        ...
        "features": [
          {
            ...
            "description": "تسارع المبيعات خلال اليوم، مؤشرات الأداء الرئيسية، ورؤية الاتجاهات بالساعة",
            "icon": "chart"
          },
          {
            "name": "العمالة المباشرة",
            "description": "تسارع العمالة خلال اليوم، تتبع مخاطر العمل الإضافي، والامتثال لفترات الراحة",
            "icon": "benchmarking"
          },
          {
            "name": "مراقبة التسرب",
            "description": "مراقبة فورية للإلغاء، التعويض، والخصومات لكل نوبة",
            "icon": "cost"
          },
          {
            "name": "التدفق",
            "description": "اختناقات الإنتاج، المتأخرات، ومقاييس تسارع المطبخ",
            "icon": "speed"
          },
          {
            "name": "ذكاء القائمة",
            "description": "فهرس العناصر، مصفوفة التصنيف (نجوم/خيول العمل/ألغاز/كلاب)",
            "icon": "insights"
          },
          {
            "name": "التنبيهات وكتيبات التشغيل",
            "description": "سير عمل استجابة تلقائية يتم تفعيلها بواسطة الاستثناءات",
            "icon": "forecasting"
          },
          {
            "name": "مدرب Sundae",
            "description": "إشارات تدريب على مستوى النوبة للمبيعات، التسرب، والتدفق",
            "icon": "intelligence"
          },
          {
            "name": "لوحة المتصدرين",
            "description": "مقارنة أداء متعددة المواقع مع تتبع السلاسل",
            "icon": "multiLocation"
          },
          {
            "name": "وضع لوحة العرض",
            "description": "عرض كامل الشاشة لشاشات المطبخ أو الواجهة الأمامية",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "قم بتوصيل جميع أنظمتك",
        ...
        "items": [
          ...
          {
            "category": "العمالة/القوى العاملة",
            "examples": "7shifts، HotSchedules، Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "المخزون والشراء",
            "examples": "MarketMan، Craftable، BinWise",
            "icon": "insights"
          },
          {
    ...
    "pt": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Vendas & Ritmo",
            "description": "Ritmo de vendas intradiário, KPIs e visualização de tendências horárias",
            "icon": "chart"
          },
          {
            "name": "Mão de Obra Ao Vivo",
            "description": "Ritmo de mão de obra intradiário, rastreamento de risco de horas extras e conformidade de pausas",
            "icon": "benchmarking"
          },
          {
            "name": "Monitoramento de Vazamentos",
            "description": "Monitoramento em tempo real de anulações, compensações e descontos por turno",
            "icon": "cost"
          },
          {
            "name": "Fluxo",
            "description": "Gargalos de throughput, backlog e métricas de ritmo da cozinha",
            "icon": "speed"
          },
          {
            "name": "Inteligência do Menu",
            "description": "Catálogo de itens, matriz de classificação (Estrelas/Cavalos de Trabalho/Puzzles/Cães)",
            "icon": "insights"
          },
          {
            "name": "Alertas & Playbooks",
            "description": "Fluxos de trabalho de resposta automatizados acionados por exceções",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Sinais de coaching em nível de turno para Vendas, Vazamentos e Fluxo",
            "icon": "intelligence"
          },
          {
            "name": "Classificação de Portfólio",
            "description": "Comparação de desempenho entre múltiplos locais com rastreamento de sequências",
            "icon": "multiLocation"
          },
          {
            "name": "Modo Wallboard",
            "description": "Exibição em tela cheia para telas de cozinha ou de atendimento ao cliente",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Conecte Todos os Seus Sistemas",
        "description": "O Core conecta-se em 12 domínios de dados com mais de 80 integrações de fornecedores.",
        "items": [
          {
            "category": "Sistemas de POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, além de conectores de banco de dados diretos",
            "icon": "integration"
          },
          {
      ...
      "modules": {
        "heading": "Adicione Módulos para Inteligência Especializada",
        "description": "Aprofunde o Core com módulos focados em seus desafios operacionais específicos.",
        "items": [
          {
            "name": "Inteligência de Mão de Obra",
            "description": "Otimização de horários em tempo real, demanda de mão de obra preditiva",
            "icon": "benchmarking"
          },
          {
            "name": "Inteligência de Inventário",
            "description": "Rastreamento de desperdício em tempo real, níveis de par automatizados",
            "icon": "insights"
          },
          {
            "name": "Inteligência de Compras",
            "description": "Otimização de preços em tempo real, comparação de fornecedores",
            "icon": "marketing"
          },
          {
            "name": "Inteligência de Marketing",
            "description": "Rastreamento de campanhas em tempo real, monitoramento de CAC",
            "icon": "growth"
          },
          {
            "name": "Inteligência de Reservas",
            "description": "Padrões de reserva em tempo real, otimização de mesas",
            "icon": "operators"
          }
        ],
    ...
    "it": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Vendite & Ritmo",
            "description": "Pacing delle vendite intraday, KPI e visualizzazione delle tendenze orarie",
            "icon": "chart"
          },
          {
            "name": "Lavoro Live",
            "description": "Pacing del lavoro intraday, monitoraggio del rischio di straordinario e conformità alle pause",
            "icon": "benchmarking"
          },
          {
            "name": "Monitoraggio delle Perdite",
            "description": "Monitoraggio in tempo reale di annullamenti, compensazioni e sconti per turno",
            "icon": "cost"
          },
          {
            "name": "Flusso",
            "description": "Collo di bottiglia nel throughput, arretrati e metriche di pacing della cucina",
            "icon": "speed"
          },
          {
            "name": "Intelligenza del Menu",
            "description": "Catalogo degli articoli, matrice di classificazione (Stelle/Animali da Lavoro/Puzzle/Cani)",
            "icon": "insights"
          },
          {
            "name": "Avvisi & Playbook",
            "description": "Flussi di lavoro di risposta automatizzati attivati da eccezioni",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Segnali di coaching a livello di turno per Vendite, Perdite e Flusso",
            "icon": "intelligence"
          },
          {
            "name": "Classifica del Portafoglio",
            "description": "Confronto delle performance multi-sede con monitoraggio delle serie",
            "icon": "multiLocation"
          },
          {
            "name": "Modalità Wallboard",
            "description": "Visualizzazione a schermo intero per schermi di cucina o di sala",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Collega Tutti i Tuoi Sistemi",
        "description": "Core si connette attraverso 12 domini di dati con oltre 80 integrazioni di fornitori.",
        "items": [
          {
            "category": "Sistemi POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, oltre a connettori di database diretti",
            "icon": "integration"
          },
          {
            "category": "Lavoro/Forza Lavoro",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Inventario e Acquisti",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        "heading": "Aggiungi Moduli per Intelligenza Specializzata",
        "description": "Approfondisci Core con moduli mirati per le tue sfide operative specifiche.",
        "items": [
          {
            "name": "Intelligenza del Lavoro",
            "description": "Ottimizzazione degli orari in tempo reale, domanda di lavoro predittiva",
            "icon": "benchmarking"
          },
          {
            "name": "Intelligenza dell'Inventario",
            "description": "Tracciamento dei rifiuti in tempo reale, livelli di par automatizzati",
            "icon": "insights"
          },
          {
            "name": "Intelligenza degli Acquisti",
            "description": "Ottimizzazione dei prezzi in tempo reale, confronto fornitori",
            "icon": "marketing"
          },
          {
            "name": "Intelligenza di Marketing",
            "description": "Tracciamento delle campagne in tempo reale, monitoraggio del CAC",
            "icon": "growth"
          },
          {
            "name": "Intelligenza delle Prenotazioni",
            "description": "Modelli di prenotazione in tempo reale, ottimizzazione dei tavoli",
            "icon": "operators"
          }
        ],
    ...
    "hi": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "बिक्री और गति",
            "description": "इंट्राडे बिक्री की गति, KPI, और घंटेवार प्रवृत्ति दृश्यता",
            "icon": "chart"
          },
          {
            "name": "श्रम लाइव",
            "description": "इंट्राडे श्रम की गति, ओवरटाइम जोखिम ट्रैकिंग, और ब्रेक अनुपालन",
            "icon": "benchmarking"
          },
          {
            "name": "लीकेज मॉनिटरिंग",
            "description": "प्रत्येक शिफ्ट के लिए वास्तविक समय में वॉइड, कंप, और छूट की निगरानी",
            "icon": "cost"
          },
          {
            "name": "प्रवाह",
            "description": "थ्रूपुट बाधाएँ, बैकलॉग, और रसोई की गति मेट्रिक्स",
            "icon": "speed"
          },
          {
            "name": "मेनू इंटेलिजेंस",
            "description": "आइटम कैटलॉग, वर्गीकरण मैट्रिक्स (स्टार्स/प्लॉहॉर्स/पज़ल्स/डॉग्स)",
            "icon": "insights"
          },
          {
            "name": "अलर्ट और प्लेबुक्स",
            "description": "अपवादों द्वारा ट्रिगर किए गए स्वचालित प्रतिक्रिया कार्यप्रवाह",
            "icon": "forecasting"
          },
          {
            "name": "Sundae कोच",
          ...
          {
            "name": "पोर्टफोलियो लीडरबोर्ड",
            "description": "स्ट्रीक ट्रैकिंग के साथ मल्टी-आउटलेट प्रदर्शन तुलना",
            "icon": "multiLocation"
          },
          {
            "name": "वॉलबोर्ड मोड",
            "description": "रसोई या फ्रंट-ऑफ-हाउस स्क्रीन के लिए पूर्ण-स्क्रीन डिस्प्ले",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        ...
        "items": [
          {
            "category": "POS सिस्टम",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, साथ ही सीधे डेटाबेस कनेक्टर्स",
            "icon": "integration"
          },
          {
            "category": "श्रम/कार्यबल",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "इन्वेंटरी और खरीददारी",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
          ...
          {
            "category": "डिलीवरी और मार्केटिंग",
            "examples": "Deliverect, Uber Eats, DoorDash, Meta, Google Ads, Mailchimp",
            "icon": "marketing"
          }
        ]
        ...
        "items": [
          {
            ...
            "description": "वास्तविक समय में शेड्यूल अनुकूलन, पूर्वानुमानित श्रम मांग",
            "icon": "benchmarking"
          },
          {
          ...
          {
            "name": "खरीद बुद्धिमत्ता",
            "description": "वास्तविक समय में मूल्य अनुकूलन, विक्रेता तुलना",
            "icon": "marketing"
          },
          {
            "name": "मार्केटिंग बुद्धिमत्ता",
            "description": "वास्तविक समय में अभियान ट्रैकिंग, CAC निगरानी",
            "icon": "growth"
          },
          {
            "name": "आरक्षण बुद्धिमत्ता",
            "description": "वास्तविक समय में बुकिंग पैटर्न, टेबल अनुकूलन",
            "icon": "operators"
          }
        ],
    ...
    "ur": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "سیلز اور رفتار",
            "description": "انٹرا ڈے سیلز کی رفتار، KPI، اور گھنٹہ وار رجحان کی بصری نمائندگی",
            "icon": "chart"
          },
          {
            "name": "محنت براہ راست",
            "description": "انٹرا ڈے محنت کی رفتار، اوور ٹائم کے خطرات کی نگرانی، اور وقفے کی تعمیل",
            "icon": "benchmarking"
          },
          {
            "name": "لیکج مانیٹرنگ",
            "description": "ہر شفٹ کے لیے حقیقی وقت میں خالی، کمپ، اور رعایت کی نگرانی",
            "icon": "cost"
          },
          {
            "name": "فلو",
          ...
          {
            "name": "مینیو انٹیلی جنس",
            "description": "آئٹم کی کیٹلاگ، درجہ بندی کا میٹرکس (ستارے/پلاوہارس/پزلز/کتے)",
            "icon": "insights"
          },
          {
            "name": "الرٹس اور پلے بکس",
            "description": "استثناؤں کی بنیاد پر متحرک جواب کے ورک فلو",
            "icon": "forecasting"
          },
          {
            "name": "Sundae کوچ",
          ...
          {
            "name": "پورٹ فولیو لیڈر بورڈ",
            "description": "ملٹی آؤٹ لیٹ کی کارکردگی کا موازنہ اور سلسلے کی نگرانی",
            "icon": "multiLocation"
          },
          {
            "name": "وال بورڈ موڈ",
            "description": "کچن یا فرنٹ آف ہاؤس اسکرینز کے لیے مکمل اسکرین ڈسپلے",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        ...
        "items": [
          {
            "category": "POS سسٹمز",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, براہ راست ڈیٹا بیس کنیکٹرز",
            "icon": "integration"
          },
          {
            "category": "محنت/ورک فورس",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
      ...
      "modules": {
        "heading": "خصوصی ذہانت کے لیے ماڈیولز شامل کریں",
        "description": "اپنی مخصوص عملی چیلنجز کے لیے توجہ مرکوز ماڈیولز کے ساتھ Core کو گہرا کریں۔",
        "items": [
          {
            "name": "محنت کی ذہانت",
            "description": "حقیقی وقت میں شیڈول کی اصلاح، پیش گوئی کی جانے والی محنت کی طلب",
            "icon": "benchmarking"
          },
          {
            "name": "انویٹری ذہانت",
          ...
          },
          {
            ...
            "description": "حقیقی وقت میں قیمت کی اصلاح، فروشندہ کا موازنہ",
            "icon": "marketing"
          },
          {
            "name": "مارکیٹنگ کی ذہانت",
            "description": "حقیقی وقت میں مہم کی نگرانی، CAC کی نگرانی",
            "icon": "growth"
          },
          {
            "name": "ریزرویشن کی ذہانت",
            "description": "حقیقی وقت میں بکنگ کے پیٹرن، ٹیبل کی اصلاح",
            "icon": "operators"
          }
        ],
    ...
    "pl": {
        ...
        "features": [
          {
            ...
            "description": "Pacing sprzedaży w ciągu dnia, KPI i wizualizacja trendów godzinowych",
            "icon": "chart"
          },
          {
            "name": "Praca na Żywo",
            "description": "Pacing pracy w ciągu dnia, śledzenie ryzyka nadgodzin i zgodność z przerwami",
            "icon": "benchmarking"
          },
          {
            "name": "Monitorowanie Ubytków",
            "description": "Monitorowanie anulacji, rekompensat i zniżek w czasie rzeczywistym na zmianę",
            "icon": "cost"
          },
          {
            "name": "Przepływ",
            "description": "Wąskie gardła przepustowości, zaległości i metryki tempa kuchni",
            "icon": "speed"
          },
          {
            "name": "Inteligencja Menu",
            "description": "Katalog pozycji, macierz klasyfikacji (Gwiazdy/Pracowite/Łamigłówki/Psy)",
            "icon": "insights"
          },
          {
            "name": "Powiadomienia i Scenariusze",
            "description": "Zautomatyzowane przepływy pracy uruchamiane przez wyjątki",
            "icon": "forecasting"
          },
          {
            "name": "Trener Sundae",
          ...
          {
            "name": "Tryb Tablicy",
            "description": "Wyświetlanie na pełnym ekranie dla kuchni lub ekranów frontowych",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Połącz Wszystkie Swoje Systemy",
        "description": "Core łączy 12 obszarów danych z ponad 80 integracjami dostawców.",
        "items": [
          {
            "category": "Systemy POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus bezpośrednie konektory do baz danych",
            "icon": "integration"
          },
          {
            "category": "Praca/Zasoby ludzkie",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Zarządzanie zapasami i zakupy",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        "heading": "Dodaj moduły dla specjalistycznej inteligencji",
        "description": "Wzbogacaj Core o moduły skoncentrowane na Twoich specyficznych wyzwaniach operacyjnych.",
        "items": [
          {
            "name": "Inteligencja Pracy",
            "description": "Optymalizacja harmonogramu w czasie rzeczywistym, prognozowanie zapotrzebowania na pracowników",
            "icon": "benchmarking"
          },
          {
            "name": "Inteligencja Zapasów",
            "description": "Śledzenie marnotrawstwa w czasie rzeczywistym, zautomatyzowane poziomy minimalne",
            "icon": "insights"
          },
          {
            "name": "Inteligencja Zakupów",
            "description": "Optymalizacja cen w czasie rzeczywistym, porównanie dostawców",
            "icon": "marketing"
          },
          {
            "name": "Inteligencja Marketingowa",
            "description": "Śledzenie kampanii w czasie rzeczywistym, monitorowanie CAC",
            "icon": "growth"
          },
          {
            "name": "Inteligencja Rezerwacji",
            "description": "Wzorce rezerwacji w czasie rzeczywistym, optymalizacja stołów",
            "icon": "operators"
          }
        ],
    ...
    "tr": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Satış & Hız",
            "description": "Gün içi satış hızı, KPI'lar ve saatlik trend görselleştirmesi",
            "icon": "chart"
          },
          {
            "name": "İş Gücü Canlı",
            "description": "Gün içi iş gücü hızı, fazla mesai riski takibi ve mola uyumu",
            "icon": "benchmarking"
          },
          {
            "name": "Kaçak İzleme",
          ...
          {
            "name": "Akış",
            "description": "Üretim darboğazları, birikme ve mutfak hızı metrikleri",
            "icon": "speed"
          },
          {
            "name": "Menü Zekası",
            "description": "Ürün kataloğu, sınıflandırma matrisi (Yıldızlar/İşlekler/Bulmaca/Köpekler)",
            "icon": "insights"
          },
          {
            "name": "Uyarılar & Oyun Kitapları",
            "description": "İstisnalar tarafından tetiklenen otomatik yanıt iş akışları",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Koçu",
          ...
          {
            "name": "Portföy Lider Tablosu",
            "description": "Çoklu şube performans karşılaştırması ve seri takibi",
            "icon": "multiLocation"
          },
          {
            "name": "Duvar Modu",
            "description": "Mutfak veya ön alan ekranları için tam ekran görüntü",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Tüm Sistemlerinizi Bağlayın",
        "description": "Core, 80'den fazla tedarikçi entegrasyonu ile 12 veri alanında bağlantı kurar.",
        "items": [
          {
            "category": "POS Sistemleri",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, ayrıca doğrudan veritabanı bağlantıları",
            "icon": "integration"
          },
          {
            "category": "İş Gücü",
          ...
          {
            "category": "Teslimat ve Pazarlama",
            "examples": "Deliverect, Uber Eats, DoorDash, Meta, Google Ads, Mailchimp",
            "icon": "marketing"
          }
        ]
      ...
      "modules": {
        "heading": "Özel Zeka için Modüller Ekleyin",
        "description": "Belirli operasyonel zorluklarınız için odaklanmış modüllerle Core'u derinleştirin.",
        "items": [
          {
            "name": "İş Gücü Zekası",
            "description": "Gerçek zamanlı program optimizasyonu, öngörücü iş gücü talebi",
            "icon": "benchmarking"
          },
          {
            "name": "Stok Zekası",
            "description": "Gerçek zamanlı atık takibi, otomatik par seviyeleri",
            "icon": "insights"
          },
          {
            "name": "Satın Alma Zekası",
            "description": "Gerçek zamanlı fiyat optimizasyonu, tedarikçi karşılaştırması",
            "icon": "marketing"
          },
          {
            "name": "Pazarlama Zekası",
            "description": "Gerçek zamanlı kampanya takibi, CAC izleme",
            "icon": "growth"
          },
          {
            "name": "Rezervasyon Zekası",
            "description": "Gerçek zamanlı rezervasyon desenleri, masa optimizasyonu",
            "icon": "operators"
          }
        ],
    ...
    "zh-Hans": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "销售与节奏",
            "description": "日内销售节奏、关键绩效指标和每小时趋势可视化",
            "icon": "chart"
          },
          {
            "name": "劳动力实时",
            "description": "日内劳动力节奏、加班风险跟踪和休息合规性",
            "icon": "benchmarking"
          },
          {
            "name": "泄漏监控",
            "description": "每班次实时监控作废、补偿和折扣",
            "icon": "cost"
          },
          {
            "name": "流量",
            "description": "吞吐瓶颈、积压和厨房节奏指标",
            "icon": "speed"
          },
          {
            "name": "菜单智能",
            "description": "项目目录、分类矩阵（明星/工作马/难题/狗）",
            "icon": "insights"
          },
          {
            "name": "警报与行动手册",
            "description": "由异常触发的自动响应工作流程",
            "icon": "forecasting"
          },
          {
            "name": "Sundae教练",
          ...
          {
            "name": "投资组合排行榜",
            "description": "多门店绩效比较及连胜跟踪",
            "icon": "multiLocation"
          },
          {
            "name": "墙面模式",
            "description": "厨房或前厅屏幕的全屏显示",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "连接您的所有系统",
        "description": "Core 在 12 个数据领域中与 80 多个供应商集成。",
        "items": [
          {
            "category": "POS 系统",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover，以及直接数据库连接器",
            "icon": "integration"
          },
          {
            "category": "劳动力",
      ...
      "modules": {
        "heading": "添加专业智能模块",
        "description": "通过专注模块深化Core，以应对您的特定运营挑战。",
        "items": [
          {
            "name": "劳动力智能",
            "description": "实时排班优化，预测劳动力需求",
            "icon": "benchmarking"
          },
          {
            "name": "库存智能",
            "description": "实时废物追踪，自动化库存水平",
            "icon": "insights"
          },
          {
            "name": "采购智能",
            "description": "实时价格优化，供应商比较",
            "icon": "marketing"
          },
          {
            "name": "营销智能",
            "description": "实时活动跟踪，客户获取成本监控",
            "icon": "growth"
          },
          {
            "name": "预订智能",
            "description": "实时预订模式，桌位优化",
            "icon": "operators"
          }
        ],
        "button": "探索所有模块"
    ...
    "ja": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "売上とペース",
            "description": "日内売上のペース、KPI、時間ごとのトレンド可視化",
            "icon": "chart"
          },
          {
            "name": "労働ライブ",
            "description": "日内労働のペース、残業リスクの追跡、休憩の遵守",
            "icon": "benchmarking"
          },
          {
            "name": "漏れ監視",
            "description": "シフトごとのリアルタイムの無効、補償、割引の監視",
            "icon": "cost"
          },
          {
            "name": "フロー",
            "description": "スループットのボトルネック、バックログ、キッチンのペース指標",
            "icon": "speed"
          },
          {
            "name": "メニューインテリジェンス",
            "description": "アイテムカタログ、分類マトリックス（スター/プラウホース/パズル/犬）",
            "icon": "insights"
          },
          {
            "name": "アラートとプレイブック",
            "description": "例外によってトリガーされる自動応答ワークフロー",
            "icon": "forecasting"
          },
          {
            "name": "Sundaeコーチ",
          ...
          {
            "name": "ポートフォリオリーダーボード",
            "description": "ストリーク追跡を伴うマルチアウトレットのパフォーマンス比較",
            "icon": "multiLocation"
          },
          {
            "name": "ウォールボードモード",
            "description": "キッチンまたはフロントオブハウスの画面用のフルスクリーン表示",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "すべてのシステムを接続",
        "description": "Coreは12のデータドメインを横断し、80以上のベンダー統合を提供します。",
        "items": [
          {
            "category": "POSシステム",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, 直接データベースコネクタ",
            "icon": "integration"
          },
          {
            "category": "労働/人材",
      ...
      "modules": {
        "heading": "専門的なインテリジェンスのためのモジュールを追加",
        "description": "特定の運用課題に対応するためにCoreを深めます。",
        "items": [
          {
            "name": "労働インテリジェンス",
            "description": "リアルタイムのスケジュール最適化、予測労働需要",
            "icon": "benchmarking"
          },
          {
            "name": "在庫インテリジェンス",
            "description": "リアルタイムの廃棄物追跡、自動パー水準",
            "icon": "insights"
          },
          {
            "name": "購買インテリジェンス",
            "description": "リアルタイムの価格最適化、ベンダー比較",
            "icon": "marketing"
          },
          {
            "name": "マーケティングインテリジェンス",
            "description": "リアルタイムのキャンペーン追跡、CACモニタリング",
            "icon": "growth"
          },
          {
            "name": "予約インテリジェンス",
            "description": "リアルタイムの予約パターン、テーブル最適化",
            "icon": "operators"
          }
        ],
        "button": "すべてのモジュールを探る"
    ...
    "ko": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "판매 및 속도",
            "description": "일일 판매 속도, KPI 및 시간별 추세 시각화",
            "icon": "chart"
          },
          {
            "name": "실시간 인력",
            "description": "일일 인력 속도, 초과 근무 위험 추적 및 휴식 준수",
            "icon": "benchmarking"
          },
          {
            "name": "누수 모니터링",
            "description": "근무별 실시간 무효, 보상 및 할인 모니터링",
            "icon": "cost"
          },
          {
            "name": "흐름",
            "description": "처리량 병목 현상, 적체 및 주방 속도 지표",
            "icon": "speed"
          },
          {
            "name": "메뉴 인텔리전스",
            "description": "항목 카탈로그, 분류 매트릭스 (스타/플라우호스/퍼즐/개)",
            "icon": "insights"
          },
          {
            "name": "알림 및 플레이북",
            "description": "예외에 의해 트리거되는 자동화된 응답 워크플로우",
            "icon": "forecasting"
          },
          {
            "name": "Sundae 코치",
          ...
          {
            "name": "포트폴리오 리더보드",
            "description": "연속 추적이 포함된 다중 매장 성과 비교",
            "icon": "multiLocation"
          },
          {
            "name": "월보드 모드",
            "description": "주방 또는 프론트 오브 하우스 화면을 위한 전체 화면 표시",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "모든 시스템 연결",
        "description": "Core는 12개의 데이터 도메인에서 80개 이상의 공급업체 통합을 지원합니다.",
        "items": [
          {
            "category": "POS 시스템",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, 직접 데이터베이스 커넥터 포함",
            "icon": "integration"
          },
          {
            "category": "노동/인력",
      ...
      "modules": {
        "heading": "전문 지능을 위한 모듈 추가",
        "description": "특정 운영 과제를 위한 집중 모듈로 Core를 심화하세요.",
        "items": [
          {
            "name": "인력 지능",
            "description": "실시간 일정 최적화, 예측 인력 수요",
            "icon": "benchmarking"
          },
          {
            "name": "재고 지능",
            "description": "실시간 폐기물 추적, 자동화된 최소 재고 수준",
            "icon": "insights"
          },
          {
            "name": "구매 지능",
            "description": "실시간 가격 최적화, 공급업체 비교",
            "icon": "marketing"
          },
          {
            "name": "마케팅 지능",
            "description": "실시간 캠페인 추적, CAC 모니터링",
            "icon": "growth"
          },
          {
            "name": "예약 지능",
            "description": "실시간 예약 패턴, 테이블 최적화",
            "icon": "operators"
          }
        ],
        "button": "모든 모듈 탐색"
    ...
    "id": {
        ...
        "features": [
          {
            ...
            "description": "Pacing penjualan intrahari, KPI, dan visualisasi tren per jam",
            "icon": "chart"
          },
          {
            "name": "Tenaga Kerja Langsung",
            "description": "Pacing tenaga kerja intrahari, pelacakan risiko lembur, dan kepatuhan istirahat",
            "icon": "benchmarking"
          },
          {
            "name": "Pemantauan Kebocoran",
            "description": "Pemantauan void, kompensasi, dan diskon secara real-time per shift",
            "icon": "cost"
          },
          {
            "name": "Aliran",
            "description": "Bottleneck throughput, backlog, dan metrik pacing dapur",
            "icon": "speed"
          },
          {
          ...
          {
            "name": "Peringatan & Buku Pedoman",
            "description": "Alur kerja respons otomatis yang dipicu oleh pengecualian",
            "icon": "forecasting"
          },
          {
            "name": "Pelatih Sundae",
          ...
          {
            "name": "Papan Peringkat Portofolio",
            "description": "Perbandingan kinerja multi-outlet dengan pelacakan streak",
            "icon": "multiLocation"
          },
          {
            "name": "Mode Wallboard",
            "description": "Tampilan layar penuh untuk dapur atau layar depan rumah",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Sambungkan Semua Sistem Anda",
        "description": "Core terhubung di 12 domain data dengan lebih dari 80 integrasi vendor.",
        "items": [
          {
            "category": "Sistem POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, ditambah konektor database langsung",
            "icon": "integration"
          },
          {
      ...
      "modules": {
        "heading": "Tambahkan Modul untuk Intelijen Khusus",
        "description": "Perdalam Core dengan modul yang fokus pada tantangan operasional spesifik Anda.",
        "items": [
          {
            "name": "Intelijen Tenaga Kerja",
            "description": "Optimasi jadwal waktu nyata, prediksi permintaan tenaga kerja",
            "icon": "benchmarking"
          },
          {
            "name": "Intelijen Inventaris",
            "description": "Pelacakan limbah waktu nyata, tingkat par otomatis",
            "icon": "insights"
          },
          {
            "name": "Intelijen Pembelian",
            "description": "Optimasi harga waktu nyata, perbandingan vendor",
            "icon": "marketing"
          },
          {
            "name": "Intelijen Pemasaran",
            "description": "Pelacakan kampanye waktu nyata, pemantauan CAC",
            "icon": "growth"
          },
          {
    ...
    "vi": {
        ...
        "features": [
          {
            ...
            "description": "Theo dõi doanh thu trong ngày, KPI và trực quan hóa xu hướng theo giờ",
            "icon": "chart"
          },
          {
            "name": "Lao động Trực tiếp",
            "description": "Theo dõi lao động trong ngày, rủi ro làm thêm giờ và tuân thủ thời gian nghỉ",
            "icon": "benchmarking"
          },
          {
            "name": "Giám sát Rò rỉ",
            "description": "Giám sát thực tế các trường hợp hủy, miễn phí và giảm giá theo ca",
            "icon": "cost"
          },
          {
            "name": "Dòng chảy",
            "description": "Các điểm nghẽn trong quá trình, tồn đọng và chỉ số tốc độ bếp",
            "icon": "speed"
          },
          {
            "name": "Trí tuệ Thực đơn",
            "description": "Danh mục món ăn, ma trận phân loại (Sao/Ngựa kéo/Câu đố/Chó)",
            "icon": "insights"
          },
          {
            "name": "Cảnh báo & Kế hoạch hành động",
            "description": "Quy trình phản hồi tự động được kích hoạt bởi các ngoại lệ",
            "icon": "forecasting"
          },
          {
          ...
          {
            "name": "Bảng xếp hạng Danh mục",
            "description": "So sánh hiệu suất đa địa điểm với theo dõi chuỗi",
            "icon": "multiLocation"
          },
          {
            "name": "Chế độ Bảng tường",
            "description": "Màn hình toàn màn hình cho bếp hoặc màn hình trước nhà",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Kết Nối Tất Cả Hệ Thống Của Bạn",
        "description": "Core kết nối qua 12 lĩnh vực dữ liệu với hơn 80 tích hợp nhà cung cấp.",
        "items": [
          {
            "category": "Hệ Thống POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, cùng các kết nối cơ sở dữ liệu trực tiếp",
            "icon": "integration"
          },
          {
            "category": "Lao Động/Quy Trình Làm Việc",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Quản Lý Tồn Kho & Mua Sắm",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        "heading": "Thêm Các Mô-đun cho Trí Tuệ Chuyên Biệt",
        "description": "Nâng cao Core với các mô-đun tập trung cho những thách thức vận hành cụ thể của bạn.",
        "items": [
          {
            "name": "Trí Tuệ Lao Động",
            "description": "Tối ưu hóa lịch trình theo thời gian thực, dự đoán nhu cầu lao động",
            "icon": "benchmarking"
          },
          {
            "name": "Trí Tuệ Tồn Kho",
            "description": "Theo dõi lãng phí theo thời gian thực, mức tối thiểu tự động",
            "icon": "insights"
          },
          {
            "name": "Trí Tuệ Mua Sắm",
            "description": "Tối ưu hóa giá theo thời gian thực, so sánh nhà cung cấp",
            "icon": "marketing"
          },
          {
            "name": "Trí Tuệ Tiếp Thị",
            "description": "Theo dõi chiến dịch theo thời gian thực, giám sát CAC",
            "icon": "growth"
          },
          {
            "name": "Trí Tuệ Đặt Chỗ",
            "description": "Mô hình đặt chỗ theo thời gian thực, tối ưu hóa bàn",
            "icon": "operators"
          }
        ],
    ...
    "ro": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Vânzări & Ritm",
            "description": "Pacing-ul vânzărilor intraday, KPI-uri și vizualizarea tendințelor pe oră",
            "icon": "chart"
          },
          {
            "name": "Forță de Muncă Live",
            "description": "Pacing-ul forței de muncă intraday, monitorizarea riscurilor de ore suplimentare și conformitatea cu pauzele",
            "icon": "benchmarking"
          },
          {
          ...
          {
            "name": "Flux",
            "description": "Gâturi de sticlă în proces, backlog și metrici de pacing pentru bucătărie",
            "icon": "speed"
          },
          {
          ...
          {
            "name": "Alerte & Planuri de Acțiune",
            "description": "Fluxuri de răspuns automatizate declanșate de excepții",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Semnale de coaching la nivel de schimb pentru Vânzări, Pierderi și Flux",
            "icon": "intelligence"
          },
          {
            "name": "Clasamentul Portofoliului",
            "description": "Compararea performanței între multiple locații cu urmărirea seriilor",
            "icon": "multiLocation"
          },
          {
            "name": "Mod Wallboard",
            "description": "Display pe ecran complet pentru bucătărie sau ecranele din fața casei",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Conectează Toate Sistemele Tale",
        "description": "Core se conectează în 12 domenii de date cu peste 80 de integrări de furnizori.",
        "items": [
          {
            "category": "Sisteme POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus conectori direcți de baze de date",
            "icon": "integration"
          },
          {
            "category": "Forță de muncă",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Inventar & Achiziții",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
        ...
        "items": [
          {
            ...
            "description": "Optimizare a programului în timp real, cerere de muncă predictivă",
            "icon": "benchmarking"
          },
          {
            "name": "Inteligența Inventarului",
            "description": "Urmărirea deșeurilor în timp real, niveluri automate de par",
            "icon": "insights"
          },
          {
            "name": "Inteligența Achizițiilor",
            "description": "Optimizare a prețurilor în timp real, compararea furnizorilor",
            "icon": "marketing"
          },
          {
            "name": "Inteligența Marketingului",
            "description": "Urmărirea campaniilor în timp real, monitorizarea CAC",
            "icon": "growth"
          },
          {
            "name": "Inteligența Rezervărilor",
            "description": "Modele de rezervare în timp real, optimizarea meselor",
            "icon": "operators"
          }
        ],
    ...
    "sv": {
        ...
        "features": [
          {
            ...
            "description": "Intradag försäljningspacing, KPI:er och timvis trendvisualisering",
            "icon": "chart"
          },
          {
            "name": "Arbete Live",
            "description": "Intradag arbetskraftspacing, övertidsriskövervakning och rastöverensstämmelse",
            "icon": "benchmarking"
          },
          {
            "name": "Läckageövervakning",
            "description": "Real-tids övervakning av voids, kompensationer och rabatter per skift",
            "icon": "cost"
          },
          {
            "name": "Flöde",
            "description": "Genomströmningsträngsel, eftersläpning och kökspacing-metrik",
            "icon": "speed"
          },
          {
            "name": "Menyintelligens",
            "description": "Artikelkatalog, klassificeringsmatris (Stjärnor/Plöjhästar/Pussel/Hundar)",
            "icon": "insights"
          },
          {
            "name": "Varningar & Handlingsplaner",
            "description": "Automatiserade svararbetsflöden utlösta av undantag",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Coaching-signaler på skiftnivå för Försäljning, Läckage och Flöde",
            "icon": "intelligence"
          },
          {
            "name": "Portföljledartavla",
            "description": "Prestandajämförelse mellan flera enheter med streak-övervakning",
            "icon": "multiLocation"
          },
          {
            "name": "Wallboard-läge",
            "description": "Helskärmsvisning för kök eller front-of-house skärmar",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Anslut Alla Dina System",
        "description": "Core kopplar samman 12 datadomäner med över 80 leverantörsintegrationer.",
        "items": [
          {
            "category": "POS-system",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, plus direkta databasanslutningar",
            "icon": "integration"
          },
          {
            "category": "Arbete/Personal",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "Lager & Inköp",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
          ...
          {
            "category": "Leverans & Marknadsföring",
            "examples": "Deliverect, Uber Eats, DoorDash, Meta, Google Ads, Mailchimp",
            "icon": "marketing"
          }
        ]
      ...
      "modules": {
        "heading": "Lägg till moduler för specialiserad intelligens",
        "description": "Fördjupa Core med fokuserade moduler för dina specifika operativa utmaningar.",
        "items": [
          {
            "name": "Arbetsintelligens",
            "description": "Optimering av scheman i realtid, förutsägande arbetsbehov",
            "icon": "benchmarking"
          },
          {
            "name": "Lagerintelligens",
            "description": "Spårning av avfall i realtid, automatiserade parnivåer",
            "icon": "insights"
          },
          {
            "name": "Inköpsintelligens",
            "description": "Priser i realtid, leverantörjämförelse",
            "icon": "marketing"
          },
          {
            "name": "Marknadsföringsintelligens",
            "description": "Kampanjspårning i realtid, CAC-övervakning",
            "icon": "growth"
          },
          {
            "name": "Bokningsintelligens",
            "description": "Bokningsmönster i realtid, optimering av bord",
            "icon": "operators"
          }
        ],
    ...
    "bn": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "বিক্রয় ও গতি",
            "description": "দিনের মধ্যে বিক্রয় গতি, কেপিআই এবং ঘণ্টা ভিত্তিক প্রবণতা ভিজ্যুয়ালাইজেশন",
            "icon": "chart"
          },
          {
            "name": "শ্রম লাইভ",
            "description": "দিনের মধ্যে শ্রম গতি, অতিরিক্ত সময়ের ঝুঁকি ট্র্যাকিং এবং বিরতি সম্মতি",
            "icon": "benchmarking"
          },
          {
            "name": "লিকেজ মনিটরিং",
            "description": "প্রতি শিফটে বাস্তব সময়ের শূন্য, কম্প, এবং ডিসকাউন্ট মনিটরিং",
            "icon": "cost"
          },
          {
            "name": "ফ্লো",
            "description": "থ্রুপুট বোতলনেক, ব্যাকলগ, এবং রান্নাঘরের গতি মেট্রিক্স",
            "icon": "speed"
          },
          {
            "name": "মেনু ইন্টেলিজেন্স",
            "description": "আইটেম ক্যাটালগ, শ্রেণীবিভাগ ম্যাট্রিক্স (স্টারস/প্লোহার্স/পাজলস/ডগস)",
            "icon": "insights"
          },
          {
            "name": "অ্যালার্টস ও প্লেবুকস",
            "description": "ব্যতিক্রম দ্বারা ট্রিগার করা স্বয়ংক্রিয় প্রতিক্রিয়া ওয়ার্কফ্লো",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
          ...
          {
            "name": "পোর্টফোলিও লিডারবোর্ড",
            "description": "স্ট্রিক ট্র্যাকিং সহ মাল্টি-আউটলেট কর্মক্ষমতা তুলনা",
            "icon": "multiLocation"
          },
          {
            "name": "ওয়ালবোর্ড মোড",
            "description": "রান্নাঘর বা ফ্রন্ট-অফ-হাউস স্ক্রীনের জন্য ফুল-স্ক্রীন ডিসপ্লে",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "আপনার সমস্ত সিস্টেম সংযুক্ত করুন",
        "description": "Core ১২টি ডেটা ডোমেইনের মধ্যে ৮০+ ভেন্ডর ইন্টিগ্রেশন সহ সংযুক্ত হয়।",
        "items": [
          {
            "category": "POS সিস্টেম",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, পাশাপাশি সরাসরি ডেটাবেস সংযোগকারী",
            "icon": "integration"
          },
          {
            "category": "শ্রম/কর্মশক্তি",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "মাল ও ক্রয়",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
        ...
        "items": [
          {
            ...
            "description": "রিয়েল-টাইম সময়সূচী অপ্টিমাইজেশন, পূর্বাভাসিত শ্রম চাহিদা",
            "icon": "benchmarking"
          },
          {
            "name": "মালামাল বুদ্ধিমত্তা",
            "description": "রিয়েল-টাইম বর্জ্য ট্র্যাকিং, স্বয়ংক্রিয় পার স্তর",
            "icon": "insights"
          },
          {
            "name": "ক্রয় বুদ্ধিমত্তা",
            "description": "রিয়েল-টাইম মূল্য অপ্টিমাইজেশন, বিক্রেতা তুলনা",
            "icon": "marketing"
          },
          {
            "name": "মার্কেটিং বুদ্ধিমত্তা",
            "description": "রিয়েল-টাইম প্রচারাভিযান ট্র্যাকিং, CAC মনিটরিং",
            "icon": "growth"
          },
          {
            "name": "সংরক্ষণ বুদ্ধিমত্তা",
            "description": "রিয়েল-টাইম বুকিং প্যাটার্ন, টেবিল অপ্টিমাইজেশন",
            "icon": "operators"
          }
        ],
    ...
    "th": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "ยอดขาย & อัตรา",
            "description": "การติดตามยอดขายระหว่างวัน, KPI และการแสดงแนวโน้มรายชั่วโมง",
            "icon": "chart"
          },
          {
            "name": "แรงงานสด",
            "description": "การติดตามแรงงานระหว่างวัน, ความเสี่ยงการทำงานล่วงเวลา และการปฏิบัติตามเวลาพัก",
            "icon": "benchmarking"
          },
          {
            "name": "การตรวจสอบการรั่วไหล",
            "description": "การตรวจสอบการยกเลิก, การชดเชย และส่วนลดแบบเรียลไทม์ต่อกะ",
            "icon": "cost"
          },
          {
            "name": "การไหล",
            "description": "จุดคอขวดในการผลิต, ยอดคงค้าง และเมตริกการติดตามในครัว",
            "icon": "speed"
          },
          {
            "name": "ข้อมูลเชิงลึกเมนู",
            "description": "แคตตาล็อกสินค้า, แมทริกซ์การจำแนกประเภท (Stars/Plowhorses/Puzzles/Dogs)",
            "icon": "insights"
          },
          {
            "name": "การแจ้งเตือน & แผนการทำงาน",
            "description": "เวิร์กโฟลว์การตอบสนองอัตโนมัติที่ถูกกระตุ้นโดยข้อยกเว้น",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "สัญญาณการสอนระดับกะสำหรับยอดขาย, การรั่วไหล และการไหล",
            "icon": "intelligence"
          },
          {
            "name": "กระดานผู้นำพอร์ตโฟลิโอ",
            "description": "การเปรียบเทียบประสิทธิภาพหลายสาขาพร้อมการติดตามสตรีค",
            "icon": "multiLocation"
          },
          {
            "name": "โหมดกระดานผนัง",
            "description": "การแสดงผลแบบเต็มหน้าจอสำหรับครัวหรือหน้าร้าน",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "เชื่อมต่อระบบทั้งหมดของคุณ",
        "description": "Core เชื่อมต่อกับ 12 ข้อมูลโดเมน พร้อมการรวมระบบจากผู้ให้บริการกว่า 80 ราย",
        "items": [
          {
            "category": "ระบบ POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, พร้อมตัวเชื่อมต่อฐานข้อมูลโดยตรง",
            "icon": "integration"
          },
          {
            "category": "แรงงาน/กำลังคน",
            "examples": "7shifts, HotSchedules, Deputy",
            "icon": "benchmarking"
          },
          {
            "category": "การจัดการสินค้าคงคลัง & การสั่งซื้อ",
            "examples": "MarketMan, Craftable, BinWise",
            "icon": "insights"
          },
          {
      ...
      "modules": {
        "heading": "เพิ่มโมดูลสำหรับความชาญฉลาดเฉพาะทาง",
        "description": "เสริม Core ด้วยโมดูลที่มุ่งเน้นสำหรับความท้าทายในการดำเนินงานเฉพาะของคุณ",
        "items": [
          {
            "name": "ความชาญฉลาดด้านแรงงาน",
            "description": "การปรับตารางเวลาแบบเรียลไทม์, การคาดการณ์ความต้องการแรงงาน",
            "icon": "benchmarking"
          },
          {
            "name": "ความชาญฉลาดด้านสินค้าคงคลัง",
            "description": "การติดตามของเสียแบบเรียลไทม์, ระดับพาร์อัตโนมัติ",
            "icon": "insights"
          },
          {
            "name": "ความชาญฉลาดด้านการจัดซื้อ",
            "description": "การปรับราคาแบบเรียลไทม์, การเปรียบเทียบผู้ขาย",
            "icon": "marketing"
          },
          {
            "name": "ความชาญฉลาดด้านการตลาด",
            "description": "การติดตามแคมเปญแบบเรียลไทม์, การติดตาม CAC",
            "icon": "growth"
          },
          {
            "name": "ความชาญฉลาดด้านการจอง",
            "description": "รูปแบบการจองแบบเรียลไทม์, การปรับตาราง",
            "icon": "operators"
          }
        ],
    ...
    "ms": {
      ...
      "pulse": {
        ...
        "features": [
          {
            "name": "Jualan & Rentak",
            "description": "Pacing jualan intrahari, KPI, dan visualisasi trend setiap jam",
            "icon": "chart"
          },
          {
            "name": "Tenaga Kerja Langsung",
            "description": "Pacing tenaga kerja intrahari, pengesanan risiko kerja lebih masa, dan pematuhan rehat",
            "icon": "benchmarking"
          },
          {
            "name": "Pemantauan Kebocoran",
            "description": "Pemantauan void, comp, dan diskaun secara langsung setiap shift",
            "icon": "cost"
          },
          {
            "name": "Aliran",
          ...
          {
            "name": "Amaran & Buku Panduan",
            "description": "Aliran kerja respons automatik yang dicetuskan oleh pengecualian",
            "icon": "forecasting"
          },
          {
            "name": "Sundae Coach",
            "description": "Isyarat latihan peringkat shift untuk Jualan, Kebocoran, dan Aliran",
            "icon": "intelligence"
          },
          {
            "name": "Papan Pendahulu Portfolio",
            "description": "Perbandingan prestasi pelbagai outlet dengan pengesanan streak",
            "icon": "multiLocation"
          },
          {
            "name": "Mod Papan Dinding",
            "description": "Paparan skrin penuh untuk dapur atau skrin depan rumah",
            "icon": "canvas"
          }
        ]
      },
      "integrations": {
        "heading": "Sambungkan Semua Sistem Anda",
        "description": "Core menyambungkan 12 domain data dengan lebih daripada 80 integrasi vendor.",
        "items": [
          {
            "category": "Sistem POS",
            "examples": "Oracle MICROS Simphony, Square, Toast, Clover, serta penyambung pangkalan data langsung",
            "icon": "integration"
          },
          {
            "category": "Tenaga Kerja",
          ...
          {
            "category": "Penghantaran & Pemasaran",
            "examples": "Deliverect, Uber Eats, DoorDash, Meta, Google Ads, Mailchimp",
            "icon": "marketing"
          }
        ]
      ...
      "modules": {
        "heading": "Tambah Modul untuk Kecerdasan Khusus",
        "description": "Perdalam Core dengan modul yang fokus untuk cabaran operasi spesifik anda.",
        "items": [
          {
            "name": "Kecerdasan Tenaga Kerja",
            "description": "Pengoptimuman jadual masa nyata, permintaan tenaga kerja ramalan",
            "icon": "benchmarking"
          },
          {
            "name": "Kecerdasan Inventori",
            "description": "Pengesanan pembaziran masa nyata, tahap par automatik",
            "icon": "insights"
          },
          {
            "name": "Kecerdasan Pembelian",
            "description": "Pengoptimuman harga masa nyata, perbandingan vendor",
            "icon": "marketing"
          },
          {
            "name": "Kecerdasan Pemasaran",
            "description": "Pengesanan kempen masa nyata, pemantauan CAC",
            "icon": "growth"
          },
          {
            "name": "Kecerdasan Tempahan",
            "description": "Corak tempahan masa nyata, pengoptimuman meja",
            "icon": "operators"
          }
        ],
        "button": "Jelajahi Semua Modul"
