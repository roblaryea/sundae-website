// Generated website local copy overrides for src/app/tools/breakeven-covers/page.tsx.
...
export const generatedLocalCopy = {
  "localizedCopy": {
    "fr": {
      ...
      "hero": {
        "badge": "Intelligence Financière",
        "title": "Calculateur de Couvert d'Équilibre",
      ...
      "form": {
        ...
        "description": "Saisissez vos coûts fixes, le coût variable par couvert et le prix de vente moyen.",
        "fixedLabel": "Coûts Fixes Par Période",
        "fixedHint": "Loyer, salaires, assurances, etc. (mensuel ou total de la période)",
      ...
      "results": {
        "title": "Couverts Nécessaires pour le Seuil de Rentabilité",
      ...
      "cta": {
        "intro": "Vous souhaitez identifier des opportunités d'amélioration spécifiques dans vos établissements ?",
        "button": "Voir comment Sundae peut aider"
      },
      "errors": {
        "invalidInputs": "Veuillez entrer des nombres valides (le prix moyen doit être supérieur au coût variable)",
    ...
    "es": {
      ...
      "results": {
        ...
        "tip3": "Aumentar la cuenta promedio (venta adicional, ingeniería de menú)",
        "tip4": "Mejorar el margen de contribución = camino más rápido hacia la rentabilidad"
      },
      "cta": {
      ...
      "errors": {
        "invalidInputs": "Por favor, ingresa números válidos (el precio promedio debe ser mayor que el costo variable)",
        "negativeMargin": "El margen de contribución debe ser positivo. Aumenta tu precio promedio o reduce los costos variables."
      }
    },
    "de": {
      ...
      "results": {
        ...
        "tip3": "Durchschnittlichen Rechnungsbetrag erhöhen (Upselling, Menügestaltung)",
        "tip4": "Deckungsbeitrag verbessern = schnellerer Weg zur Rentabilität"
      },
      "cta": {
        "intro": "Möchten Sie spezifische Verbesserungspotenziale in Ihren Standorten identifizieren?",
        "button": "Sehen Sie, wie Sundae helfen kann"
      },
      "errors": {
        "invalidInputs": "Bitte geben Sie gültige Zahlen ein (der durchschnittliche Preis muss höher sein als die variablen Kosten)",
        "negativeMargin": "Der Deckungsbeitrag muss positiv sein. Erhöhen Sie Ihren durchschnittlichen Preis oder senken Sie die variablen Kosten."
      }
    },
    "nl": {
      ...
      "errors": {
        "invalidInputs": "Voer geldige getallen in (gemiddelde prijs moet hoger zijn dan variabele kosten)",
        "negativeMargin": "Bijdrage marge moet positief zijn. Verhoog je gemiddelde prijs of verlaag variabele kosten."
      }
    },
    "ar": {
      ...
      "cta": {
        "intro": "هل تريد تحديد فرص تحسين محددة عبر مواقعك؟",
        "button": "اكتشف كيف يمكن أن تساعدك Sundae"
      },
      "errors": {
        "invalidInputs": "يرجى إدخال أرقام صحيحة (يجب أن يكون متوسط السعر أكبر من التكلفة المتغيرة)",
        "negativeMargin": "يجب أن يكون هامش المساهمة إيجابيًا. قم بزيادة متوسط السعر أو تقليل التكاليف المتغيرة."
      }
    },
    "pt": {
      ...
      "results": {
        ...
        "tip2": "Diminua custos variáveis (melhores condições com fornecedores, reduza desperdícios)",
        "tip3": "Aumente a conta média (vendas adicionais, engenharia de cardápio)",
        "tip4": "Melhore a margem de contribuição = caminho mais rápido para a lucratividade"
      },
      "cta": {
      ...
      "errors": {
        "invalidInputs": "Por favor, insira números válidos (o preço médio deve ser maior que o custo variável)",
        "negativeMargin": "A margem de contribuição deve ser positiva. Aumente seu preço médio ou reduza os custos variáveis."
      }
    },
    "ur": {
      ...
      "errors": {
        "invalidInputs": "براہ کرم درست نمبر درج کریں (اوسط قیمت متغیر لاگت سے زیادہ ہونی چاہیے)",
        "negativeMargin": "شراکت کا مارجن مثبت ہونا چاہیے۔ اپنی اوسط قیمت بڑھائیں یا متغیر اخراجات کم کریں۔"
      }
    },
    "it": {
      ...
      "results": {
        ...
        "tip3": "Aumenta il conto medio (upselling, ingegneria del menu)",
        "tip4": "Migliora il margine di contribuzione = percorso più veloce verso la redditività"
      },
      "cta": {
      ...
      "errors": {
        "invalidInputs": "Inserisci numeri validi (il prezzo medio deve essere maggiore del costo variabile)",
        "negativeMargin": "Il margine di contribuzione deve essere positivo. Aumenta il tuo prezzo medio o riduci i costi variabili."
      }
    },
    "hi": {
      ...
      "errors": {
        "invalidInputs": "कृपया मान्य संख्याएँ दर्ज करें (औसत मूल्य को परिवर्तनीय लागत से अधिक होना चाहिए)",
        "negativeMargin": "योगदान मार्जिन सकारात्मक होना चाहिए। अपने औसत मूल्य को बढ़ाएं या परिवर्तनीय लागत को कम करें।"
      }
    },
    "pl": {
      ...
      "errors": {
        "invalidInputs": "Proszę wprowadzić prawidłowe liczby (średnia cena musi być większa niż koszt zmienny)",
        "negativeMargin": "Marża wkładu musi być dodatnia. Zwiększ swoją średnią cenę lub zmniejsz koszty zmienne."
      }
    },
    "zh-Hans": {
      "back": "返回工具",
      ...
      "errors": {
        "invalidInputs": "请输入有效的数字（平均价格必须大于变动成本）",
        "negativeMargin": "贡献利润必须为正。提高您的平均价格或降低变动成本。"
      }
    },
    "tr": {
      ...
      "results": {
        ...
        "tip2": "Değişken maliyetleri düşürün (daha iyi tedarikçi koşulları, israfı azaltın)",
        "tip3": "Ortalama hesabı artırın (ek satış, menü mühendisliği)",
        "tip4": "Katkı marjını artırın = kârlılığa daha hızlı ulaşma yolu"
      },
      "cta": {
      ...
      "errors": {
        "invalidInputs": "Lütfen geçerli sayılar girin (ortalama fiyat, değişken maliyetten büyük olmalıdır)",
        "negativeMargin": "Katkı marjı pozitif olmalıdır. Ortalama fiyatınızı artırın veya değişken maliyetleri azaltın."
      }
    },
    "ja": {
      "back": "ツールに戻る",
      ...
      "cta": {
        ...
        "button": "Sundaeがどのようにお手伝いできるかを見る"
      },
      "errors": {
        "invalidInputs": "有効な数字を入力してください（平均価格は変動費より大きくする必要があります）",
        "negativeMargin": "貢献マージンは正でなければなりません。平均価格を上げるか、変動費を減らしてください。"
      }
    },
    "id": {
      ...
      "errors": {
        "invalidInputs": "Silakan masukkan angka yang valid (harga rata-rata harus lebih besar dari biaya variabel)",
        "negativeMargin": "Margin kontribusi harus positif. Tingkatkan harga rata-rata Anda atau kurangi biaya variabel."
      }
    },
    "ro": {
      ...
      "results": {
        ...
        "tip2": "Reducerea costurilor variabile (termeni mai buni de la furnizori, reducerea risipei)",
        "tip3": "Creșterea notei medii (vânzări suplimentare, inginerie de meniu)",
        "tip4": "Îmbunătățirea marjei de contribuție = cale mai rapidă către profitabilitate"
      },
      "cta": {
        "intro": "Vrei să identifici oportunități specifice de îmbunătățire în locațiile tale?",
        "button": "Vezi Cum Te Poate Ajuta Sundae"
      },
      "errors": {
        "invalidInputs": "Te rog să introduci numere valide (prețul mediu trebuie să fie mai mare decât costul variabil)",
        "negativeMargin": "Marja de contribuție trebuie să fie pozitivă. Crește prețul mediu sau reduce costurile variabile."
      }
    },
    "vi": {
      "back": "Quay lại Công cụ",
      "hero": {
        "badge": "Trí tuệ Tài chính",
        "title": "Máy Tính Điểm Hòa Vốn",
        "description": "Tính toán số lượng khách cần thiết để hòa vốn dựa trên chi phí cố định và biến đổi."
      },
      "form": {
        "title": "Nhập Chi Phí Của Bạn",
        "description": "Nhập chi phí cố định, chi phí biến đổi trên mỗi khách, và giá bán trung bình.",
        "fixedLabel": "Chi Phí Cố Định Mỗi Kỳ",
        "fixedHint": "Tiền thuê, lương, bảo hiểm, v.v. (tổng hàng tháng hoặc theo kỳ)",
        "variableLabel": "Chi Phí Biến Đổi Trên Mỗi Khách",
        "variableHint": "Chi phí thực phẩm, bao bì, phí thẻ tín dụng trên mỗi khách hàng",
        "priceLabel": "Giá Bán Trung Bình Trên Mỗi Khách",
        "priceHint": "Kích thước hóa đơn trung bình trên mỗi khách hàng",
        "buttonIdle": "Tính Toán Điểm Hòa Vốn",
        "buttonBusy": "Đang Tính Toán..."
      },
      "results": {
        "title": "Số Khách Cần Thiết Để Hòa Vốn",
      ...
      "errors": {
        "invalidInputs": "Vui lòng nhập số hợp lệ (giá trung bình phải lớn hơn chi phí biến đổi)",
        "negativeMargin": "Biên lợi nhuận phải dương. Tăng giá trung bình của bạn hoặc giảm chi phí biến đổi."
      }
    },
    "sv": {
      ...
      "errors": {
        "invalidInputs": "Vänligen ange giltiga nummer (genomsnittligt pris måste vara högre än rörlig kostnad)",
        "negativeMargin": "Bidragsmarginalen måste vara positiv. Öka ditt genomsnittliga pris eller minska rörliga kostnader."
      }
    },
    "bn": {
      "back": "টুলসে ফিরে যান",
      ...
      "cta": {
        "intro": "আপনার অবস্থানগুলির মধ্যে নির্দিষ্ট উন্নতির সুযোগ চিহ্নিত করতে চান?",
        "button": "কিভাবে Sundae সাহায্য করতে পারে দেখুন"
      },
      "errors": {
        "invalidInputs": "দয়া করে বৈধ সংখ্যা প্রবেশ করুন (গড় মূল্য পরিবর্তনশীল খরচের চেয়ে বেশি হতে হবে)",
        "negativeMargin": "অবদান মার্জিন ইতিবাচক হতে হবে। আপনার গড় মূল্য বাড়ান বা পরিবর্তনশীল খরচ কমান।"
      }
    },
    "th": {
    ...
    "ms": {
      ...
      "cta": {
        "intro": "Ingin mengenal pasti peluang peningkatan tertentu di lokasi anda?",
        "button": "Lihat Bagaimana Sundae Boleh Membantu"
      },
      "errors": {
        "invalidInputs": "Sila masukkan nombor yang sah (harga purata mesti lebih besar daripada kos berubah)",
        "negativeMargin": "Margin sumbangan mesti positif. Tingkatkan harga purata anda atau kurangkan kos berubah."
      }
    },
    "ko": {
      "back": "도구로 돌아가기",
      ...
      "errors": {
        "invalidInputs": "유효한 숫자를 입력하세요 (평균 가격은 변동비용보다 커야 합니다)",
        "negativeMargin": "기여 마진은 양수여야 합니다. 평균 가격을 올리거나 변동비용을 줄이세요."
      }
    }
  }
} as const
