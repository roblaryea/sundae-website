// Generated locale overrides for src/app/crew/people — transcreated (review prose before release).
...
export const generatedLocalCopy = {
  ...
  "ar": {
    ...
    "heroProof": [
      {
        "value": "من التوظيف إلى المغادرة",
        "label": "سجلٌّ واحد لكل شخص"
      },
      {
        "value": "بلا ورق",
        "label": "وقّع المستندات داخل التطبيق"
      },
      {
        "value": "كل موظف",
        "label": "تسجيل دخول مجاني خاص به"
      },
      {
        "value": "للمديرين أيضاً",
        "label": "لا للموارد البشرية وحدها"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "مستندات بلا ورق",
        "body": "خزّن المستندات، وأرسلها للتوقيع داخل التطبيق، واحصل على تذكير قبل انتهاء أي شهادة أو تأشيرة.",
        "chips": [
          "التوقيع الإلكتروني",
          "تذكيرات",
          "محدَّثة دائماً"
      ...
      {
        "title": "مخطط الفريق والصلاحيات",
        "body": "مخطط فريق مرئي مع السحب لإعادة التعيين، والمستوى المناسب من الصلاحيات للملاك والموارد البشرية والمديرين والموظفين.",
        "chips": [
          "مخطط الفريق",
          "إعادة التعيين",
          "الصلاحيات المناسبة"
    ...
    "howEyebrow": "كيف تعمل",
    "howTitle": "سجلٌّ واحد، طوال الطريق.",
    "howSteps": [
      {
        "title": "وظّف وأدمِج",
  ...
  "fr": {
    ...
    "heroProof": [
      {
        "value": "De l'embauche au départ",
        "label": "un seul dossier par personne"
      },
      {
        "value": "Zéro papier",
        "label": "signez les documents dans l'app"
      },
      {
        "value": "Chaque employé",
        "label": "son propre accès gratuit"
      },
      {
        "value": "Pour les managers aussi",
        "label": "pas seulement les RH"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Documents sans papier",
        "body": "Stockez les documents, envoyez-les à la signature dans l'app, et recevez un rappel avant l'expiration de tout certificat ou visa.",
        "chips": [
      ...
      {
        "title": "Organigramme & accès",
        "body": "Un organigramme visuel avec glisser-pour-réaffecter, et le bon niveau d'accès pour les propriétaires, les RH, les managers et le personnel.",
        "chips": [
          "Organigramme",
          "Réaffecter",
          "Le bon accès"
    ...
    "howTitle": "Un seul dossier, du début à la fin.",
    "howSteps": [
      {
  ...
  "es": {
    ...
    "heroProof": [
      {
        "value": "De contratación a salida",
        "label": "un solo registro por persona"
      },
      {
        "value": "Sin papeles",
        "label": "firma documentos en la app"
      },
      {
        "value": "Cada empleado",
        "label": "su propio acceso gratuito"
      },
      {
        "value": "También para managers",
        "label": "no solo RR. HH."
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Documentos sin papel",
        "body": "Guarda documentos, envíalos a firma en la app y recibe un recordatorio antes de que caduque cualquier certificado o visado.",
        "chips": [
          "Firma electrónica",
          "Recordatorios",
          "Siempre al día"
      ...
      {
        "title": "Organigrama y accesos",
        "body": "Un organigrama visual con arrastrar-para-reasignar, y el nivel de acceso adecuado para propietarios, RR. HH., managers y personal.",
        "chips": [
          "Organigrama",
          "Reasignar",
          "Acceso adecuado"
    ...
    "howTitle": "Un solo registro, de principio a fin.",
    "howSteps": [
      {
  ...
  "de": {
    ...
    "heroProof": [
      {
        "value": "Einstellung bis Austritt",
        "label": "eine Akte pro Person"
      },
      {
        "value": "Papierlos",
        "label": "Dokumente in der App signieren"
      },
      {
        "value": "Jede:r Mitarbeitende",
        "label": "ein eigener kostenloser Zugang"
      },
      {
        "value": "Auch für Manager",
        "label": "nicht nur HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Papierlose Dokumente",
        "body": "Dokumente speichern, in der App zur Signatur senden und eine Erinnerung erhalten, bevor ein Zertifikat oder Visum abläuft.",
        "chips": [
          "E-Signatur",
          "Erinnerungen",
          "Immer aktuell"
      ...
      {
        "title": "Teamübersicht & Zugriff",
        "body": "Eine visuelle Teamübersicht mit Drag-and-drop-Zuordnung und das passende Zugriffslevel für Inhaber, HR, Manager und Mitarbeitende.",
        "chips": [
          "Teamübersicht",
          "Neu zuordnen",
          "Passender Zugriff"
    ...
    "howTitle": "Eine Akte, den ganzen Weg.",
    "howSteps": [
      {
  ...
  "nl": {
    ...
    "heroProof": [
      {
        "value": "Aanname tot vertrek",
        "label": "één dossier per persoon"
      },
      {
        "value": "Papierloos",
        "label": "documenten in de app tekenen"
      },
      {
        "value": "Elke medewerker",
        "label": "een eigen gratis login"
      },
      {
        "value": "Ook voor managers",
        "label": "niet alleen HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Papierloze documenten",
        "body": "Bewaar documenten, stuur ze ter ondertekening in de app en krijg een herinnering voordat een certificaat of visum verloopt.",
        "chips": [
          "E-handtekening",
          "Herinneringen",
          "Altijd actueel"
      ...
      {
        "title": "Teamoverzicht & toegang",
        "body": "Een visueel teamoverzicht met sleep-om-te-herindelen, en het juiste toegangsniveau voor eigenaren, HR, managers en medewerkers.",
        "chips": [
          "Teamoverzicht",
          "Herindelen",
          "Juiste toegang"
    ...
    "howTitle": "Eén dossier, de hele weg.",
    "howSteps": [
      {
  ...
  "pt": {
    ...
    "heroProof": [
      {
        "value": "Da contratação à saída",
        "label": "um registo por pessoa"
      },
      {
        "value": "Sem papel",
        "label": "assine documentos na app"
      },
      {
        "value": "Cada colaborador",
        "label": "o seu próprio acesso grátis"
      },
      {
        "value": "Também para gestores",
        "label": "não só para o RH"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Documentos sem papel",
        "body": "Guarde documentos, envie-os para assinatura na app e receba um lembrete antes de qualquer certificado ou visto expirar.",
        "chips": [
          "Assinatura digital",
          "Lembretes",
          "Sempre atual"
      ...
      {
        "title": "Organograma & acessos",
        "body": "Um organograma visual com arrastar-para-reatribuir, e o nível de acesso certo para proprietários, RH, gestores e colaboradores.",
        "chips": [
          "Organograma",
          "Reatribuir",
          "Acesso certo"
    ...
    "howTitle": "Um registo, do início ao fim.",
    "howSteps": [
      {
  ...
  "hi": {
    ...
    "heroProof": [
      {
        "value": "हायर से एग्ज़िट तक",
        "label": "हर व्यक्ति का एक रिकॉर्ड"
      },
      {
        "value": "काग़ज़-रहित",
        "label": "दस्तावेज़ ऐप में ही साइन करें"
      },
      {
        "value": "हर कर्मचारी",
        "label": "अपना मुफ़्त लॉगिन"
      },
      {
        "value": "मैनेजरों के लिए भी",
        "label": "सिर्फ़ HR के लिए नहीं"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "काग़ज़-रहित दस्तावेज़",
        "body": "दस्तावेज़ स्टोर करें, उन्हें ऐप में ही साइन के लिए भेजें, और किसी सर्टिफ़िकेट या वीज़ा के एक्सपायर होने से पहले रिमाइंडर पाएँ।",
        "chips": [
          "ई-सिग्नेचर",
          "रिमाइंडर",
          "हमेशा ताज़ा"
      ...
      {
        "title": "टीम चार्ट और एक्सेस",
        "body": "ड्रैग-टू-रीअसाइन वाला एक विज़ुअल टीम चार्ट, और मालिकों, HR, मैनेजरों और स्टाफ के लिए सही स्तर का एक्सेस।",
        "chips": [
          "टीम चार्ट",
          "रीअसाइन",
          "सही एक्सेस"
    ...
    "howTitle": "एक रिकॉर्ड, पूरे रास्ते भर।",
    "howSteps": [
      {
  ...
  "ur": {
    ...
    "heroProof": [
      {
        "value": "بھرتی سے رخصتی تک",
        "label": "ہر شخص کا ایک ریکارڈ"
      },
      {
        "value": "کاغذ کے بغیر",
        "label": "دستاویزات ایپ میں ہی سائن کریں"
      },
      {
        "value": "ہر ملازم",
        "label": "اپنا مفت لاگ ان"
      },
      {
        "value": "مینیجرز کے لیے بھی",
        "label": "صرف HR کے لیے نہیں"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "کاغذ کے بغیر دستاویزات",
        "body": "دستاویزات محفوظ کریں، انہیں ایپ میں ہی سائن کے لیے بھیجیں، اور کسی سرٹیفکیٹ یا ویزے کی میعاد ختم ہونے سے پہلے ریمائنڈر پائیں۔",
        "chips": [
          "ای سگنیچر",
          "ریمائنڈر",
          "ہمیشہ تازہ"
      ...
      {
        "title": "ٹیم چارٹ اور رسائی",
        "body": "ڈریگ کر کے دوبارہ تفویض والا ایک بصری ٹیم چارٹ، اور مالکان، HR، مینیجرز اور اسٹاف کے لیے صحیح سطح کی رسائی۔",
        "chips": [
          "ٹیم چارٹ",
          "دوبارہ تفویض",
          "صحیح رسائی"
    ...
    "howTitle": "ایک ریکارڈ، پورے راستے بھر۔",
    "howSteps": [
      {
  ...
  "it": {
    ...
    "heroProof": [
      {
        "value": "Dall'assunzione all'uscita",
        "label": "una scheda per persona"
      },
      {
        "value": "Senza carta",
        "label": "firma i documenti nell'app"
      },
      {
        "value": "Ogni dipendente",
        "label": "il proprio accesso gratuito"
      },
      {
        "value": "Anche per i manager",
        "label": "non solo per le HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Documenti senza carta",
        "body": "Archivia i documenti, inviali per la firma nell'app e ricevi un promemoria prima che un certificato o un visto scada.",
        "chips": [
          "Firma elettronica",
          "Promemoria",
          "Sempre aggiornati"
      ...
      {
        "title": "Organigramma e accessi",
        "body": "Un organigramma visivo con riassegnazione drag-and-drop e il giusto livello di accesso per titolari, HR, manager e personale.",
        "chips": [
          "Organigramma",
          "Riassegna",
          "Accesso giusto"
    ...
    "howTitle": "Un'unica scheda, lungo tutto il percorso.",
    "howSteps": [
      {
  ...
  "pl": {
    ...
    "heroProof": [
      {
        "value": "Od przyjęcia po odejście",
        "label": "jedna kartoteka na osobę"
      },
      {
        "value": "Bez papieru",
        "label": "podpisuj dokumenty w aplikacji"
      },
      {
        "value": "Każdy pracownik",
        "label": "własny darmowy login"
      },
      {
        "value": "Także dla menedżerów",
        "label": "nie tylko dla HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Dokumenty bez papieru",
        "body": "Przechowuj dokumenty, wysyłaj je do podpisu w aplikacji i dostawaj przypomnienie, zanim wygaśnie jakikolwiek certyfikat lub wiza.",
        "chips": [
          "e-podpis",
          "Przypomnienia",
          "Zawsze aktualne"
      ...
      {
        "title": "Schemat zespołu i dostęp",
        "body": "Wizualny schemat zespołu z przeciąganiem do zmiany przypisania oraz właściwy poziom dostępu dla właścicieli, HR, menedżerów i pracowników.",
        "chips": [
          "Schemat zespołu",
          "Zmiana przypisania",
          "Właściwy dostęp"
    ...
    "howTitle": "Jedna kartoteka, przez całą drogę.",
    "howSteps": [
      {
  ...
  "tr": {
    ...
    "heroProof": [
      {
        "value": "İşe alımdan çıkışa",
        "label": "kişi başına tek kayıt"
      },
      {
        "value": "Kâğıtsız",
        "label": "belgeleri uygulamada imzalayın"
      },
      {
        "value": "Her çalışan",
        "label": "kendi ücretsiz girişi"
      },
      {
        "value": "Yöneticiler için de",
        "label": "yalnızca İK için değil"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Kâğıtsız belgeler",
        "body": "Belgeleri saklayın, imza için uygulamada gönderin ve herhangi bir sertifika veya vize süresi dolmadan önce hatırlatma alın.",
        "chips": [
          "e-imza",
          "Hatırlatmalar",
          "Her zaman güncel"
      ...
      {
        "title": "Ekip şeması ve erişim",
        "body": "Sürükle-bırakla yeniden atama yapılan görsel bir ekip şeması ve sahipler, İK, yöneticiler ve personel için doğru erişim düzeyi.",
        "chips": [
          "Ekip şeması",
          "Yeniden atama",
          "Doğru erişim"
    ...
    "howTitle": "Tek bir kayıt, baştan sona.",
    "howSteps": [
      {
  ...
  "zh-Hans": {
    ...
    "features": [
      ...
      {
        "title": "无纸化文件",
        "body": "存放文件、在应用内发送签署,并在任何证书或签证到期前收到提醒。",
        "chips": [
          "电子签名",
          "提醒",
          "始终最新"
      ...
      {
        "title": "团队架构图与权限",
        "body": "可拖拽改派的可视化团队架构图,以及为业主、HR、管理者和员工设定恰当的权限层级。",
        "chips": [
          "团队架构图",
          "改派",
          "恰当权限"
  ...
  "ja": {
    ...
    "featuresEyebrow": "People & HR の中身",
    "featuresTitle": "従業員の道のり全体を、ひとつに。",
    "featuresDescription": "従業員があなたと過ごす時間の各段階を、ひとつの記録に。見つけやすく、安全で、初期設定で意思決定に流れ込みます。",
    "features": [
      {
        "title": "採用から退職手続きまで",
        "body": "採用・身元確認・オンボーディング・社内異動・最終給与。道のりの一部ではなく、全体を。",
        "chips": [
          "オンボーディング",
          "社内異動",
          "退職手続き"
      ...
      {
        "title": "ペーパーレス書類",
        "body": "書類を保管し、アプリ内で署名を依頼。資格やビザの期限切れ前にリマインドが届きます。",
        "chips": [
          "電子署名",
          "リマインド",
          "常に最新"
      ...
      {
        "title": "評価と成長",
        "body": "人事評価・報酬・人材・昇進。チームを運用するのと同じ場所で、人に関する意思決定を。",
        "chips": [
          "評価",
          "報酬",
          "昇進"
      ...
      {
        "title": "Ask-HR ヘルプデスク",
        "body": "スタッフがHRの質問や案件を上げられる非公開の場。応答時間と明確な記録付きで、製品サポートとは分けて管理します。",
        "chips": [
          "非公開",
          "追跡可能",
          "明確な記録"
      ...
      {
        "title": "組織図とアクセス権",
        "body": "ドラッグで再配置できる組織図と、オーナー・HR・マネージャー・スタッフに適したアクセス権。",
        "chips": [
          "組織図",
          "再配置",
          "適切な権限"
      ...
      {
        "title": "無料の従業員アプリ",
        "body": "全従業員に無料の Sundae ログイン。シフト・休暇・給与明細・打刻が、すべて手のひらに。",
        "chips": [
          "シフトと休暇",
          "給与明細",
          "全員無料"
    ...
    "howEyebrow": "仕組み",
    "howTitle": "ひとつの記録で、最初から最後まで。",
    "howSteps": [
      {
        "title": "採用とオンボーディング",
        "body": "新しい仲間は初日から、書類も手続きもすべて、ひとつの記録に集約されます。"
      },
      {
        "title": "日々の管理",
        "body": "書類・評価・休暇・案件は、すべてその記録に。安全で、見つけやすいまま。"
      },
      {
        "title": "きれいに退職手続き",
        "body": "最終給与・退職ステップ・記録が、やり残しなく完了します。"
      }
    ],
    "loopLine": "すべての変更は、自動で Labor Intelligence へ。別のエクスポートも、再入力もありません。",
    "creamEyebrow": "ひとつの記録、チーム全体",
    "creamStatement": "プラットフォームに流れ込む、人のレイヤー。",
    "creamLede": "多くの事業者は、分析が決して見ないツールでHRを運用しています。Crew People は道のり全体をひとつの記録に保ち、同じ人材データがそのまま意思決定へ流れ込みます。",
    "relatedEyebrow": "Crew のその他",
    "relatedTitle": "People & HR は、運用レイヤーのひとつのピースです。",
    "ctaEyebrow": "HRのサイロを廃止する",
    "ctaTitle": "道のりを、ひとつの記録で。",
    "ctaDescription": "30分、あなたの運用で。オンボーディング・書類・評価・退職手続きと、各ステップが Labor Intelligence をどう鋭くするかをご案内します。",
  ...
  "ko": {
    ...
    "features": [
      ...
      {
        "title": "종이 없는 문서",
        "body": "문서를 보관하고, 앱에서 서명을 받고, 어떤 증명서나 비자가 만료되기 전에 알림을 받으세요.",
        "chips": [
          "전자 서명",
          "알림",
          "언제나 최신"
      ...
      {
        "title": "조직도 & 접근 권한",
        "body": "끌어서 재배치하는 시각적 조직도와, 오너, HR, 매니저, 직원에게 알맞은 수준의 접근 권한.",
        "chips": [
          "조직도",
          "재배치",
          "알맞은 권한"
  ...
  "id": {
    ...
    "heroProof": [
      {
        "value": "Rekrut hingga keluar",
        "label": "satu catatan per orang"
      },
      {
        "value": "Tanpa kertas",
        "label": "tanda tangan di aplikasi"
      },
      {
        "value": "Setiap karyawan",
        "label": "login gratis sendiri"
      },
      {
        "value": "Untuk manajer juga",
        "label": "bukan cuma HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Dokumen tanpa kertas",
        "body": "Simpan dokumen, kirim untuk ditandatangani di aplikasi, dan terima pengingat sebelum sertifikat atau visa apa pun kedaluwarsa.",
        "chips": [
          "Tanda tangan e",
          "Pengingat",
          "Selalu terkini"
      ...
      {
        "title": "Bagan tim & akses",
        "body": "Bagan tim visual dengan seret-untuk-pindah, serta tingkat akses yang tepat bagi pemilik, HR, manajer, dan staf.",
        "chips": [
          "Bagan tim",
          "Pindah",
          "Akses tepat"
    ...
    "howTitle": "Satu catatan, dari awal hingga akhir.",
    "howSteps": [
      {
  ...
  "vi": {
    ...
    "heroProof": [
      {
        "value": "Tuyển đến nghỉ việc",
        "label": "một hồ sơ mỗi người"
      },
      {
        "value": "Không giấy tờ",
        "label": "ký tài liệu ngay trong app"
      },
      {
        "value": "Mọi nhân viên",
        "label": "tài khoản miễn phí của riêng mình"
      },
      {
        "value": "Cho cả quản lý",
        "label": "không chỉ riêng HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Tài liệu không giấy tờ",
        "body": "Lưu tài liệu, gửi đi để ký ngay trong app, và nhận nhắc nhở trước khi bất kỳ chứng chỉ hay visa nào hết hạn.",
        "chips": [
          "Chữ ký điện tử",
          "Nhắc nhở",
          "Luôn cập nhật"
      ...
      {
        "title": "Sơ đồ đội & phân quyền",
        "body": "Một sơ đồ đội trực quan với kéo-thả để chuyển bộ phận, cùng mức truy cập phù hợp cho chủ, HR, quản lý và nhân viên.",
        "chips": [
          "Sơ đồ đội",
          "Chuyển bộ phận",
          "Quyền phù hợp"
    ...
    "howTitle": "Một hồ sơ, xuyên suốt cả chặng đường.",
    "howSteps": [
      {
  ...
  "ro": {
    ...
    "heroProof": [
      {
        "value": "De la angajare la plecare",
        "label": "o fișă per persoană"
      },
      {
        "value": "Fără hârtie",
        "label": "semnezi documente în aplicație"
      },
      {
        "value": "Fiecare angajat",
        "label": "propriul cont gratuit"
      },
      {
        "value": "Și pentru manageri",
        "label": "nu doar pentru HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Documente fără hârtie",
        "body": "Stochează documente, trimite-le la semnat în aplicație și primește o notificare înainte ca vreun certificat sau viză să expire.",
        "chips": [
      ...
      {
        "title": "Organigramă & acces",
        "body": "O organigramă vizuală cu reatribuire prin tragere și nivelul potrivit de acces pentru proprietari, HR, manageri și angajați.",
        "chips": [
          "Organigramă",
          "Reatribuire",
          "Acces potrivit"
    ...
    "howTitle": "O singură fișă, pe tot parcursul.",
    "howSteps": [
      {
  ...
  "sv": {
    ...
    "heroProof": [
      {
        "value": "Från anställning till avsked",
        "label": "en akt per person"
      },
      {
        "value": "Papperslöst",
        "label": "signera dokument i appen"
      },
      {
        "value": "Varje anställd",
        "label": "sin egen gratis inloggning"
      },
      {
        "value": "För chefer också",
        "label": "inte bara HR"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Papperslösa dokument",
        "body": "Förvara dokument, skicka dem för signering i appen och få en påminnelse innan något intyg eller visum går ut.",
        "chips": [
          "E-signering",
          "Påminnelser",
          "Alltid aktuella"
      ...
      {
        "title": "Organisationsschema & behörighet",
        "body": "Ett visuellt organisationsschema med dra-för-att-flytta, och rätt behörighetsnivå för ägare, HR, chefer och personal.",
        "chips": [
          "Organisationsschema",
          "Flytta om",
          "Rätt behörighet"
    ...
    "howTitle": "En enda akt, hela vägen igenom.",
    "howSteps": [
      {
  ...
  "bn": {
    ...
    "heroProof": [
      {
        "value": "নিয়োগ থেকে বিদায়",
        "label": "প্রতি ব্যক্তির একটি রেকর্ড"
      },
      {
        "value": "কাগজবিহীন",
        "label": "অ্যাপেই ডকুমেন্ট সই"
      },
      {
        "value": "প্রতিটি কর্মী",
        "label": "নিজের ফ্রি লগইন"
      },
      {
        "value": "ম্যানেজারদের জন্যও",
        "label": "শুধু HR নয়"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "কাগজবিহীন ডকুমেন্ট",
        "body": "ডকুমেন্ট রাখুন, অ্যাপেই সইয়ের জন্য পাঠান, আর যেকোনো সার্টিফিকেট বা ভিসার মেয়াদ শেষের আগে রিমাইন্ডার পান।",
        "chips": [
          "ই-স্বাক্ষর",
          "রিমাইন্ডার",
          "সবসময় হালনাগাদ"
      ...
      {
        "title": "টিম চার্ট ও অ্যাক্সেস",
        "body": "ড্র্যাগ-করে-পুনর্বণ্টনসহ একটি ভিজ্যুয়াল টিম চার্ট, আর মালিক, HR, ম্যানেজার ও স্টাফদের জন্য সঠিক মাত্রার অ্যাক্সেস।",
        "chips": [
          "টিম চার্ট",
          "পুনর্বণ্টন",
          "সঠিক অ্যাক্সেস"
    ...
    "howTitle": "একটাই রেকর্ড, পুরো পথজুড়ে।",
    "howSteps": [
      {
  ...
  "th": {
    "badge": "Crew · People & HR",
    "heroLine1": "ตั้งแต่รับเข้าจนลาออก",
    "heroLine2": "ในระเบียนเดียว",
    "description": "Crew People ดูแลทั้งเส้นทางของพนักงานทุกคน ตั้งแต่การรับเข้า การปฐมนิเทศ เอกสาร การประเมิน การลา ไปจนถึงการพ้นสภาพ บนระเบียนเดียวต่อคนที่ป้อนข้อมูลเข้า Sundae แทนที่จะนอนอยู่ในเครื่องมือ HR แยกต่างหากที่ไม่มีใครเปิด",
    "primaryCta": "จองสาธิตการใช้งาน Crew",
    "secondaryCta": "ดู Crew ทำงานจริง",
    "heroProof": [
      {
        "value": "รับเข้าจนลาออก",
        "label": "หนึ่งระเบียนต่อคน"
      },
      {
        "value": "ไร้กระดาษ",
        "label": "เซ็นเอกสารในแอป"
      },
      {
        "value": "พนักงานทุกคน",
        "label": "มีล็อกอินฟรีของตัวเอง"
      },
      {
        "value": "เพื่อผู้จัดการด้วย",
        "label": "ไม่ใช่แค่ HR"
      }
    ],
    "featuresEyebrow": "สิ่งที่มีใน People & HR",
    "featuresTitle": "ทั้งเส้นทางของพนักงาน ในที่เดียว",
    "featuresDescription": "ทุกช่วงเวลาที่พนักงานอยู่กับคุณบนระเบียนเดียว หาง่าย ปลอดภัย และป้อนเข้าสู่การตัดสินใจโดยปริยาย",
    "features": [
      {
        "title": "ตั้งแต่รับเข้าจนพ้นสภาพ",
        "body": "การสรรหา การตรวจประวัติ การปฐมนิเทศ การโยกย้ายภายใน และเงินงวดสุดท้าย ทั้งเส้นทาง ไม่ใช่แค่ส่วนหนึ่ง",
        "chips": [
          "ปฐมนิเทศ",
          "โยกย้ายภายใน",
          "พ้นสภาพ"
      ...
      {
        "title": "เอกสารไร้กระดาษ",
        "body": "จัดเก็บเอกสาร ส่งให้เซ็นในแอป และรับการเตือนก่อนใบรับรองหรือวีซ่าใดหมดอายุ",
        "chips": [
      ...
      {
        "title": "ประเมินและเติบโต",
        "body": "การประเมินผลงาน ค่าจ้าง ความสามารถ และการเลื่อนตำแหน่ง การตัดสินใจเรื่องคน ทำในที่เดียวกับที่คุณบริหารทีม",
        "chips": [
          "ประเมินผล",
          "ค่าจ้าง",
          "เลื่อนตำแหน่ง"
      ...
      {
        "title": "เฮลป์เดสก์ Ask-HR",
        "body": "พื้นที่ส่วนตัวให้พนักงานตั้งคำถามและเปิดเคสด้าน HR พร้อมเวลาตอบและร่องรอยที่ชัดเจน แยกจากการสนับสนุนผลิตภัณฑ์",
        "chips": [
          "ส่วนตัว",
          "ติดตามได้",
          "ร่องรอยชัดเจน"
      ...
      {
        "title": "ผังทีมและสิทธิ์การเข้าถึง",
        "body": "ผังทีมแบบเห็นภาพที่ลากเพื่อย้ายตำแหน่งได้ พร้อมระดับสิทธิ์ที่เหมาะสมสำหรับเจ้าของ HR ผู้จัดการ และพนักงาน",
        "chips": [
          "ผังทีม",
          "ย้ายตำแหน่ง",
          "สิทธิ์ที่เหมาะสม"
      ...
      {
        "title": "แอปพนักงานฟรี",
        "body": "พนักงานทุกคนได้ล็อกอิน Sundae ฟรี ทั้งกะ การลา สลิปเงินเดือน และการลงเวลา อยู่ในกระเป๋าทั้งหมด",
        "chips": [
          "กะและการลา",
          "สลิปเงินเดือน",
          "ฟรีสำหรับทุกคน"
    ...
    "howTitle": "ระเบียนเดียว ตลอดทั้งเส้นทาง",
    "howSteps": [
      {
        "title": "รับเข้าและปฐมนิเทศ",
        "body": "พนักงานใหม่เข้าสู่ระเบียนเดียวตั้งแต่วันแรก พร้อมเอกสารและทุกอย่างครบ"
      },
      {
        "title": "ดูแลในแต่ละวัน",
        "body": "เอกสาร การประเมิน การลา และเคส อยู่บนระเบียนนั้นทั้งหมด ปลอดภัยและหาง่าย"
      },
      {
        "title": "พ้นสภาพอย่างเรียบร้อย",
        "body": "เงินงวดสุดท้าย ขั้นตอนการลาออก และระเบียน จบลงโดยไม่มีอะไรค้างคา"
      }
    ],
    "loopLine": "ทุกการเปลี่ยนแปลงป้อนเข้า Labor Intelligence อัตโนมัติ ไม่ต้องส่งออกแยก ไม่ต้องคีย์ซ้ำ",
    "creamEyebrow": "ระเบียนเดียว ทั้งทีม",
    "creamStatement": "ชั้นข้อมูลคนที่ป้อนเข้าทั้งแพลตฟอร์ม",
    "creamLede": "ผู้ประกอบการส่วนใหญ่ทำ HR ในเครื่องมือที่ระบบวิเคราะห์ไม่เคยเห็น Crew People เก็บทั้งเส้นทางไว้บนระเบียนเดียว ข้อมูลคนชุดเดียวกันจึงไหลตรงเข้าสู่การตัดสินใจของคุณ",
    "relatedEyebrow": "ส่วนที่เหลือของ Crew",
    "relatedTitle": "People & HR เป็นเพียงชิ้นหนึ่งของชั้นปฏิบัติการ",
    "ctaEyebrow": "ปลดระวางไซโล HR",
    "ctaTitle": "ดูทั้งเส้นทางบนระเบียนเดียว",
    "ctaDescription": "30 นาที กับการดำเนินงานของคุณ เราพาดูการปฐมนิเทศ เอกสาร การประเมิน และการพ้นสภาพ รวมถึงแต่ละขั้นทำให้ Labor Intelligence คมขึ้นอย่างไร",
  ...
  "ms": {
    ...
    "heroProof": [
      {
        "value": "Ambil hingga berhenti",
        "label": "satu rekod setiap orang"
      },
      {
        "value": "Tanpa kertas",
        "label": "tandatangan dokumen dalam apl"
      },
      {
        "value": "Setiap pekerja",
        "label": "log masuk percuma sendiri"
      },
      {
        "value": "Untuk pengurus juga",
        "label": "bukan HR sahaja"
      }
    ],
    ...
    "features": [
      ...
      {
        "title": "Dokumen tanpa kertas",
        "body": "Simpan dokumen, hantar untuk ditandatangani dalam apl, dan dapatkan peringatan sebelum mana-mana sijil atau visa luput.",
        "chips": [
          "e-tandatangan",
          "Peringatan",
          "Sentiasa terkini"
      ...
      {
        "title": "Carta pasukan & akses",
        "body": "Carta pasukan visual dengan seret-untuk-pindah, dan tahap akses yang betul untuk pemilik, HR, pengurus dan staf.",
        "chips": [
          "Carta pasukan",
          "Pindah tugas",
          "Akses yang betul"
    ...
    "howTitle": "Satu rekod, sepanjang perjalanan.",
    "howSteps": [
      {
