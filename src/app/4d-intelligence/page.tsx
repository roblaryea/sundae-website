...
const localized4DCopy = {
  ...
  fr: {
    ...
    alerts: [
      { type: 'Alerte coût main-d’oeuvre', location: 'Site centre-ville', message: 'Le coût de la main-d’oeuvre est 12% au-dessus du benchmark pour des restaurants similaires. Correction recommandée : rééquilibrer le planning - confiée au responsable du point de vente, avec la marge de main-d’oeuvre récupérée mesurée par rapport à la référence de la semaine dernière.', severity: 'warning', action: 'Revoir le planning', icon: 'warning' },
