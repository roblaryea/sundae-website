...
const localizedGettingStartedCopy: Record<"en" | "ar" | "fr" | "es", GettingStartedCopy> = {
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "All four packages cover the same ground. What changes is how deep each one goes - so you choose on the gap you are trying to close, not on how many sites you run.",
  ...
  fr: {
    ...
    steps: [
      ...
      { number: 2, title: "Choisissez votre package Core", subtitle: "La profondeur est le choix, pas le nombre de sites.", description: "Les quatre offres couvrent le même périmètre. Ce qui change, c'est la profondeur de chacun : vous choisissez donc sur l'écart à combler, pas sur le nombre de sites.", actions: ["Foundation - la base opérationnelle", "Margin - profondeur coût, gaspillage et fuites", "Growth - clients, promos et marge par canal", "Performance - consolidation multi-marques et multi-marchés"], timeline: "Une session de travail", cta: "Comparer les packages", ctaLink: "/core", icon: "balance", color: "from-[#F2B45C] to-[#C2410C]" },
