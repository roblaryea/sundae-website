        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card variant="elevated" className="hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 bg-[rgba(28,71,255,0.1)]0 rounded-xl flex items-center justify-center mb-4">
                  <SundaeIcon name="labor" size="lg" className="text-[var(--text-primary)]" />
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-blue-100 text-[#60A5FA] rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">1</div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm text-[var(--text-secondary)]">Upgrade to Report Plus for AI insights</p>
                  </div>
                  <div className="flex items-center space-x-3">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="p-6 bg-[var(--navy-deep)] rounded-xl shadow-none">
              ...
              <p className="text-sm text-[var(--text-supporting)] mb-4">Report Lite, no credit card</p>
              <Button 
                variant="primary" 
                size="md"
                className="w-full"
            ...
            <div className="p-6 bg-[var(--navy-deep)] rounded-xl shadow-none">
              ...
              <h3 className="font-semibold text-[var(--text-primary)] mb-2">Calculate Your Path</h3>
              <p className="text-sm text-[var(--text-supporting)] mb-4">Interactive pricing calculator</p>
            ...
            <div className="p-6 bg-[var(--navy-deep)] rounded-xl shadow-none">
              ...
              <p className="text-sm text-[var(--text-supporting)] mb-4">Custom recommendations</p>
              <Button 
                variant="outline" 
                size="md"
                className="w-full"
