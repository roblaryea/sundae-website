...
const localizedGettingStartedCopy: Record<"en" | "ar" | "fr" | "es", GettingStartedCopy> = {
  ...
  fr: {
    ...
    steps: [
      ...
      { number: 3, title: "Connectez vos systèmes", subtitle: "Le POS d'abord, puis main-d'œuvre et coûts.", description: "Sundae se pose au-dessus de ce que vous exploitez déjà. Le POS entre en premier car il ancre tout le reste, puis main-d'œuvre, stocks et achats complètent le tableau.", actions: ["Connecter votre POS", "Ajouter les sources main-d'œuvre et planning", "Ajouter stocks et achats", "Vérifier les chiffres face à votre clôture"], timeline: "La classe d'implémentation fixe le périmètre", cta: "Voir les intégrations", ctaLink: "/integrations", icon: "network", color: "from-green-500 to-green-600" },
      { number: 4, title: "Ajoutez les couches utiles", subtitle: "Main-d'œuvre, prévision et vos modèles d'exploitation.", description: "Crew est la couche workforce - planning, temps, paie et personnes. Foresight & Action ajoute la prévision, les scénarios et la couche d'action avec validation humaine. Les SKUs concepts activent les modèles d'exploitation que votre groupe opère réellement.", actions: ["Crew pour planning, temps, paie et personnes", "Foresight & Action pour prévision et scénarios", "Concepts : franchise, hôtellerie F&B, cloud kitchen, traiteur, production ou commissary locatif", "Watchtower pour l'intelligence marché, cadré avec vous"], timeline: "À ajouter quand cela le mérite", cta: "Découvrir Crew", ctaLink: "/crew", icon: "growth", color: "from-orange-500 to-orange-600" },
