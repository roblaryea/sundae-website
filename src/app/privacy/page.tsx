...
+            </div>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">2.1 Information You Provide to Us</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">2.2 Restaurant and Business Data (Customer Data)</h3>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.1 With Your Consent or Direction</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.2 Service Providers (Processors)</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.3 Aggregated and Benchmark Data</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.4 Legal Requirements and Protection of Rights</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.5 Business Transfers</h3>
                <p className="text-slate-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">12. Region-Specific Information</h2>
                
                <h3 className="text-xl font-semibold text-slate-900 mb-3">12.1 California Privacy Rights (CCPA/CPRA)</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">12.2 EEA/UK – GDPR</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">12.3 United Arab Emirates (including DIFC and ADGM)</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900 mb-2">Applicable Law</h4>
                <p className="text-slate-700 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900 mb-2">Data Controller and Processor</h4>
                <p className="text-slate-700 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900 mb-2">Your Rights</h4>
                <p className="text-slate-700 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900 mb-2">Cross-Border Transfers</h4>
                <p className="text-slate-700 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900 mb-2">Complaints</h4>
                <p className="text-slate-700 mb-4">
