...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", SolutionCopy> = {
  en: {
    ...
    description: "Campaign ROI tied to covers and net margin within 24 hours. Channel mix, attribution, and the margin you recover by reallocating - not a monthly recap.",
    ...
    ctaTitle: "Recover the margin your channel mix is leaking.",
  ...
  ar: {
    ...
    description: "ROI الحملة مرتبط بالضيوف وصافي الهامش خلال 24 ساعة. مزيج القنوات، الإسناد، والهامش الذي تستعيده بإعادة التخصيص - لا تقرير شهري.",
  ...
  fr: {
    ...
    description: "ROI campagne lié aux couverts et à la marge nette en 24h. Mix canal, attribution, la marge récupérée en réallouant - pas un récap mensuel.",
    ...
    ctaTitle: "Récupérez la marge que votre mix canal laisse fuir.",
  ...
  es: {
    ...
    description: "ROI de campaña ligado a cubiertos y margen neto en 24 horas. Mix de canal, atribución y el margen que recuperas al reasignar - no un recap mensual.",
    ...
    ctaTitle: "Recupera el margen que tu mix de canal está fugando.",
