...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", SolutionCopy> = {
  en: {
    ...
    description: "Live labor variance by location - routed to a named manager and measured back to margin. Overtime flagged before it lands, productivity read per FOH hour, not per pay period.",
    ...
    outcomesDescription: "Tighter schedules, OT owned by a manager, recovered labor margin measured back.",
    outcomes: [
      { title: "Recover the OT before it's paid", description: "Reallocate hours mid-week to a named manager and measure the labor margin back against baseline - not after the payroll run.", icon: "speed" },
    ...
    ctaTitle: "Find the leak. Recover the labor margin.",
    ctaDescription: "30 minutes. Your schedule. The OT hours routed to an owner - and the labor margin measured back against baseline.",
  ...
  ar: {
    ...
    outcomes: [
      { title: "استردّ OT قبل أن يُدفَع", description: "أعد توزيع الساعات في منتصف الأسبوع إلى مدير محدد وقِس هامش العمالة مجدداً مقابل خط الأساس - لا بعد تشغيل الرواتب.", icon: "speed" },
  ...
  fr: {
    ...
    outcomes: [
      { title: "Récupérez les heures sup' avant qu'elles ne soient payées", description: "Redistribuez les heures en milieu de semaine à un manager nommé et remesurez la marge main-d'œuvre face au point de référence - pas après le run de paie.", icon: "speed" },
  ...
  es: {
    ...
    outcomes: [
      { title: "Recupera las horas extra antes de pagarlas", description: "Redistribuye horas a mitad de semana a un gerente concreto y vuelve a medir el margen de personal contra la línea base - no después de la nómina.", icon: "speed" },
