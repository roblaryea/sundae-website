...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedHub> = {
  en: {
    ...
    description: "Decision intelligence built around the person who has to act on it, and measured on what that action returned - from the executive office to the floor.",
  ...
  ar: {
    ...
    description: "ذكاء القرار مصمم حول من يتحرك بناءً عليه، ويُقاس بما عاد من ذلك التحرك - من المكتب التنفيذي إلى الموقع.",
  ...
  fr: {
    ...
    description: "L'intelligence décisionnelle pensée pour la personne qui doit agir, et mesurée sur ce que cette action a rapporté - du bureau exécutif jusqu'à la salle.",
  ...
  es: {
    ...
    description: "Inteligencia de decisión construida alrededor de quien tiene que actuar, y medida por lo que esa acción devolvió - desde la dirección hasta el local.",
