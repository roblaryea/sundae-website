...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", SolutionCopy> = {
  en: {
    ...
    outcomes: [
      ...
      { title: "Catch the leak, measure it back", description: "Voids, comps, over-coverage - routed to the location owner and the recovered margin measured against baseline, not written off at month-end.", icon: "owners" },
    ...
    ctaTitle: "From margin leak to measured recovery.",
  ...
  ar: {
    ...
    outcomes: [
      ...
      { title: "أمسك التسرّب وقِس استرداده", description: "الإلغاءات والوجبات المجانية والتغطية الزائدة - تُوجَّه إلى مسؤول الموقع ويُقاس الهامش المستردّ مقابل خط الأساس، بدلاً من شطبها في نهاية الشهر.", icon: "owners" },
  ...
  fr: {
    ...
    outcomes: [
      ...
      { title: "Attrapez la fuite, mesurez sa récupération", description: "Annulations, offerts, sureffectif - transmis au responsable du site et la marge récupérée mesurée par rapport à la référence, plutôt que passée en perte en fin de mois.", icon: "owners" },
  ...
  es: {
    ...
    outcomes: [
      ...
      { title: "Atrapa la fuga y mide su recuperación", description: "Anulaciones, invitaciones, exceso de personal - dirigidos al responsable del local y el margen recuperado medido frente a la línea base, en vez de darse por perdido a fin de mes.", icon: "owners" },
