...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", SolutionCopy> = {
  en: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach gives the next move", description: "When a site is pacing 14% behind, Coach recommends a specific play to the GM - adjusted labor, a loyalty push, a menu swap - then measures the margin it recovers against baseline.", product: "Sundae Intelligence", icon: "intelligence" },
    ],
  ...
  ar: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach يعطي الخطوة التالية", description: "حين يتأخر موقع 14% عن وتيرته، يوصي Coach المديرَ بخطوة محددة - تعديل العمالة، دفعة ولاء، تبديل صنف في القائمة - ثم يقيس الهامش المسترد مقابل خط أساس.", product: "Sundae Intelligence", icon: "intelligence" },
    ],
  ...
  fr: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach donne le coup suivant", description: "Quand un site est 14% en retard sur son rythme, Coach recommande une action précise au directeur - main-d'œuvre ajustée, un coup de fidélité, un changement de carte - puis mesure la marge récupérée par rapport à une référence.", product: "Sundae Intelligence", icon: "intelligence" },
    ],
  ...
  es: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach da el siguiente paso", description: "Cuando un local va 14% por debajo del ritmo, Coach recomienda una jugada concreta al gerente - mano de obra ajustada, un empujón de fidelidad, un cambio de menú - y luego mide el margen recuperado contra una línea base.", product: "Sundae Intelligence", icon: "intelligence" },
    ],
