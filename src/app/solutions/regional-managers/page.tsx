...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", SolutionCopy> = {
  en: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach gives the next move", description: "When a site is pacing 14% behind, Coach recommends a specific play - adjusted labor, a loyalty push, a menu swap - based on what's worked before.", product: "Ask Sundae", icon: "intelligence" },
    ],
    ...
    outcomes: [
      ...
      { title: "Recover leakage you didn't know you had", description: "Margin hides in voids, comps, and overrides. Sundae surfaces it shift-by-shift, against your own baseline.", icon: "owners" },
    ],
  ...
  ar: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach يعطي الخطوة التالية", description: "حين يتأخر موقع 14%، يقترح Coach خطة محددة بناءً على ما نجح سابقاً.", product: "Ask Sundae", icon: "intelligence" },
    ],
    ...
    outcomes: [
      ...
      { title: "استرد تسرباً لم تعرف أنه موجود", description: "الهامش يختبئ في التجاوزات والتعويضات والتعديلات. Sundae يكشفه وردية بوردية، مقابل خط أساسك أنت.", icon: "owners" },
    ],
  ...
  fr: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach donne le coup suivant", description: "Quand un site est à −14%, Coach recommande une action concrète basée sur ce qui a marché.", product: "Ask Sundae", icon: "intelligence" },
    ],
    ...
    outcomes: [
      ...
      { title: "Récupérez la fuite que vous ne voyiez pas", description: "La marge se cache dans les annulations, offerts et overrides. Sundae la remonte service par service, face a votre propre reference.", icon: "owners" },
    ],
  ...
  es: {
    ...
    howSundaeHelps: [
      ...
      { title: "Sundae Coach da el siguiente paso", description: "Cuando un local va −14%, Coach recomienda una jugada concreta basada en lo que funcionó.", product: "Ask Sundae", icon: "intelligence" },
    ],
    ...
    outcomes: [
      ...
      { title: "Recupera fuga que no veías", description: "El margen se esconde en anulaciones, invitaciones y overrides. Sundae lo saca turno a turno, frente a tu propia referencia.", icon: "owners" },
    ],
