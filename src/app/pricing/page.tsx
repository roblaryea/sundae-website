...
const pricingPageCopy: Partial<Record<Exclude<WebsiteLocale, 'en'>, PricingPageCopy>> = {
  ...
  fr: {
    ...
    coreDescription:
      "Choisissez l'offre dont la profondeur correspond aux décisions que vous devez prendre. Chaque offre embarque les mêmes onze modules métier ; elles diffèrent par la profondeur de chacun.",
    ...
    creditsLabel: 'crédits IA / mois',
    includesLabel: 'Ce qui est inclus',
    bandsTitle: 'Comment fonctionne la tarification par site',
    bandsBody:
      "Votre premier site porte le prix d'ancrage de l'offre. Chaque site suivant est facturé au tarif marginal de sa tranche, et ce tarif baisse à mesure que vous grandissez. Franchir une tranche moins chère ne retarife pas les sites déjà en place.",
    bandsExample:
      'Cinq sites sur Core Foundation : 1 195 $ pour le premier, plus quatre à 175 $ = 1 895 $ par mois. Soit une moyenne pondérée de 379 $ par site - une moyenne du total, pas un tarif à multiplier.',
    modulesTitle: "Les onze modules métier sont compris dans l'offre",
    modulesBody: "Ils ne sont pas vendus séparément et n'ont pas de prix à l'unité. Choisir une offre Core, c'est les obtenir tous.",
    foresightTitle: 'Foresight & Action',
    foresightDescription:
      "Prévisions, modélisation de scénarios et couche d'action validée par un humain. Tarifée sur les mêmes tranches de sites que Core.",
    crewTitle: 'Sundae Crew',
    crewDescription: 'Le socle RH : personnes, plannings, temps et présence, préparation de la paie. Forfait mensuel, quel que soit le nombre de sites.',
    crewBundlesLabel: 'Bundles',
    conceptsTitle: 'Concepts',
    conceptsDescription: "Activez les modèles d'exploitation que votre groupe fait tourner. Chaque concept ajoute sa maille à tous les modules Core.",
    implementationTitle: 'Mise en œuvre',
    implementationDescription: 'Des frais de démarrage uniques. Si votre sélection couvre plusieurs classes, vous payez la plus élevée, jamais la somme.',
    implementationNote: 'Facturé une fois, à la classe la plus élevée de votre sélection.',
    volumeTitle: 'Volume',
