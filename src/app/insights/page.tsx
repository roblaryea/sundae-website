...
const localizedInsightsUi = {
  ...
  es: {
    ...
    description:
      '12 modulos especializados: ingresos, personal, inventario, compras, marketing, reservas, beneficio, delivery, experiencia de clientes, CRM, aseguramiento de ingresos e inteligencia cruzada.',
