 ...
 * contrast word (the "not" in the English source). The renderer splits on `*` and
...
export const aboutCreamCopy: Record<string, { eyebrow: string; statement: string; lede: string }> = {
  ...
  vi: {
    ...
    statement: 'Nhà hàng xứng đáng có quyết định, *chứ không* phải bảng số liệu.',
  ...
  ro: {
    ...
    statement: 'Restaurantele merită decizii, *nu* panouri.',
  ...
  sv: {
    ...
    statement: 'Restauranger förtjänar beslut, *inte* instrumentpaneler.',
    lede: 'Vi gör datan du redan skapar till nästa rätta steg - för varje roll.',
  },
  bn: {
    eyebrow: 'আমরা কেন Sundae তৈরি করেছি',
    statement: 'রেস্তোরাঁর প্রাপ্য সিদ্ধান্ত, ড্যাশবোর্ড *নয়*।',
  ...
  th: {
    ...
    statement: 'ร้านอาหารสมควรได้การตัดสินใจ *ไม่ใช่* แดชบอร์ด',
    lede: 'เราเปลี่ยนข้อมูลที่คุณสร้างอยู่แล้วให้เป็นก้าวต่อไปที่ถูกต้อง - สำหรับทุกบทบาท',
  },
  ms: {
    eyebrow: 'MENGAPA KAMI MEMBINA SUNDAE',
    statement: 'Restoran berhak mendapat keputusan, *bukan* papan pemuka.',
