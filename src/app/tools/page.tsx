...
const localizedCopy: RequiredEnglishLocalizedRecord<ToolsPageCopy> = {
  ...
  ar: {
    ...
    tools: [
      { title: "مقدّر تسرّب الهامش حسب فترة اليوم ✦", description: "اعرف الفترة التي يتسرب منها الهامش بسبب زيادة العمالة. ارتباط عبر نوافذ متعددة مع إسقاط سنوي للتسرب وإجراء تصحيحي محدد - لا مجرد حساب نسبة واحدة.", icon: "performance", href: "/tools/daypart-margin-leak", features: ["ارتباط عبر فترات متعددة", "كشف أسوأ نافذة زمنية", "التسرب السنوي بعملتك"], button: "افتح الأداة" },
      { title: "مؤشر فرص البيع الإضافي ✦", description: "قيّم صحة الإضافات في قائمتك من 0 إلى 100 وحدّد الفجوة السنوية في الإيراد مقابل معدلات إضافة صحية عبر المقبلات والأطباق الجانبية والمشروبات والحلويات والإضافات.", icon: "performance", href: "/tools/upsell-opportunity-index", features: ["مؤشر إضافات 0-100", "تحليل الفجوة لكل فئة", "أهم ثلاث أولويات"], button: "افتح الأداة" },
  ...
  fr: {
    ...
    tools: [
      { title: "Estimateur de fuite de marge par plage horaire ✦", description: "Trouvez la plage horaire qui perd de la marge par sureffectif. Corrélation multi-fenêtres avec projection annualisée de la fuite et une action corrective précise - pas un simple calcul de pourcentage.", icon: "performance", href: "/tools/daypart-margin-leak", features: ["Corrélation multi-plages", "Détection de la pire fenêtre", "Fuite annualisée dans votre devise"], button: "Ouvrir l'outil" },
      { title: "Indice d'opportunité d'upsell ✦", description: "Notez la santé d'attachement de votre carte de 0 à 100 et chiffrez l'écart de revenu annuel par rapport à des taux d'attachement sains sur entrées, accompagnements, boissons, desserts et suppléments.", icon: "performance", href: "/tools/upsell-opportunity-index", features: ["Score d'attachement 0-100", "Analyse d'écart par catégorie", "Top 3 des priorités"], button: "Ouvrir l'outil" },
  ...
  es: {
    ...
    tools: [
      { title: "Estimador de fuga de margen por franja ✦", description: "Encuentra la franja horaria que pierde margen por exceso de personal. Correlación multiventana con proyección anualizada de la fuga y una acción correctiva concreta, no un solo cálculo de porcentaje.", icon: "performance", href: "/tools/daypart-margin-leak", features: ["Correlación multifranja", "Detección de la peor franja", "Fuga anualizada en tu moneda"], button: "Abrir herramienta" },
      { title: "Índice de oportunidad de upselling ✦", description: "Puntúa la salud de attach de tu carta de 0 a 100 y cuantifica la brecha anual de ingresos frente a tasas de attach sanas en entrantes, guarniciones, bebidas, postres y extras.", icon: "performance", href: "/tools/upsell-opportunity-index", features: ["Puntuación de attach 0-100", "Análisis de brecha por categoría", "Top 3 de prioridades"], button: "Abrir herramienta" },
