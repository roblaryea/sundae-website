...
const localizedInsightsUi = {
  en: {
    ...
    description:
      'Twelve specialized modules cover revenue, labor, inventory, purchasing, marketing, reservations, profit, revenue assurance, delivery, guest experience, guest CRM, and cross-intelligence. Each module is built for one operating domain.',
  ...
  ar: {
    ...
    description:
      '12 وحدة متخصصة تشمل الإيرادات والعمالة والمخزون والمشتريات والتسويق والحجوزات والربحية والتوصيل وتجربة الضيف وCRM وضمان الإيرادات والذكاء المتقاطع.',
    bookDemo: 'احجز عرضًا',
  ...
  fr: {
    ...
    description:
      '12 modules spécialisés couvrant le revenu, la main-d&apos;œuvre, les stocks, les achats, le marketing, les réservations, la profitabilité, la livraison, l&apos;expérience client, le CRM, la garantie du revenu et l&apos;intelligence croisée.',
    ...
    whoItsForDescription: "Aux équipes qui ont besoin d'une lecture plus fine de chaque domaine opérationnel.",
    whoItsFor: [
    ...
    fitDescription:
      "Pulse surveille le service en temps réel et Watchtower suit ce qui se passe à l'extérieur. Les modules Insights donnent ensuite à chaque équipe une lecture plus précise de son domaine, de la main-d'œuvre au marketing.",
    fitItems: [
  ...
  es: {
    badge: 'MÓDULOS SUNDAE',
    title: 'Profundiza en cada parte de tu operación',
    description:
      '12 módulos especializados: ingresos, personal, inventario, compras, marketing, reservas, beneficio, delivery, experiencia de clientes, CRM, aseguramiento de ingresos e inteligencia cruzada.',
    ...
    valueProps: ['Añade módulos según los necesites', 'Analítica con IA por dominio', 'Disponible en planes Core'],
    whoItsForTitle: 'Para quién es',
    whoItsForDescription: 'Equipos que necesitan una lectura más fina de cada dominio operativo.',
    whoItsFor: [
      { title: 'Líderes de operación', description: 'Profundiza en áreas operativas concretas sin informes personalizados' },
      { title: 'Finanzas y FP&A', description: 'Inteligencia de beneficio, costes y aseguramiento de ingresos en tiempo real' },
      { title: 'Gerentes regionales', description: 'Visibilidad por módulo en cada local de tu territorio' },
    ],
    modulesTitle: '12 módulos. Una plataforma.',
    modulesDescription: 'Cada módulo ofrece analítica con IA para un dominio operativo concreto',
    howTitle: 'Cómo funciona',
    howDescription: 'Añade módulos a tu suscripción Core a medida que crecen tus necesidades',
    fitEyebrow: 'CÓMO ENCAJA INSIGHTS',
    fitTitle: 'La capa analítica',
    fitDescription:
      'Pulse vigila el turno en tiempo real y Watchtower sigue lo que ocurre fuera del local. Los módulos Insights dan a cada equipo una lectura más precisa de su dominio, desde personal e inventario hasta compras y marketing.',
    fitItems: [
      { name: 'Pulse', desc: 'Monitorización en tiempo real' },
      { name: 'Watchtower', desc: 'Inteligencia de mercado externa' },
      { name: 'Insights', desc: 'Inteligencia analítica por dominio' },
    ],
    ctaTitle: 'Empieza por lo que más importa',
    ctaDescription: 'Añade los módulos que tu operación necesita. Escala con tu crecimiento.',
    ctaDemo: 'Reservar una demo',
    ctaPricing: 'Ver precios de módulos',
  },
} as const;
  ...
  fr: [
    {
      ...
      description: "Allez au-delà du chiffre d'affaires global pour comprendre le mix produit, les moments forts, les canaux et les tendances de revenu.",
      capabilities: ["Analyse du mix et des articles", "Optimisation des dayparts", "Ventilation par canal", "Prévision des tendances de revenu"],
      category: "Opérations coeur",
      color: "from-emerald-500 to-emerald-600"
    },
    {
      name: "Intelligence main-d'œuvre",
      icon: "labor",
      headline: "Optimisez les plannings, réduisez les heures sup, anticipez la demande.",
      description: "Transformez la main-d'œuvre, souvent votre plus grand coût, en un levier optimisé grâce aux recommandations IA.",
      capabilities: ["Plannings recommandés par IA", "Suivi du coût main-d'œuvre en temps réel", "Prévision de la demande sur 14 à 30 jours", "Analyse de performance par shift", "Alertes précoces sur les heures sup"],
      category: "Opérations coeur",
      color: "from-[#FF7E6F] to-[#FF5C4D]"
    },
    {
      ...
      icon: "insights",
      headline: "Suivez le gaspillage, automatisez les niveaux, optimisez les coûts.",
      description: "Faites passer la gestion des stocks d'un casse-tête quotidien à un système optimisé avec suivi temps réel et recommandations automatiques.",
      capabilities: ["Suivi du gaspillage en temps réel", "Ajustement automatique des niveaux", "Coût recette par recette", "Suivi de performance fournisseur", "Optimisation de la rotation"],
      category: "Opérations coeur",
      color: "from-[#F2B45C] to-[#C2410C]"
    },
    {
      ...
      description: "Évitez les surcoûts en comparant les prix, en suivant la conformité contractuelle et en détectant les économies possibles.",
      capabilities: ["Comparaison de prix fournisseurs", "Suivi de conformité des contrats", "Analyse des achats", "Alertes d'économies"],
      category: "Support",
      color: "from-green-500 to-green-600"
    },
    {
      ...
      description: "Reliez le budget marketing à l'impact réel sur le revenu pour savoir quelles campagnes et quels canaux méritent plus d'investissement.",
    ...
    },
    {
      ...
      icon: "reservations",
      headline: "Prédisez les no-shows, optimisez le seating, maximisez les rotations.",
      description: "Allez au-delà de la gestion des réservations en anticipant les no-shows et en alignant la capacité front-of-house avec la demande.",
      capabilities: ["Prédiction des no-shows", "Optimisation des rotations de table", "Recommandations de placement selon la demande", "Analytique walk-in vs réservation"],
      category: "Support",
      color: "from-teal-500 to-teal-600"
    },
    {
      ...
      icon: "finance",
      headline: "Voyez la vraie rentabilité par shift, article et site.",
      description: "Combinez revenu, main-d'œuvre, stock et frais fixes dans une vue de rentabilité temps réel.",
      capabilities: ["Suivi temps réel de la marge", "Analyse de rentabilité par shift", "Analyse de contribution des articles", "Vue P&L par site"],
      category: "Premium",
      color: "from-amber-500 to-amber-600"
    },
    {
      ...
      icon: "risk",
      headline: "Repérez les fuites, protégez vos marges, évitez les pertes.",
      description: "Détection automatisée des fuites de revenu comme les annulations, remises, remboursements et anomalies tarifaires.",
      capabilities: ["Détection des fuites", "Alertes sur les anomalies tarifaires", "Identification des abus de remise", "Score de protection du revenu"],
      category: "Protection",
      color: "from-red-500 to-red-600"
    },
    {
      ...
      icon: "delivery",
      headline: "Suivez les coûts plateformes, optimisez les marges, comparez les canaux.",
      description: "Comprenez l'économie réelle de la livraison selon les plateformes et optimisez votre mix.",
      capabilities: ["Suivi des coûts par plateforme", "Comparaison de rentabilité des canaux", "Analyse de l'impact des commissions", "Optimisation du menu livraison"],
      category: "Canal",
      color: "from-[#FF6B5B] to-[#E03E48]"
    },
    {
      ...
      icon: "success",
      headline: "Écoutez les clients, détectez les tendances, agissez vite.",
      description: "Agrégez avis, sondages et signaux sociaux dans une vue unifiée du sentiment avec détection de tendances par IA.",
      capabilities: ["Agrégation multi-source des avis", "Analyse de sentiment par IA", "Suivi des tendances qualité", "Score de satisfaction client"],
      category: "Insight",
      color: "from-[#FF8473] to-[#FF5C4D]"
    },
    {
      ...
      icon: "operators",
      headline: "Connaissez vos clients, retenez les meilleurs, réengagez les autres.",
      description: "Segmentez vos clients par valeur, suivez la valeur vie, la fidélité et les risques de churn.",
      capabilities: ["Segmentation et valeur vie client", "Analytique du programme de fidélité", "Détection du risque de churn", "Déclencheurs de campagnes de rétention"],
      category: "Insight",
      color: "from-rose-500 to-rose-600"
    },
    {
      ...
      description: "Fait ressortir automatiquement les corrélations cachées entre modules actifs comme la main-d'œuvre et le revenu ou le stock et le gaspillage.",
      capabilities: ["Analyse de corrélation inter-domaines", "Remontée automatique des insights", "Détection d'attribution et de cannibalisation", "Score de santé multi-modules"],
      category: "Plateforme",
      color: "from-[#F2C078] to-[#E9A24A]"
    }
  ],
  es: [
    {
      ...
      description: "Ve más allá del ingreso total para entender el mix de menú, el timing por franja, los canales y las tendencias de crecimiento.",
      capabilities: ["Análisis de mix y productos", "Optimización de franjas horarias", "Desglose por canal", "Pronóstico de ingresos"],
    ...
    },
    {
      ...
      description: "Convierte la mano de obra en un activo optimizado con recomendaciones de horarios y pronóstico de demanda con IA.",
      capabilities: ["Horarios recomendados por IA", "Seguimiento del coste laboral en tiempo real", "Pronóstico de demanda de 14 a 30 días", "Análisis de rendimiento por turno", "Alertas tempranas de horas extra"],
      category: "Operaciones clave",
      color: "from-[#FF7E6F] to-[#FF5C4D]"
    },
    {
      ...
      description: "Convierte la gestión diaria de inventario en un sistema optimizado con seguimiento en tiempo real y recomendaciones automáticas.",
      capabilities: ["Seguimiento de mermas en tiempo real", "Ajustes automáticos de niveles", "Costeo por receta", "Monitoreo de proveedores", "Optimización de rotación"],
      category: "Operaciones clave",
      color: "from-[#F2B45C] to-[#C2410C]"
    },
    {
      ...
      description: "Evita pagar de más comparando precios, siguiendo el cumplimiento contractual e identificando ahorros.",
      capabilities: ["Comparación de precios de proveedores", "Seguimiento de cumplimiento de contratos", "Análisis de patrones de compra", "Alertas de ahorro"],
      category: "Soporte",
      color: "from-green-500 to-green-600"
    },
    {
      ...
      icon: "marketing",
      headline: "Mide campañas, atribuye ingresos y optimiza gasto.",
      description: "Conecta el gasto de marketing con el impacto real en ingresos para saber qué campañas y canales merecen más inversión.",
      capabilities: ["Atribución campaña-ingresos", "Seguimiento de canales", "Análisis ROI por campaña", "Medición del impacto promocional"],
    ...
    },
    {
      ...
      icon: "reservations",
      headline: "Predice no-shows, optimiza mesas y maximiza rotación.",
      description: "Ve más allá de la gestión de reservas prediciendo ausencias y alineando la capacidad del front con la demanda.",
      capabilities: ["Predicción de no-shows", "Optimización de rotación de mesas", "Recomendaciones de seating según demanda", "Analítica de walk-ins vs reservas"],
      category: "Soporte",
      color: "from-teal-500 to-teal-600"
    },
    {
      ...
      capabilities: ["Seguimiento del margen en tiempo real", "Análisis de rentabilidad por turno", "Análisis de contribución por producto", "Vista P&L por local"],
      category: "Premium",
      color: "from-amber-500 to-amber-600"
    },
    {
      ...
      icon: "risk",
      headline: "Detecta fugas, protege márgenes y evita pérdidas.",
      description: "Detección automatizada de fugas de ingresos como anulaciones, descuentos, reembolsos y anomalías de precio.",
      capabilities: ["Detección automática de fugas", "Alertas de anomalías de precio", "Identificación de abuso de descuentos", "Puntuación de protección de ingresos"],
      category: "Protección",
      color: "from-red-500 to-red-600"
    },
    {
      ...
      icon: "delivery",
      headline: "Controla costes de plataformas, optimiza márgenes y compara canales.",
      description: "Entiende la economía real del delivery entre plataformas y optimiza tu mezcla de canales.",
      capabilities: ["Seguimiento de costes por plataforma", "Comparación de rentabilidad por canal", "Análisis del impacto de comisiones", "Optimización del menú delivery"],
      category: "Canal",
      color: "from-[#FF6B5B] to-[#E03E48]"
    },
    {
      ...
      icon: "success",
      headline: "Escucha a tus clientes, detecta tendencias y actúa rápido.",
      description: "Agrupa reseñas, encuestas y señales sociales en una vista unificada del sentimiento con detección de tendencias por IA.",
      capabilities: ["Agregación de reseñas multifuente", "Análisis de sentimiento con IA", "Seguimiento de calidad del servicio", "Puntuación de satisfacción"],
      category: "Insight",
      color: "from-[#FF8473] to-[#FF5C4D]"
    },
    {
      ...
      icon: "operators",
      headline: "Conoce a tus clientes, retén a los mejores y recupera al resto.",
      ...
      capabilities: ["Segmentación y valor de vida", "Analítica de fidelización", "Detección y alertas de churn", "Disparadores de campañas de retención"],
      category: "Insight",
      color: "from-rose-500 to-rose-600"
    },
    {
      ...
      description: "Saca automáticamente correlaciones ocultas entre módulos activos como mano de obra e ingresos o inventario y merma.",
      capabilities: ["Análisis de correlación entre dominios", "Detección automática de insights", "Atribución y detección de canibalización", "Puntuación de salud multi-módulo"],
      category: "Plataforma",
      color: "from-[#F2C078] to-[#E9A24A]"
    }
  ]
