...
const localizedCrossIntelligenceMockups: Record<'en' | 'ar' | 'fr' | 'es', CrossIntelligenceMockupCopy> = {
  ...
  fr: {
    marketingTimeline: {
      ...
      campaignSpend: "Dépense campagne",
      revenue: "Revenu",
      campaignLaunch: "Lancement campagne",
      uplift: "Hausse du revenu détectée 5 jours après la campagne (+14%)",
    },
    causeEffect: {
      label: "Analyse cause-effet",
      alert: "Le revenu a baissé de 8,2 % vs. la semaine précédente",
      causes: [
        { cause: "Le staff de service a été réduit de 15 %", impact: "-$3,200" },
        { cause: "Article #4 rupture à 19h", impact: "-$1,800" },
        { cause: "Météo : pluie ven-sam", impact: "-$1,100" },
      ],
      strongNegative: "Fortement négatif",
      strongPositive: "Fortement positif",
    },
    correlationMatrix: {
      label: "Matrice de corrélation",
      modules: ["Rev", "Main-d'œuvre", "Stock", "Mktg", "Météo"],
      strongNegative: "Fortement négatif",
      strongPositive: "Fortement positif",
    },
    revenueWaterfall: {
      ...
      bars: [
        ...
        { label: "Promo", h: 25, color: "bg-green-500" },
        { label: "Menu", h: 15, color: "bg-green-400" },
        { label: "Main-d'œuvre", h: -10, color: "bg-red-400" },
        { label: "Météo", h: -8, color: "bg-red-300" },
        { label: "Total", h: 72, color: "bg-purple-500" },
      ],
    },
    spendRadar: {
      label: "Radar d'efficacité des dépenses",
      markers: ["Mktg", "Main-d'œuvre", "Stock", "Loyer", "Tech"],
      alert: "ROI marketing 2,3x au-dessus du benchmark. Main-d'œuvre en dessous.",
    },
    campaignPulse: {
      label: "Campaign Pulse Monitor",
      campaignROI: "ROI campagne",
      revImpact: "Impact revenu",
      headers: ["Campagne", "Dépense", "Rev", "ROI"],
      rows: [
        ["Brunch week-end", "$1,200", "$4,800", "4.0x"],
        ["Happy Hour", "$800", "$2,100", "2.6x"],
        ["Push fidélité", "$600", "$1,700", "2.8x"],
      ],
      warning: "Happy Hour : pic de coût main-d'œuvre détecté (+22 %)",
    },
    cannibalization: {
    ...
    whatChanged: {
      ...
      metrics: [
        { metric: "Revenu déj.", change: "+12%", cause: "Nouveaux plats + amélioration météo", severity: "positive" },
        { metric: "Coût main-d'œuvre %", change: "+3,1pp", cause: "Heures sup : 2 absences jeudi", severity: "negative" },
        { metric: "Gaspillage alimentaire", change: "-18%", cause: "Ajustement du niveau de par", severity: "positive" },
        { metric: "Ticket moyen", change: "-$2.40", cause: "Remise promo appliquée sans plafond", severity: "negative" },
      ],
    },
  },
  es: {
    marketingTimeline: {
      label: "Línea de impacto de marketing",
      campaignSpend: "Gasto de campaña",
      revenue: "Ingresos",
      campaignLaunch: "Lanzamiento de campaña",
      uplift: "Se detectó un aumento de ingresos 5 días después de la campaña (+14%)",
    },
    causeEffect: {
      label: "Análisis causa-efecto",
    ...
    spendRadar: {
      ...
      alert: "El ROI de marketing está 2.3x por encima del benchmark. La mano de obra va por debajo.",
    },
    campaignPulse: {
      label: "Campaign Pulse Monitor",
      ...
      warning: "Happy Hour: se detectó un pico en el coste laboral (+22%)",
    },
    cannibalization: {
    ...
    whatChanged: {
      ...
      metrics: [
        ...
        { metric: "Desperdicio de comida", change: "-18%", cause: "Se aplicó un ajuste de nivel de par", severity: "positive" },
        { metric: "Ticket medio", change: "-$2.40", cause: "Descuento promocional aplicado sin límite", severity: "negative" },
      ],
    },
  },
};
...
const localizedCrossIntelligenceComponents: Record<'en' | 'ar' | 'fr' | 'es', CrossIntelligenceComponent[]> = {
  ...
  fr: [
    {
      ...
      headline: "Voyez les effets retardés de chaque euro marketing",
      description: "Superposez dépenses marketing, campagnes et promotions sur votre chronologie de revenu pour révéler le délai entre action et impact.",
      capabilities: ["Overlay revenu + dépense marketing", "Attribution du ROI des campagnes avec score de confiance", "Visualisation de l'impact promo multi-sites", "Détection automatique des effets retardés"],
      icon: "chart",
      color: "from-[#F2B45C] to-[#C2410C]",
      tier: 'base',
    },
    {
      ...
      headline: "Explications générées automatiquement pour chaque variation",
      description: "Quand le revenu baisse ou que le coût main-d'œuvre grimpe, le moteur explique pourquoi en reliant les changements entre modules.",
      capabilities: ["Identification automatique des causes racines", "Score de confiance par hypothèse", "Recommandations actionnables avec impact estimé", "Rapprochement avec les patterns historiques"],
      icon: "idea",
      color: "from-[#E9A24A] to-[#FF5C4D]",
      tier: 'base',
    },
    {
      ...
      headline: "Vue complète de toutes les connexions",
      description: "Visualisez la force et le sens des relations entre revenu, main-d'œuvre, stock, marketing, météo et événements.",
      capabilities: ["Heatmap NxN interactive", "Force de corrélation temps réel", "Drill-down vers les données sous-jacentes", "Analyse des corrélations décalées", "Règles et seuils de corrélation personnalisés"],
      icon: "data",
      color: "from-[#F4A259] to-[#C2410C]",
      tier: 'pro',
    },
    {
      ...
      headline: "Attribuez les variations de revenu à des actions précises",
      description: "Décomposez les mouvements de revenu en actions marketing et opérationnelles pour comprendre la contribution de chaque facteur.",
      capabilities: ["Décomposition waterfall des variations de revenu", "Attribution aux campagnes, menus et changements de staffing", "Comparaison site par site", "Tendances d'attribution par période"],
      icon: "performance",
      color: "from-[#FF7E6F] to-[#E03E48]",
      tier: 'pro',
    },
    {
      ...
      headline: "Comparez le ROI de chaque catégorie de dépense",
      description: "Comparez le rendement de chaque euro sur le marketing, la main-d'œuvre, le stock et le loyer pour voir les zones sous-performantes.",
      capabilities: ["Radar ROI multi-axes", "Benchmark face à votre historique", "Comparaison d'efficacité par site", "Suggestions d'optimisation selon les écarts"],
      icon: "balance",
      color: "from-emerald-500 to-teal-600",
      tier: 'pro',
    },
    {
      ...
      headline: "Performance campagne en temps réel avec contexte opérationnel",
      description: "Reliez la performance des campagnes au revenu, à l'utilisation de la main-d'œuvre, à la rotation du stock et à la satisfaction client.",
      capabilities: ["Dashboard temps réel de campagne", "Suivi d'impact inter-modules", "Comparaison A/B avec significativité statistique", "Recommandations automatiques de pause si le ROI chute"],
      icon: "pulse",
      color: "from-rose-500 to-pink-600",
      tier: 'pro',
    },
    {
      ...
      headline: "Détectez quand vos promos mangent vos propres ventes",
      description: "Détectez automatiquement lorsqu'un nouvel article ou une promotion cannibalise vos produits existants avant d'éroser vos marges.",
      capabilities: ["Détection automatique de cannibalisation", "Analyse des substitutions de produits", "Quantification du déplacement de revenu", "Alertes selon seuil configurable", "Patterns historiques de cannibalisation"],
      icon: "warning",
      color: "from-amber-500 to-orange-600",
      tier: 'pro',
    },
    {
      ...
      description: "Quand un indicateur bouge fortement, le moteur identifie les causes probables en analysant toutes les sources reliées.",
      capabilities: ["Détection automatique d'anomalies", "Analyse causale multifactorielle", "Digest hebdomadaire des changements majeurs", "Règles d'alerte personnalisées"],
      icon: "search",
      color: "from-stone-500 to-stone-700",
      tier: 'base',
    },
  ...
  es: [
    {
      title: "Línea de impacto de marketing",
      headline: "Ve los efectos retrasados de cada dólar de marketing",
      description: "Superpone gasto, campañas y promociones sobre tu línea de ingresos para descubrir el retraso entre acción e impacto.",
      capabilities: ["Overlay de ingresos y gasto", "Atribución ROI de campañas con confianza estadística", "Visualización del impacto promocional multi-sede", "Detección automática de respuestas retrasadas"],
      icon: "chart",
      color: "from-[#F2B45C] to-[#C2410C]",
      tier: 'base',
    },
    {
      ...
      headline: "Explicaciones automáticas para cada cambio de métrica",
      description: "Cuando bajan los ingresos o suben los costes laborales, el motor explica por qué conectando cambios entre módulos.",
      capabilities: ["Identificación automática de causa raíz", "Puntuación de confianza por hipótesis", "Recomendaciones accionables con impacto estimado", "Comparación con patrones históricos"],
      icon: "idea",
      color: "from-[#E9A24A] to-[#FF5C4D]",
      tier: 'base',
    },
    {
      ...
      headline: "Vista completa de cómo todo se conecta",
      description: "Observa la fuerza y dirección de las relaciones entre ingresos, mano de obra, inventario, marketing, clima y eventos.",
      capabilities: ["Heatmap NxN interactivo", "Fuerza de correlación en tiempo real", "Drill-down a datos subyacentes", "Análisis de correlaciones con desfase", "Reglas y umbrales personalizados"],
      icon: "data",
      color: "from-[#F4A259] to-[#C2410C]",
      tier: 'pro',
    },
    {
      ...
      description: "Descompone el movimiento de ingresos en acciones operativas y de marketing para ver cuánto aportó cada factor.",
      capabilities: ["Descomposición en cascada", "Atribución a campañas, cambios de menú y staffing", "Comparación entre locales", "Tendencias de atribución entre periodos"],
      icon: "performance",
      color: "from-[#FF7E6F] to-[#E03E48]",
      tier: 'pro',
    },
    {
      ...
      headline: "Compara el ROI de cada categoría de gasto",
      description: "Compara el retorno de cada dólar en marketing, mano de obra, inventario y renta para detectar categorías menos eficientes.",
      capabilities: ["Radar ROI multi-eje", "Benchmark contra tu histórico", "Comparación de eficiencia por local", "Sugerencias de optimización por brechas"],
      icon: "balance",
      color: "from-emerald-500 to-teal-600",
      tier: 'pro',
    },
    {
      ...
      description: "Relaciona el rendimiento de campañas con ingresos, uso de mano de obra, rotación de inventario y satisfacción de clientes.",
      capabilities: ["Dashboard de campañas en tiempo real", "Seguimiento de impacto entre módulos", "Comparación A/B con significación estadística", "Recomendaciones automáticas de pausa si cae el ROI"],
      icon: "pulse",
      color: "from-rose-500 to-pink-600",
      tier: 'pro',
    },
    {
      ...
      description: "Detecta automáticamente cuando un producto o campaña nueva canibaliza ventas existentes antes de erosionar tus márgenes.",
      capabilities: ["Detección automática de canibalización", "Análisis de sustitución de productos", "Cuantificación del desplazamiento de ingresos", "Alertas por umbral configurable", "Patrones históricos de canibalización"],
      icon: "warning",
      color: "from-amber-500 to-orange-600",
      tier: 'pro',
    },
    {
      ...
      headline: "Análisis causal automático para cada movimiento de métricas",
      description: "Cuando una métrica se mueve de forma relevante, el motor identifica las causas más probables analizando todas las fuentes conectadas.",
      capabilities: ["Detección automática de anomalías", "Análisis causal multifactor", "Resumen semanal de cambios importantes", "Reglas de alerta personalizadas"],
      icon: "search",
      color: "from-stone-500 to-stone-700",
      tier: 'base',
    },
...
const localizedTierComparison: Record<'en' | 'ar' | 'fr' | 'es', { feature: string; base: boolean; pro: boolean }[]> = {
  ...
  fr: [
    ...
    { feature: "Alertes de corrélation basiques", base: true, pro: true },
    { feature: "Matrice de corrélation complète", base: false, pro: true },
    { feature: "Waterfall d'attribution revenu", base: false, pro: true },
    { feature: "Radar d'efficacité des dépenses", base: false, pro: true },
    { feature: "Campaign Pulse Monitor", base: false, pro: true },
    { feature: "Détecteur de cannibalisation", base: false, pro: true },
    { feature: "Historique illimité", base: false, pro: true },
    { feature: "Règles et seuils d'alerte personnalisés", base: false, pro: true },
    { feature: "Accès API aux données de corrélation", base: false, pro: true },
    { feature: "Traitement prioritaire", base: false, pro: true },
  ],
  es: [
    { feature: "Línea de impacto de marketing (30 días)", base: true, pro: true },
    { feature: "Tarjetas causa-efecto", base: true, pro: true },
    { feature: "Resumen semanal What Changed", base: true, pro: true },
    { feature: "Alertas básicas de correlación", base: true, pro: true },
    { feature: "Matriz de correlación completa", base: false, pro: true },
    { feature: "Cascada de atribución de ingresos", base: false, pro: true },
    { feature: "Radar de eficiencia del gasto", base: false, pro: true },
    { feature: "Campaign Pulse Monitor", base: false, pro: true },
    { feature: "Detector de canibalización", base: false, pro: true },
    { feature: "Historial ilimitado", base: false, pro: true },
    { feature: "Reglas y umbrales de alerta personalizados", base: false, pro: true },
    { feature: "Acceso API a datos de correlación", base: false, pro: true },
...
const crossIntelligenceCopy = {
  ...
  fr: {
    ...
    heroTitle: <>Moteur de<br />corrélation cross-intelligence</>,
    heroDescription:
      "Quand vos modules travaillent ensemble, les liens utiles remontent plus vite. Cross-Intelligence relie marketing, revenu, main-d'œuvre, stock et pertes pour montrer ce qui influence vraiment la performance.",
    heroSupport:
      'Les fonctions de Base sont incluses dans chaque offre Core, dont les domaines sont des composants du package. Passez à Pro pour le moteur complet avec attribution, détection de cannibalisation et accès API.',
    heroPrimary: 'Réserver une démo',
    heroSecondary: 'Voir le calculateur de prix',
    problemTitle: 'La vraie valeur apparaît quand les modules travaillent ensemble.',
    problemDescription:
      "Chaque module apporte une lecture utile sur un domaine, qu'il s'agisse de la main-d'œuvre, du stock, du marketing ou du revenu. Mais les décisions les plus solides viennent des liens entre ces domaines.",
    problemStats: [
      { stat: "3-7 jours", label: "Délai moyen entre les dépenses marketing et leur impact sur le revenu", icon: "time" as SundaeIconName },
      ...
      { stat: "5x", label: "De facteurs causaux identifiés vs analyse mono-module", icon: "increase" as SundaeIconName },
    ],
    componentsEyebrow: '8 COMPOSANTS',
    componentsTitle: 'Chaque connexion mise en lumière',
    componentsDescription:
      "Des alertes de corrélation basiques à l'attribution complète du revenu et à la détection de cannibalisation.",
    baseVsProTitle: 'Base vs Pro',
    baseVsProDescription: 'Base se débloque automatiquement. Pro débloque le moteur complet.',
    baseCardTitle: 'Intelligence croisée',
    ...
    ctaDescription:
      "Une courte visite avec votre équipe de la matrice de corrélation, du détecteur de cannibalisation et du waterfall d'attribution du revenu.",
    ctaPrimary: 'Réserver une démo',
    ctaSecondary: 'Voir le calculateur de prix',
  },
  es: {
    heroBadge: 'Se activa automáticamente con 3+ módulos',
    heroTitle: <>Motor de correlación<br />Cross-Intelligence</>,
    heroDescription:
      'Cuando tus módulos trabajan juntos, las relaciones útiles aparecen antes. Cross-Intelligence conecta marketing, ingresos, mano de obra, inventario y desperdicio para mostrar qué está moviendo realmente el rendimiento.',
    heroSupport:
      'Las funciones Base se incluyen en cada paquete Core, cuyos dominios son componentes del paquete. Sube a Pro para obtener el motor completo con atribución, detección de canibalización y acceso a API.',
    heroPrimary: 'Reservar una demo',
    heroSecondary: 'Ver calculadora de precios',
    problemTitle: 'El valor real aparece cuando los módulos trabajan juntos.',
    problemDescription:
      'Cada módulo te da una lectura fuerte de un dominio, ya sea mano de obra, inventario, marketing o ingresos. Pero las decisiones más sólidas salen de ver cómo se afectan entre sí.',
    problemStats: [
      { stat: "3-7 días", label: "Retraso promedio entre el gasto de marketing y su impacto en ingresos", icon: "time" as SundaeIconName },
      { stat: "23%", label: "De las promociones muestran canibalización medible de artículos existentes", icon: "warning" as SundaeIconName },
      { stat: "5x", label: "Más factores causales identificados frente al análisis de un solo módulo", icon: "increase" as SundaeIconName },
    ],
    componentsEyebrow: '8 COMPONENTES',
    componentsTitle: 'Cada conexión, visible',
    componentsDescription:
      'Desde alertas básicas de correlación hasta atribución completa de ingresos y detección de canibalización.',
    baseVsProTitle: 'Base vs Pro',
    baseVsProDescription: 'Base se desbloquea automáticamente. Pro desbloquea el motor completo.',
    ...
    ctaTitle: 'Ve Cross-Intelligence en acción',
    ctaDescription:
      'Un recorrido breve con tu equipo por la matriz de correlación, el detector de canibalización y la cascada de atribución de ingresos.',
