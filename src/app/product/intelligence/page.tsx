...
const localizedChatCopy = {
  ...
  fr: {
    ...
    heroDescription:
      "Questions en langage naturel, réponses visuelles structurées - alimentées en temps réel par vos données POS, stock, main-d'œuvre et livraison.",
    ...
    differentiators: [
      ...
      { title: "Connecté à tout", description: "Se branche sur chaque source connectée - POS, main-d'œuvre, stock, réservations, livraison. Portée complète par organisation.", icon: "integration" },
    ...
    queries: [
      ...
      "Compare les coûts de main-d'œuvre entre mes sites du centre-ville",
      "Pourquoi le chiffre d'affaires a-t-il baissé au site 5 cette semaine ?",
      "Montre-moi les sites où le coût de main-d'œuvre a dépassé 32%",
