...
const localizedWatchtowerCopy = {
  ...
  fr: {
    ...
    introCards: [
      ...
      { icon: "speed" as SundaeIconName, title: "Proactif, pas reactif", text: "Recevez des alertes quand les concurrents bougent. Anticipez les changements de demande. Agissez sur les tendances avant qu elles ne touchent votre marge." },
    ...
    ctaDescription: "Voyez votre activite dans son contexte marche complet. Protegez votre marge avant que le marche ne la deplace.",
  ...
  es: {
    ...
    introCards: [
      ...
      { icon: "speed" as SundaeIconName, title: "Proactivo, no reactivo", text: "Recibe alertas cuando los competidores se mueven. Anticipa cambios en la demanda. Actua sobre las tendencias antes de que afecten tu margen." },
