...
const localizedPillars: Record<'en' | 'ar' | 'fr' | 'es', Pillar[]> = {
  ...
  fr: [
    { name: "Pulse", tagline: "Operations intraday", description: "Rythme du revenu, cout de main-d oeuvre, performance serveur et detection des fuites - mise a jour toutes les 5 minutes, chaque signal confie au manager en poste et mesure avant la fin du service. Un service est un actif perissable.", icon: "pulse", features: ["Pacing ventes vs objectifs", "Suivi de l'upsell serveur", "Detection des fuites et annulations", "Signaux de shift Sundae Coach", "Classement portefeuille", "Mode wallboard pour la salle"], stat: "$2K", statLabel: "recuperes par mauvais service - repere, corrige et mesure avant la cloture", mockup: PulseDashboardMockup },
    { name: "Benchmarks", tagline: "Intelligence concurrentielle", description: "Index RevPASH, occupation des sieges, ticket moyen et indices de revenu - compares a des pairs anonymises de votre segment et marche, si bien que chaque ecart sous vos pairs devient une marge a recuperer et a mesurer.", icon: "benchmarking", features: ["Indices RevPASH et revenu", "Comparaisons avec les pairs", "Analyse des tendances", "Prevision du revenu", "Positionnement marche", "Insights prioritaires de Sundae Coach"], stat: "112", statLabel: "Index RevPASH - 12 % au-dessus des pairs", mockup: BenchmarkDashboardMockup },
    { name: "Watchtower", tagline: "Intelligence marche", description: "Suivi des concurrents, impact meteo sur le revenu, intelligence des evenements et briefings quotidiens - pour agir avant que l'impact n'apparaisse dans vos chiffres, et mesurer la marge que vous avez protegee.", icon: "watchtower", features: ["Suivi des prix et menus concurrents", "Modeles d'impact meteo", "Intelligence des evenements locaux", "Briefings quotidiens Sundae Coach", "Flux de signaux et alertes", "Detection des tendances marche"], stat: "72h", statLabel: "alerte precoce avant impact", mockup: WatchtowerMockup },
    { name: "Insights", tagline: "12 modules d'intelligence", description: "Revenu, main-d'oeuvre, stock, achats, marketing, reservations, livraison, experience client et plus - chaque recommandation Sundae Coach confiee a un responsable et mesuree par rapport a une reference.", icon: "insights", features: ["Intelligence revenu et profit", "Optimisation du cout main-d'oeuvre", "Gaspillage et ecarts de stock", "Notation achats et fournisseurs", "Attribution du ROI marketing", "Moteur de correlation Cross-Intelligence"], stat: "500+", statLabel: "modeles de donnees sur 12 domaines", mockup: InsightsModuleMockup },
    { name: "Sundae Intelligence", tagline: "Decisions conversationnelles", description: "Posez une question en langage simple, puis transformez chaque reponse sourcee en une decision suivie et mesurable - appuyee sur vos vraies donnees, avec sources, pas des suppositions. Disponible sur web, Telegram, Slack et Microsoft Teams.", icon: "conversation", features: ["Requetes en langage naturel", "Mode monitoring (alertes temps reel)", "Mode briefing (resumes quotidiens)", "Web + Telegram + Slack + Teams", "Historique de conversation", "Reponses citees"], stat: "30s", statLabel: "de la question a la reponse citee", mockup: IntelligenceChatMockup },
