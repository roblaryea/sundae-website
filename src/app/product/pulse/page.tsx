...
export default function PulsePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--navy-deep)]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="body-xl text-[var(--text-supporting)] mb-6 max-w-xl">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="p-4 bg-[rgba(220,38,38,0.1)]/60 rounded-xl text-center">
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-red-50/30">
        <div className="max-w-7xl mx-auto">
                ...
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-orange-600 rounded-lg flex items-center justify-center">
                      <SundaeIcon name={block.icon} size="md" className="text-[var(--text-primary)]" />
                    </div>
                    <div>
      ...
      {/* CTA */}
      <section className="section-standard px-4 sm:px-6 lg:px-8 bg-[var(--navy-deep)] text-[var(--text-primary)]">
