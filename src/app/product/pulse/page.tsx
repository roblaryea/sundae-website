        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="body-xl text-slate-600 mb-6 max-w-xl">
                ...
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-xl font-bold text-slate-900">{block.headline}</h3>
                    </div>
                  </div>
                  <p className="text-slate-600 leading-relaxed mb-4">{block.description}</p>
