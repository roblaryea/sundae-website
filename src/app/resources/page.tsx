...
const localizedCaseStudies: Record<string, CaseStudy[]> = {
  en: [
    ...
    { segment: "Enterprise Hospitality Group · Regional", challenge: "Market Positioning", description: "Hospitality operator with limited visibility into competitor pricing, category trends, and market share across 22 locations in competitive markets.", solution: ["Sundae Watchtower for market intelligence", "Sundae Report for competitive benchmarking", "Sundae Core for market analysis"], outcomes: [{ metric: "Market share growth", value: "+2.3%" }, { metric: "Competitive response time", value: "Days → Hours" }, { metric: "Pricing optimization", value: "+4%" }], icon: "benchmarking", color: "bg-[#FF5C4D]" },
  ],
  ar: [
