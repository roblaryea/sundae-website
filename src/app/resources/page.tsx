...
const localizedCaseStudies: Record<string, CaseStudy[]> = {
  ...
  fr: [
    { segment: "Groupe multi-marques · GCC", challenge: "Ecarts de cout main-d'oeuvre", description: "Un groupe de 35 sites subissait 18 % d ecart de cout main-d'oeuvre sans visibilite sur les causes racines.", solution: ["Sundae Core pour des tableaux de bord main-d'oeuvre en temps reel", "Sundae Core pour les alertes de planification", "Sundae Benchmarking pour le benchmarking"], outcomes: [{ metric: "Reduction du cout main-d'oeuvre", value: "5%" }, { metric: "Efficacite de planification", value: "+12%" }, { metric: "Vitesse de decision", value: "3x plus rapide" }], icon: "franchise", color: "bg-[#FF5C4D]" },
    { segment: "Franchise mondiale · 150+ sites", challenge: "Tarification et erosion de marge", description: "Un operateur international faisait face à 8 % d ecart de cout alimentaire par region.", solution: ["Sundae Core pour l analyse de tarification", "Sundae Core pour le suivi de marge", "Sundae Benchmarking pour les benchmarks"], outcomes: [{ metric: "Amelioration de marge", value: "+3.2%" }, { metric: "Abus de remise detecte", value: "Tôt" }, { metric: "Decisions de prix", value: "Temps reel" }], icon: "multiLocation", color: "bg-green-600" },
    { segment: "Cloud kitchen · multi-ville", challenge: "Angles morts operationnels", description: "Une reseau de dark kitchens en forte croissance avec des donnees fragmentees sur 8 plateformes.", solution: ["Sundae Core pour l integration", "Sundae Core pour le suivi de performance", "Sundae Core pour des dashboards unifies"], outcomes: [{ metric: "Unification des donnees", value: "8 plateformes" }, { metric: "Detection des problemes", value: "48h plus vite" }, { metric: "Optimisation du revenu", value: "+6%" }], icon: "kitchen", color: "bg-orange-600" },
    { segment: "Groupe hospitality enterprise · regional", challenge: "Positionnement marche", description: "Visibilite limitee sur les prix concurrents, les tendances de categorie et la part de marche.", solution: ["Sundae Watchtower pour l intelligence marche", "Sundae Benchmarking pour le benchmarking", "Sundae Core pour l analyse de marche"], outcomes: [{ metric: "Croissance de part de marche", value: "+2.3%" }, { metric: "Temps de reponse concurrentiel", value: "Jours → Heures" }, { metric: "Optimisation de prix", value: "+4%" }], icon: "benchmarking", color: "bg-[#FF5C4D]" },
  ],
  es: [
    { segment: "Grupo multimarca · GCC", challenge: "Variacion de costo laboral", description: "Un grupo de 35 locales sufria una variacion del 18% en costo laboral sin visibilidad sobre las causas raiz.", solution: ["Sundae Core para dashboards laborales en tiempo real", "Sundae Core para alertas de programacion", "Sundae Benchmarking para benchmarking"], outcomes: [{ metric: "Reduccion de costo laboral", value: "5%" }, { metric: "Eficiencia de programacion", value: "+12%" }, { metric: "Velocidad de decision", value: "3x mas rapida" }], icon: "franchise", color: "bg-[#FF5C4D]" },
    { segment: "Franquicia global · 150+ locales", challenge: "Precios de menu y erosion de margen", description: "Operador internacional con variacion del 8% en costo de alimentos entre regiones.", solution: ["Sundae Core para analisis de precios", "Sundae Core para seguimiento de margen", "Sundae Benchmarking para benchmarks"], outcomes: [{ metric: "Mejora de margen", value: "+3.2%" }, { metric: "Abuso de descuentos detectado", value: "Temprano" }, { metric: "Decisiones de precio", value: "Tiempo real" }], icon: "multiLocation", color: "bg-green-600" },
    { segment: "Cocina cloud · multi-ciudad", challenge: "Puntos ciegos operativos", description: "Red de cloud kitchens con datos fragmentados en 8 plataformas de delivery.", solution: ["Sundae Core para integracion", "Sundae Core para seguimiento de rendimiento", "Sundae Core para dashboards unificados"], outcomes: [{ metric: "Unificacion de datos", value: "8 plataformas" }, { metric: "Deteccion de problemas", value: "48h mas rapido" }, { metric: "Optimizacion de ingresos", value: "+6%" }], icon: "kitchen", color: "bg-orange-600" },
    { segment: "Grupo hospitality enterprise · regional", challenge: "Posicionamiento de mercado", description: "Visibilidad limitada de precios de competidores, tendencias y cuota de mercado.", solution: ["Sundae Watchtower para inteligencia de mercado", "Sundae Benchmarking para benchmarking", "Sundae Core para analisis"], outcomes: [{ metric: "Crecimiento de cuota", value: "+2.3%" }, { metric: "Tiempo de respuesta", value: "Dias → Horas" }, { metric: "Optimizacion de precios", value: "+4%" }], icon: "benchmarking", color: "bg-[#FF5C4D]" },
  ],
} as const;
