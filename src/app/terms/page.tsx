        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">1. Introduction & Acceptance of Terms</h2>
              ...
              <section>
                ...
                <p className="text-slate-700 mb-4">For purposes of these Terms:</p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Description of Services</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Eligibility & Account Registration</h2>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.1 Eligibility</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.2 Account Creation</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.3 Account Security</h3>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Permitted Use & Acceptable Use</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Customer Data, Usage Data & Privacy</h2>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.1 Ownership of Customer Data</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.2 License to Customer Data</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.3 Usage Data, Aggregated Data & Benchmark Data</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.4 Privacy Policy</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.5 Data Security</h3>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">7. User Responsibilities & Representations</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">9. License to Use the Services</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">10. Fees, Billing & Taxes</h2>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">10.1 Fees</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">10.2 Billing & Renewal</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">10.3 Cancellations & Refunds</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">10.4 Late Payments & Suspension</h3>
                <p className="text-slate-700 mb-4">
                  If you fail to pay fees when due, we may suspend or limit your access to the Services until payment is received.
                </p>

                <h3 className="text-xl font-semibold text-slate-900 mb-3">10.5 Taxes</h3>
                <p className="text-slate-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">11. Feedback</h2>
                <p className="text-slate-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">12. Service Availability, Changes & Beta Features</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">13. Additional Terms for Sundae Report</h2>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.1 Service Description (Sundae Report)</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.2 Data Provision</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.3 Anonymization & Aggregation</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.4 License to Anonymized & Aggregated Data</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.5 License to Use Sundae Report</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">13.6 Restrictions (Sundae Report)</h3>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">14. Confidentiality</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">15. Disclaimers</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">18. Term & Termination</h2>
                <h3 className="text-xl font-semibold text-slate-900 mb-3">18.1 Term</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">18.2 Termination by You</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">18.3 Termination or Suspension by Sundae</h3>
                <p className="text-slate-700 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3">18.4 Effect of Termination</h3>
                <p className="text-slate-700 mb-4">
                  Upon termination:
                </p>
                <ul className="list-disc pl-6 text-slate-700 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">19. Governing Law & Dispute Resolution</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">20. Changes to Terms</h2>
                <p className="text-slate-700 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">21. Assignment</h2>
                <p className="text-slate-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">22. Miscellaneous</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">23. Contact Us</h2>
                <p className="text-slate-700 mb-4">
