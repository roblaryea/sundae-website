...
const localizedDocsCopy: RequiredEnglishLocalizedRecord<DocumentationCopy> = {
  ...
  fr: {
    ...
    description: "Guides, références API et bonnes pratiques pour tirer le meilleur de Sundae.",
    primaryCta: "Réserver une démo",
    secondaryCta: "Découvrir le benchmarking",
    topicsLabel: "Sujets :",
    quickStartTitle: "Guide de démarrage rapide",
    quickStartDescription: "Mettez Sundae en route en quatre étapes simples",
    stepLabel: "Étape",
    comingSoonTitle: "Plus de documentation bientôt",
    comingSoonDescription:
      "Nous enrichissons continuellement la documentation. Revenez bientôt pour les références API, les tutoriels vidéo et les guides avancés.",
    contactPrompt: "Des questions d'ici là ?",
    contactLinkLabel: "Contacter notre équipe",
    ...
    sections: [
      {
        title: "Premiers pas",
        description: "Apprenez à démarrer sur Sundae et à connecter vos sources de données",
        icon: "growth",
        color: "bg-[#FF5C4D]",
        topics: [
          "Créer votre compte Sundae",
          "Connecter votre système POS",
          "Intégrer les données paie et RH",
          "Relier budgets et prévisions",
      ...
      },
      {
        ...
        color: "bg-green-600",
        topics: [
          "Importer vos données pour le benchmark",
      ...
      },
      {
        ...
        description: "Maîtrisez l'intelligence décisionnelle conversationnelle en langage naturel",
        icon: "intelligence",
        color: "bg-[#FF5C4D]",
        topics: [
      ...
      },
      {
        ...
        description: "Configurez les alertes en temps réel et l'intelligence de marché externe",
        icon: "insights",
        color: "bg-orange-600",
        topics: [
          "Configurer des alertes proactives",
          "Comprendre la détection d'anomalies",
          "Connecter les données externes comme la météo et les événements",
      ...
      },
      {
        ...
        description: "Construisez et adaptez des tableaux de bord pour chaque équipe",
        icon: "chart",
        color: "bg-[#FF5C4D]",
        topics: [
          "Créer des tableaux de bord personnalisés",
          "Configurer widgets et KPI",
          "Mettre en place des vues par rôle",
          "Planifier des rapports automatiques",
          "Partager les tableaux de bord avec les équipes",
        ],
      },
      {
        ...
        color: "bg-teal-600",
        topics: [
          "Chiffrement des données et standards de sécurité",
    ...
    quickStartSteps: [
      {
        ...
        description: "Reliez vos systèmes POS, paie, inventaire et budget à Sundae Core",
        icon: "integration",
      },
      {
        step: "2",
        title: "Lancer votre premier benchmark",
        description: "Importez vos données dans Sundae Report et comparez-vous à des restaurants similaires",
        icon: "benchmarking",
      },
      {
        step: "3",
        title: "Poser des questions",
        description: "Utilisez Sundae Core pour interroger vos données en langage naturel et obtenir des réponses immédiates",
        icon: "intelligence",
      },
      {
        step: "4",
  ...
  es: {
    ...
    description: "Guías, referencias de API y buenas prácticas para sacar el máximo partido de Sundae.",
    ...
    stepLabel: "Paso",
    comingSoonTitle: "Más documentación muy pronto",
    comingSoonDescription:
      "Seguimos ampliando la documentación. Vuelve pronto para ver referencias de API, tutoriales en vídeo y guías avanzadas.",
    contactPrompt: "¿Tienes preguntas mientras tanto?",
    contactLinkLabel: "Habla con nuestro equipo",
    supportTitle: "¿Necesitas ayuda?",
    supportDescription: "Nuestro equipo está aquí para ayudarte a sacar el máximo partido de Sundae.",
    supportCta: "Contactar soporte",
    trainingCta: "Programar formación",
    sections: [
      {
        ...
        topics: [
          ...
          "Integrar datos de nómina y RR. HH.",
      ...
      },
      {
        ...
        description: "Aprovecha al máximo el benchmarking gratuito y los informes de rendimiento",
        icon: "benchmarking",
        color: "bg-green-600",
        topics: [
          ...
          "Estándares del sector y grupos de pares",
    ...
    quickStartSteps: [
      {
        ...
        description: "Vincula tus sistemas POS, nómina, inventario y presupuesto a Sundae Core",
        icon: "integration",
      },
      {
        step: "2",
      ...
      },
      {
        ...
        description: "Configura Sundae Core para vigilar métricas clave y avisarte sobre anomalías",
        icon: "warning",
      },
    ],
  },
