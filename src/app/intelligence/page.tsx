            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Button
                  ...
                  size="lg"
                  href={SIGNUP_URL}
                  onClick={() => cta(SIGNUP_URL, "try_intelligence_hero", { page: "/intelligence" })}
                >
                  Try It Free
                </Button>
                <Button
                  variant="secondary"
                  size="lg"
                  onClick={() => cta("/demo", "book_demo_intelligence", { page: "/intelligence" })}
                >
                  Book a Demo
                </Button>
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() => cta("/demo", "book_demo_intelligence_cta", { page: "/intelligence" })}
            >
              Book a Demo
            </Button>
            <Button
              ...
              size="lg"
              onClick={() => cta(SIGNUP_URL, "start_free_intelligence_cta", { page: "/intelligence" })}
            >
              Start Free
            </Button>
          </div>
