...
export const frBatch5BlogTranslations: BlogLocaleTranslations = {
  'data-literacy-operators': {
    status: 'translated',
    title: "Développer la culture data dans les équipes opérations de la restauration",
    summary:
...
1. **Application pratique**: apprendre en prenant des décisions réelles, pas à travers des concepts abstraits
2. **Renforcement continu**: pratiquer régulièrement pour créer des automatismes
3. **Apprentissage contextualisé**: comprendre les métriques dans leur contexte opérationnel, pas isolément
4. **Complexité progressive**: commencer simple, puis monter en puissance à mesure que la confiance grandit
5. **Ancrage culturel**: faire des décisions fondées sur la donnée la norme, pas l’exception
...
1. **Aucune spécificité de concept**: elles mélangent QSR, fast-casual, casual dining et fine dining dans des moyennes sans signification
2. **Aucun contexte de marché**: elles traitent le marché de Dubaï comme celui de Kansas City malgré des règles salariales, des exigences de visa et des dynamiques concurrentielles très différentes
3. **Aucun ajustement de zone de chalandise**: elles comparent des sites en mall à des sites street-front alors que les flux, horaires et structures de coûts diffèrent
4. **Instantanés statiques**: les mises à jour annuelles ou trimestrielles ratent l’évolution du marché et les déplacements concurrentiels
5. **Aucune actionabilité**: des pourcentages globaux n’éclairent pas les décisions opérationnelles spécifiques
...
Sundae Report fournit le benchmarking granulaire qui éclaire réellement les décisions opérationnelles - pas des pourcentages génériques qui induisent plus en erreur qu’ils n’aident. Voyez comment vos opérations se comparent aux bons benchmarks pour votre concept, vos marchés et vos zones de chalandise. **Réservez une démo** pour accéder à des benchmarks en temps réel qui améliorent les décisions sur tout votre portefeuille.`,
  ...
  'labor-benchmarks-gcc': {
    status: 'translated',
    title: 'Benchmarks de main-d’œuvre en restauration dans le CCG : la réalité propre à chaque marché',
    summary:
...
Sundae Report fournit les benchmarks GCC de main-d’œuvre granulaires et sensibles au marché qui permettent de fixer des objectifs appropriés, d’identifier de vraies opportunités d’amélioration et de planifier l’expansion avec réalisme. Comprendre que votre main-d’œuvre de 27,8 % à Dubaï est solide quand la médiane marché est 27,5 %, tandis que votre main-d’œuvre de 31,0 % à Riyad doit être améliorée quand la médiane marché est 29,8 %, permet de concentrer les efforts là où ils comptent vraiment. **Obtenez votre Sundae Report gratuit** pour voir comment votre efficacité de main-d’œuvre se compare aux benchmarks spécifiques au marché pour vos concepts et vos sites dans le CCG.`,
  ...
  'food-cost-benchmarks-concept': {
    status: 'translated',
    title: 'Benchmarks de food cost par type de concept de restauration',
    summary:
...
Sundae Report fournit les benchmarks de food cost spécifiques au concept qui permettent de définir des objectifs réalistes pour l’efficacité QSR, la fraîcheur fast-casual, la variété casual dining et la créativité fine dining. Comprendre que votre food cost fast-casual de 33 % est cohérent lorsque la médiane du concept est à 32,4 %, alors que votre food cost QSR de 35 % demande une correction quand la médiane du concept est à 29,8 %, concentre les efforts d’amélioration là où ils comptent vraiment. **Obtenez votre Sundae Report gratuit** pour voir comment votre food cost se compare aux benchmarks appropriés pour votre type de concept et votre positionnement.`,
  ...
  'revenue-quality-benchmarks': {
    status: 'translated',
    title: 'Benchmarks de qualité du revenu : au-delà du chiffre d’affaires',
    summary:
...
Site X: 120 k$ par mois, 8 000 transactions, ticket moyen de 15 $
Site Y: 120 k$ par mois, 10 000 transactions, ticket moyen de 12 $
