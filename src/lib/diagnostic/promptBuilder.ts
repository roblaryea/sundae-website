...
5. **Ask Sundae** - Conversational decision intelligence. Natural-language-to-SQL on real data with source-cited answers. Replaces the spreadsheet → analyst → answer loop.
