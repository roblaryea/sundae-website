...
export const websiteMessages = {
  en: {
    ...
    home: {
      ...
      proofStats: [
        ...
        { number: '18', label: 'Decisions, not dashboards' },
  ...
  ar: {
    ...
    home: {
      ...
      proofStats: [
        ...
        { number: '18', label: 'قرارات، لا لوحات معلومات' },
  ...
  fr: {
    ...
    footer: {
      ...
      startFree: 'Commencer avec Report Lite',
      brandDescription:
        "Intelligence décisionnelle pour la restauration. Comprenez la performance, anticipez la suite et agissez avec confiance.",
      global: 'Global',
    ...
    home: {
      ...
      description:
        'Vos données vivent dans 5 à 10 systèmes déconnectés. Votre équipe décide au feeling pendant que les marges fuient.',
      descriptionEmphasis: 'C\'est ce compromis que Sundae fait disparaître.',
      ...
      proofStats: [
        ...
        { number: '18', label: 'Des décisions, pas des tableaux de bord' },
        { number: '12', label: 'Domaines de données unifiés' },
        { number: '5 min', label: 'Rafraîchissement par service' },
      ],
      problem: {
        eyebrow: 'LE PROBLÈME',
      ...
      platform: {
        ...
        layers: [
          ...
          { name: 'Sundae Intelligence', subtitle: 'IA conversationnelle', description: 'Posez n\'importe quelle question. Des réponses en secondes sur le web, Slack ou Teams.', href: '/intelligence' },
          { name: 'Foresight', subtitle: 'Intelligence prédictive', description: 'Prévisions à 14-90 jours, scénarios hypothèse, briefings dirigeants auto-correctifs.', href: '/product/foresight' },
        ],
      },
      modules: {
  ...
  es: {
    ...
    footer: {
      ...
      startFree: 'Comienza con Report Lite',
      brandDescription:
        'Inteligencia de decisión para restaurantes. Entiende el rendimiento, anticipa lo que viene y actúa con confianza.',
      global: 'Global',
    ...
    home: {
      ...
      description:
        'Tus datos viven en 5 a 10 sistemas desconectados. Tu equipo decide por intuición mientras el margen se fuga cada día.',
      descriptionEmphasis: 'Ese es el sacrificio que Sundae elimina.',
      ...
      proofStats: [
        ...
        { number: '18', label: 'Decisiones, no paneles' },
        { number: '12', label: 'Dominios de datos unificados' },
        { number: '5 min', label: 'Actualización por turno' },
      ],
      problem: {
        eyebrow: 'EL PROBLEMA',
      ...
      platform: {
        ...
        layers: [
          ...
          { name: 'Sundae Intelligence', subtitle: 'IA conversacional', description: 'Pregúntale cualquier cosa a tus datos. Respuestas en segundos en web, Slack o Teams.', href: '/intelligence' },
          { name: 'Foresight', subtitle: 'Inteligencia predictiva', description: 'Pronósticos de 14 a 90 días, escenarios hipotéticos y briefings ejecutivos autocorregibles.', href: '/product/foresight' },
        ],
      },
      modules: {
