  ...
  fr: {
    ...
    footer: {
      ...
      companyLinks: [
        ...
        { name: 'Contact', href: '/contact' },
        { name: 'Securite et conformite', href: '/security' },
        { name: 'Integrations', href: '/integrations' },
      ],
      extraResources: [
    ...
    home: {
      ...
      problem: {
        ...
        kpis: [
          ...
          { value: '72 h+', label: 'Pour cloturer les comptes', supporting: 'Et souvent cela prend plus de trois jours', color: 'amber' },
      ...
      pages: {
        signIn: {
          ...
          footerSecurity: 'Securite et conformite',
          footerSupport: 'Support',
    ...
    home: {
      ...
      problem: {
        ...
        kpis: [
          ...
          { value: '72 h+', label: 'Para cerrar libros', supporting: 'Y muchas veces tarda mas de tres dias', color: 'amber' },
