...
export const websiteMessages = {
  ...
  fr: {
    ...
    navbar: {
      ...
      about: 'A propos',
      signIn: 'Se connecter',
      bookDemo: 'Reserver une session de travail',
    ...
    footer: {
      readyTitle: 'Arretez de gerer vos restaurants avec les chiffres d hier.',
      readyDescription: 'Decouvrez comment Sundae fonctionnerait avec votre operation, en utilisant vos donnees lorsqu elles sont disponibles ou un scenario de restaurant representatif.',
      bookDemo: 'Reserver une session de travail',
      startFree: 'Commencer avec Report Lite',
      brandDescription:
  ...
  es: {
    ...
    navbar: {
      ...
      bookDemo: 'Reservar una sesion de trabajo',
    ...
    footer: {
      readyTitle: 'Deja de gestionar tus restaurantes con los numeros de ayer.',
      readyDescription: 'Vea como funcionaria Sundae con su operacion, utilizando sus datos cuando esten disponibles o un escenario de restaurante representativo.',
      bookDemo: 'Reservar una sesion de trabajo',
      startFree: 'Comienza con Report Lite',
      brandDescription:
