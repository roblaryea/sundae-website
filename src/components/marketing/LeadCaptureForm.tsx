...
export const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({
 ...
 : 'border-white/[0.1] focus:border-blue-600 focus:ring-blue-600/20'
 } bg-[var(--surface-subtle)] text-[var(--text-primary)] focus:ring-2 transition-all duration-200 outline-none`}
 ...
 ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20'
 : 'border-white/[0.1] focus:border-blue-600 focus:ring-blue-600/20'
 } bg-[var(--surface-subtle)] text-[var(--text-primary)] focus:ring-2 transition-all duration-200 outline-none text-sm`}
 >
 {COUNTRY_CODES.map((country) => (
 ...
 {errors.numberOfLocations && (
 <p id="locations-error" className="mt-1 text-sm text-red-600">
 {errors.numberOfLocations}
 </p>
 )}
 </div>
 ...
 />
 {errors.primaryPOS && (
 <p id="pos-error" className="mt-1 text-sm text-red-600">
 {errors.primaryPOS}
 </p>
 )}
 </div>
 ...
 ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20'
 : 'border-white/[0.1] focus:border-blue-600 focus:ring-blue-600/20'
 } bg-[var(--surface-subtle)] text-[var(--text-primary)] focus:ring-2 transition-all duration-200 outline-none resize-none`}
