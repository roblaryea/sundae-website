...
export const solutionCreamCopy: Record<string, SolutionCreamCopy> = {
  en: {
    ...
    lede: 'Everyone sees the same truth - leak found, fix owned, margin measured back - framed for the calls they actually make.',
  },
  ar: {
    eyebrow: 'مصمم لدورك',
    statement: 'سطح قرار مصمم على مقاس دورك - *لا* لوحة معلومات عامة.',
    lede: 'الجميع يرى الحقيقة نفسها - التسرب يُرصد، والإصلاح يُسنَد، والهامش يُقاس مجدداً - معروضة بما يناسب القرارات التي يتخذها فعلاً.',
  },
  fr: {
    eyebrow: 'PENSÉ POUR VOTRE RÔLE',
    statement: "Une surface de décision taillée pour votre rôle - *pas* un tableau de bord générique.",
    lede: 'Chacun voit la même vérité - fuite repérée, correction prise en charge, marge remesurée - cadrée pour les décisions qu il prend vraiment.',
  },
  es: {
    eyebrow: 'HECHO PARA TU ROL',
    statement: 'Una superficie de decisión a la medida de tu rol - *no* un panel genérico.',
    lede: 'Todos ven la misma verdad - fuga detectada, corrección asumida, margen vuelto a medir - planteada para las decisiones que de verdad toman.',
  },
  de: {
    ...
    lede: 'Alle sehen dieselbe Wahrheit - Leck gefunden, Korrektur übernommen, Marge zurückgemessen - zugeschnitten auf die Entscheidungen, die sie wirklich treffen.',
  },
  nl: {
    eyebrow: 'GEMAAKT VOOR JOUW ROL',
    statement: 'Een beslisoppervlak op maat van jouw rol - *geen* generiek dashboard.',
    lede: 'Iedereen ziet dezelfde waarheid - lek gevonden, oplossing opgepakt, marge terug gemeten - toegesneden op de keuzes die ze echt maken.',
  },
  pt: {
    eyebrow: 'FEITO PARA O SEU PAPEL',
    statement: 'Uma superfície de decisão moldada ao seu papel - *não* um painel genérico.',
    lede: 'Todos veem a mesma verdade - vazamento encontrado, correção assumida, margem medida de volta - enquadrada para as decisões que de fato tomam.',
  },
  hi: {
    eyebrow: 'आपकी भूमिका के लिए बना',
    statement: 'आपकी भूमिका के हिसाब से बना एक डिसीज़न सरफेस - कोई आम डैशबोर्ड *नहीं।*',
    lede: 'हर किसी को एक ही सच दिखता है - रिसाव मिला, सुधार का मालिक तय, मार्जिन दोबारा मापा गया - उन्हीं फैसलों के हिसाब से जो वे सचमुच लेते हैं।',
  },
  ur: {
    eyebrow: 'آپ کے کردار کے لیے بنایا گیا',
    statement: 'آپ کے کردار کے مطابق بنایا گیا فیصلہ سطح - کوئی عام ڈیش بورڈ *نہیں۔*',
    lede: 'سب کو وہی ایک سچ دکھتا ہے - رساو ملا، حل کا ذمہ دار طے، مارجن دوبارہ ناپا گیا - اُنہی فیصلوں کے مطابق جو وہ واقعی کرتے ہیں۔',
  },
  it: {
    ...
    lede: 'Tutti vedono la stessa verità - perdita individuata, correzione presa in carico, margine rimisurato - calibrata sulle decisioni che prendono davvero.',
  },
  pl: {
    eyebrow: 'STWORZONE DLA TWOJEJ ROLI',
    statement: 'Powierzchnia decyzyjna skrojona pod twoją rolę - *nie* ogólny pulpit.',
    lede: 'Każdy widzi tę samą prawdę - wyciek wykryty, poprawka przypisana, marża zmierzona z powrotem - ujętą pod decyzje, które naprawdę podejmuje.',
  },
  tr: {
    eyebrow: 'ROLÜNÜZE GÖRE TASARLANDI',
    statement: 'Rolünüze göre biçimlenmiş bir karar yüzeyi - genel bir gösterge paneli *değil.*',
    lede: 'Herkes aynı gerçeği görür - sızıntı bulundu, düzeltme sahiplenildi, marj yeniden ölçüldü - gerçekten verdikleri kararlara göre çerçevelenmiş olarak.',
  },
  'zh-Hans': {
    eyebrow: '为你的岗位而建',
    statement: '一个为你的岗位量身打造的决策界面--*而非*千篇一律的仪表盘。',
    lede: '人人看到同一份事实--漏损被找到、修正有人负责、利润率被重新衡量--只是按各自真正要做的决定来呈现。',
  },
  ja: {
    eyebrow: 'あなたの役割のために',
    statement: 'あなたの役割に合わせた意思決定の画面--ありきたりのダッシュボードでは*ない。*',
    lede: '全員が同じ事実を見る--漏れの発見、対策の担当、マージンの再測定--ただし、その人が実際に下す判断に合わせて。',
  },
  ko: {
    eyebrow: '당신의 역할에 맞춰',
    statement: '당신의 역할에 맞춰진 의사결정 화면 - 흔한 대시보드가 *아닙니다.*',
    lede: '모두가 같은 진실을 봅니다 - 누수 발견, 개선 책임자 지정, 마진 재측정 - 다만 각자가 실제로 내리는 결정에 맞춰서.',
  },
  id: {
    eyebrow: 'DIBUAT UNTUK PERAN ANDA',
    statement: 'Permukaan keputusan yang dibentuk untuk peran Anda - *bukan* dasbor generik.',
    lede: 'Semua melihat kebenaran yang sama - kebocoran ditemukan, perbaikan diampu, margin diukur kembali - dibingkai untuk keputusan yang benar-benar mereka ambil.',
  },
  vi: {
    ...
    lede: 'Mọi người thấy cùng một sự thật - rò rỉ được tìm ra, khắc phục có người phụ trách, biên lợi nhuận được đo lại - được trình bày cho đúng những quyết định họ thực sự đưa ra.',
  },
  ro: {
    eyebrow: 'CONSTRUIT PENTRU ROLUL TĂU',
    statement: 'O suprafață de decizie croită pe rolul tău - *nu* un panou generic.',
    lede: 'Toți văd același adevăr - scurgere găsită, corecție asumată, marjă remăsurată - încadrat pentru deciziile pe care chiar le iau.',
  },
  sv: {
    eyebrow: 'BYGGD FÖR DIN ROLL',
    statement: 'En beslutsyta formad efter din roll - *inte* en generisk instrumentpanel.',
    lede: 'Alla ser samma sanning - läcka hittad, åtgärd ägd, marginal återmätt - formad efter de beslut de faktiskt fattar.',
  },
  bn: {
    eyebrow: 'আপনার ভূমিকার জন্য তৈরি',
    statement: 'আপনার ভূমিকার মাপে গড়া একটি সিদ্ধান্ত-পৃষ্ঠ - কোনো গতানুগতিক ড্যাশবোর্ড *নয়।*',
    lede: 'সবাই একই সত্য দেখে - লিক ধরা পড়ল, সংশোধনের দায়িত্ব নেওয়া হলো, মার্জিন আবার মাপা হলো - শুধু সেই সিদ্ধান্তগুলোর মাপে যা তারা সত্যিই নেয়।',
  },
  th: {
    eyebrow: 'สร้างมาเพื่อบทบาทของคุณ',
    statement: 'พื้นผิวการตัดสินใจที่ปั้นมาเพื่อบทบาทของคุณ - *ไม่ใช่* แดชบอร์ดสำเร็จรูปทั่วไป',
    lede: 'ทุกคนเห็นความจริงเดียวกัน - พบจุดรั่วไหล การแก้ไขมีผู้รับผิดชอบ มาร์จิ้นวัดผลซ้ำ - เพียงแต่จัดวางให้ตรงกับการตัดสินใจที่เขาต้องทำจริง',
  },
  ms: {
    ...
    lede: 'Semua melihat kebenaran yang sama - kebocoran ditemukan, pembetulan diampu, margin diukur semula - dirangka untuk keputusan yang benar-benar mereka buat.',
  },
};
