...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedCopy> = {
  en: {
    ...
    items: [
      ...
      { title: "Governed Schema", supporting: "500+ food-service data models" },
    ],
  },
  ar: {
    ...
    items: [
      ...
      { title: "مخطط محكوم", supporting: "أكثر من 500 نموذج بيانات خدمات الطعام" },
    ],
  },
  fr: {
    ...
    items: [
      ...
      { title: "Schéma gouverné", supporting: "500+ modèles de données de restauration" },
    ],
  },
  es: {
    ...
    items: [
      ...
      { title: "Esquema gobernado", supporting: "500+ modelos de datos de hostelería" },
    ],
  },
};
