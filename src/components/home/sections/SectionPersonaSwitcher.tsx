...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedPersonaSwitcher> = {
  ...
  ar: {
    ...
    ctaSuffix: "←",
    personas: [
      { shortLabel: "COO", pluralLabel: "قادة العمليات", pain: "لا يمكنك أن تكون في كل مطعم في آن واحد.", painCopy: "حين يصل ملخص الأسبوع، تكون الوردية السيئة انتهت والهامش ضاع.", outcome: "رؤية حية لكل وردية.", outcomeCopy: "Pulse يُظهر أي موقع يحتاج المساعدة الآن — وتيرة، عمالة، تسرب، تتحدث عبر الوردية." },
  ...
  fr: {
    ...
    personas: [
      ...
      { shortLabel: "Tech", pluralLabel: "Responsables Tech & Data", pain: "Douze API. Cinq formats. Aucun schéma unifié.", painCopy: "Chaque nouveau dashboard devient un projet de six semaines.", outcome: "Une plateforme, douze domaines, zéro plomberie.", outcomeCopy: "POS, main-d'œuvre, stocks, livraison, comptabilité, réservations — unifiés dans 179 modèles gouvernés. RBAC, audit, API publique, webhooks. Prêts à l'emploi." },
    ],
  },
  es: {
    ...
    ctaSuffix: "→",
    personas: [
      { shortLabel: "COO", pluralLabel: "Líderes de operaciones", pain: "No puedes estar en todos los restaurantes a la vez.", painCopy: "Cuando llega el recap semanal, el turno malo acabó y el margen se fue.", outcome: "Visibilidad en vivo de cada turno.", outcomeCopy: "Pulse muestra qué local necesita ayuda ahora mismo — ritmo, personal, fugas, actualizado durante el turno." },
