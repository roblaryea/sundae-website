...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedPersonaSwitcher> = {
  en: {
    ...
    ctaSuffix: "demo →",
    personas: [
      { shortLabel: "COO", pluralLabel: "Operations Leaders", pain: "You can't be in every restaurant at once.", painCopy: "Fifty floors, one of you - and no single live view of which one is slipping tonight.", outcome: "Live visibility into every shift.", outcomeCopy: "Whether you're the GM on the floor or the COO over fifty outlets, Pulse shows which location needs help right now - pacing, labor, leakage, all updated through the shift." },
  ...
  ar: {
    ...
    ctaSuffix: "←",
    personas: [
      { shortLabel: "COO", pluralLabel: "قادة العمليات", pain: "لا يمكنك أن تكون في كل مطعم في آن واحد.", painCopy: "خمسون صالة، وأنت وحدك - ولا رؤية حية واحدة تكشف أيها يتعثّر الليلة.", outcome: "رؤية حية لكل وردية.", outcomeCopy: "سواء كنت مدير الفرع على الأرض أو الرئيس التنفيذي للعمليات على خمسين فرعاً، Pulse يُظهر أي موقع يحتاج المساعدة الآن - وتيرة، عمالة، تسرب، كل ذلك يتحدث عبر الوردية." },
