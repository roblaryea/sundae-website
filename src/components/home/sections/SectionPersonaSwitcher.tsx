...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedPersonaSwitcher> = {
  en: {
    ...
    ctaSuffix: "demo →",
    personas: [
      { shortLabel: "COO", pluralLabel: "Operations Leaders", pain: "You can't be in every restaurant at once.", painCopy: "Fifty floors, one of you - and no single live view of which one is slipping tonight.", outcome: "Margin recovered across every shift.", outcomeCopy: "Whether you're the GM on the floor or the COO over fifty outlets, Pulse shows which location needs help right now - pacing, labor, leakage, all updated through the shift." },
      ...
      { shortLabel: "CEO", pluralLabel: "CEOs and Owners", pain: "Your worst location is invisible until Thursday's recap.", painCopy: "By the time you see it, three more days of margin have leaked.", outcome: "The leaks - and the recovery - every morning.", outcomeCopy: "Daily AI briefings across every brand and location. Where you're winning, where you're leaking, what the market did to you, what to do today." },
      ...
      { shortLabel: "HR / People", pluralLabel: "HR and People Leads", pain: "Labor variance shows up too late.", painCopy: "Schedule changes happen on instinct. By the time the report comes back, the OT is already paid.", outcome: "Labor margin recovered, in the moment.", outcomeCopy: "Pulse shows live labor% by location, server productivity, and overtime risk - by shift, not by month." },
  ...
  ar: {
    ...
    ctaSuffix: "←",
    personas: [
      { shortLabel: "COO", pluralLabel: "قادة العمليات", pain: "لا يمكنك أن تكون في كل مطعم في آن واحد.", painCopy: "خمسون صالة، وأنت وحدك - ولا رؤية حية واحدة تكشف أيها يتعثّر الليلة.", outcome: "استرداد الهامش عبر كل وردية.", outcomeCopy: "سواء كنت مدير الفرع على الأرض أو الرئيس التنفيذي للعمليات على خمسين فرعاً، Pulse يُظهر أي موقع يحتاج المساعدة الآن - وتيرة، عمالة، تسرب، كل ذلك يتحدث عبر الوردية." },
      ...
      { shortLabel: "CEO", pluralLabel: "الرؤساء التنفيذيون والمالكون", pain: "أسوأ موقع عندك مختفٍ حتى ملخص الخميس.", painCopy: "حين تراه، يكون ثلاثة أيام إضافية من الهامش قد تسرّبت.", outcome: "التسربات - والاسترداد - كل صباح.", outcomeCopy: "إحاطات يومية بالذكاء الاصطناعي عبر كل علامة وموقع. أين تربح، أين تتسرب، ما فعله السوق، ما تفعله اليوم." },
      ...
      { shortLabel: "الموارد البشرية", pluralLabel: "قادة الموارد البشرية", pain: "تباين العمالة يظهر متأخراً.", painCopy: "تغييرات الجدول تحدث بالحدس. حين يعود التقرير، تكون OT قد دُفعت.", outcome: "استرداد هامش العمالة، في اللحظة.", outcomeCopy: "Pulse يُظهر نسبة عمالة حية بالموقع، إنتاجية الموظفين، وخطر OT - بالوردية لا بالشهر." },
  ...
  fr: {
    ...
    ctaSuffix: "→",
    personas: [
      { shortLabel: "COO", pluralLabel: "Responsables opérations", pain: "Vous ne pouvez pas être partout à la fois.", painCopy: "Cinquante salles, un seul vous - et aucune vue live de celle qui décroche ce soir.", outcome: "Marge récupérée sur chaque service.", outcomeCopy: "Que vous soyez le directeur sur le terrain ou le COO de cinquante points de vente, Pulse montre quel site a besoin d'aide en ce moment - cadence, main-d'œuvre, fuites, le tout mis à jour pendant le service." },
      ...
      { shortLabel: "CEO", pluralLabel: "Dirigeants et propriétaires", pain: "Votre pire site est invisible jusqu'au récap du jeudi.", painCopy: "Quand vous le voyez, trois jours de marge supplémentaires ont fui.", outcome: "Les fuites - et la récupération - chaque matin.", outcomeCopy: "Briefings IA quotidiens sur chaque marque et site. Où vous gagnez, où vous fuyez, ce que le marché vous a fait, quoi faire aujourd'hui." },
  ...
  es: {
    ...
    personas: [
      ...
      { shortLabel: "CEO", pluralLabel: "CEOs y propietarios", pain: "Tu peor local es invisible hasta el recap del jueves.", painCopy: "Cuando lo ves, tres días más de margen se han fugado.", outcome: "Las fugas - y la recuperación - cada mañana.", outcomeCopy: "Briefings de IA diarios en cada marca y local. Dónde ganas, dónde fugas, qué hizo el mercado, qué hacer hoy." },
      ...
      { shortLabel: "RR.HH.", pluralLabel: "Líderes de RR.HH. & People", pain: "La varianza de personal aparece demasiado tarde.", painCopy: "Los cambios de horario por instinto. Cuando vuelve el reporte, las horas extras ya se pagaron.", outcome: "Margen laboral recuperado, en el momento.", outcomeCopy: "Pulse muestra % personal en vivo por local, productividad de meseros y riesgo de horas extras - por turno, no por mes." },
