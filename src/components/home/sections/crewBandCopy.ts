...
export const crewBandCopy: Record<WebsiteLocale, CrewBandCopy> = {
  en: {
    ...
    "sub": "Scheduling, time and attendance, payroll readiness, and the full hire-to-retire lifecycle - run natively in Sundae, or bring your own HR. Every shift, punch, and pay run becomes operating data that sharpens the whole platform - from Pulse and Labor Intelligence to Ask Sundae and Foresight.",
    "pillars": [
      {
        "title": "Scheduling",
  ...
  ar: {
    ...
    "sub": "جدولة المناوبات وتتبّع الوقت والحضور والتحضير لكشوف الرواتب ودورة الحياة الكاملة من التوظيف حتى انتهاء الخدمة - تُدار جميعها أصلاً داخل Sundae، أو عبر نظام الموارد البشرية الخاص بك. كل مناوبة وكل تسجيل حضور وكل دورة رواتب تتحوّل إلى بيانات تشغيلية تصقل المنصة بأكملها - من Pulse وLabor Intelligence إلى Ask Sundae وForesight.",
    "pillars": [
      {
  ...
  "zh-Hans": {
    ...
    "accent": "每个班次都化为信号。",
    "sub": "排班、考勤、薪资准备，以及从入职到离职的完整员工生命周期 - 既可在 Sundae 中原生运行，也可接入你自己的 HR 系统。每一次排班、每一次打卡、每一轮发薪都会沉淀为运营数据，让整个平台更敏锐 - 从 Pulse 和 Labor Intelligence 到 Ask Sundae 与 Foresight。",
    "pillars": [
      {
        "title": "排班",
  ...
  ja: {
    ...
    "sub": "シフト管理、勤怠、給与準備、そして採用から退職までのすべての従業員ライフサイクルを--Sundae 内でネイティブに動かすことも、自社の HR をそのまま使うこともできます。すべてのシフト、打刻、給与計算が運用データとなり、プラットフォーム全体を鋭くします--Pulse や Labor Intelligence から Ask Sundae や Foresight まで。",
    "pillars": [
      {
        "title": "シフト管理",
  ...
  ko: {
    ...
    "sub": "근무 일정, 근태, 급여 준비, 그리고 채용부터 퇴사까지 이어지는 전체 직원 생애주기를--Sundae 안에서 기본으로 운영하거나, 기존 HR을 그대로 연결할 수 있습니다. 모든 근무, 모든 출퇴근 기록, 모든 급여 지급이 운영 데이터가 되어 플랫폼 전체를 더 날카롭게 만듭니다--Pulse와 Labor Intelligence부터 Ask Sundae와 Foresight까지.",
    "pillars": [
      {
        "title": "근무 스케줄",
