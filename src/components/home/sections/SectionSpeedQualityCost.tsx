...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedSQC> = {
  en: {
    ...
    vertices: [
      { label: "Speed", headline: "Deploy in days. Recover from day one.", body: "Connect your stack fast. Pulse updates through the shift, and Sundae Intelligence answers with sources instead of sending teams back into the report queue.", chips: ["Days to deploy", "Live Core refresh", "Answers in seconds"] },
  ...
  ar: {
    ...
    vertices: [
      { label: "السرعة", headline: "انشر في أيام. استرجع من اليوم الأول.", body: "اربط مكدّسك سريعاً. Pulse يتحدث عبر الوردية، وSundae Intelligence يجيب بمصادر بدل إعادة الفِرَق إلى طابور التقارير.", chips: ["أيام للنشر", "تحديث Core حي", "إجابات في ثوانٍ"] },
  ...
  es: {
    ...
    vertices: [
      { label: "Velocidad", headline: "Despliega en días. Recupera desde el primer día.", body: "Conecta tu stack rápido. Pulse se actualiza durante el turno, y Sundae Intelligence responde con fuentes en vez de mandar a los equipos de vuelta a la cola de reportes.", chips: ["Días para desplegar", "Refresh Core en vivo", "Respuestas en segundos"] },
