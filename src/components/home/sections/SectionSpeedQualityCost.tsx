...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedSQC> = {
  en: {
    ...
    vertices: [
      ...
      { label: "Quality", headline: "Built for food-service. Governed for decisions.", body: "Sundae ships with 500+ governed food-service data models, peer-anchored benchmarks, and source-cited AI answers - so teams are not building from a blank BI canvas.", chips: ["500+ models", "Source-cited AI", "Peer benchmarks"] },
  ...
  ar: {
    ...
    vertices: [
      ...
      { label: "الجودة", headline: "مصمم لخدمات الطعام. محكوم للقرارات.", body: "Sundae يأتي بأكثر من 500 نموذج بيانات محكوم لخدمات الطعام، ومعايير نظراء، وإجابات AI مع مصادر - فلا تبني من لوحة BI فارغة.", chips: ["+500 نموذج", "AI بمصادر", "معايير نظراء"] },
  ...
  fr: {
    ...
    vertices: [
      ...
      { label: "Qualité", headline: "Conçu pour la restauration. Gouverné pour décider.", body: "Sundae livre 500+ modèles de données de restauration gouvernés, des benchmarks pairs et des réponses IA sourcées - vous ne construisez pas sur une toile BI vide.", chips: ["500+ modèles", "IA sourcée", "Benchmarks pairs"] },
  ...
  es: {
    ...
    vertices: [
      ...
      { label: "Calidad", headline: "Hecho para la hostelería. Gobernado para decidir.", body: "Sundae trae 500+ modelos de datos de hostelería gobernados, benchmarks de pares y respuestas IA con fuente - para que los equipos no construyan desde un lienzo BI en blanco.", chips: ["500+ modelos", "IA con fuente", "Benchmarks pares"] },
