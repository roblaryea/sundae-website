...
const localizedCopy: Record<"en" | "ar" | "fr" | "es", LocalizedProof> = {
  en: {
    ...
    stats: [
      ...
      { value: "179+", label: "restaurant-specific data models" },
      { value: "30+", label: "analytics modules", footnoteMarker: "†" },
    ...
    footnote: "*Refresh frequency varies by Core tier. See pricing for details. †30+ analytics modules across the platform; 14 specialized modules included in the current pricing bundle. ‡Industry observations are general restaurant-industry patterns drawn from public research and advisory feedback. Named pilot results and validated customer outcomes will replace this section as they become available.",
  },
  ar: {
    ...
    stats: [
      ...
      { value: "+179", label: "نموذج بيانات مطعم" },
    ...
    footnote: "*يختلف معدل التحديث بحسب طبقة Core. راجع التسعير. † أكثر من 30 وحدة تحليلية عبر المنصة؛ 14 وحدة متخصصة في الحزمة الحالية. ‡ ملاحظات الصناعة أنماط عامة لصناعة المطاعم من بحث عام وملاحظات استشارية. نتائج تجريبية مسماة ستحل محل هذا القسم عند توفرها.",
  },
  fr: {
    ...
    stats: [
      ...
      { value: "179+", label: "modèles de données restaurant" },
      { value: "30+", label: "modules analytiques", footnoteMarker: "†" },
    ...
    footnote: "*Fréquence de refresh selon le tier Core. Voir les prix. †30+ modules analytiques sur la plateforme ; 14 modules spécialisés inclus dans le bundle actuel. ‡Observations industrielles : motifs généraux de la restauration tirés de recherche publique et de retours conseil. Résultats pilotes nommés remplaceront cette section dès disponibles.",
  },
  es: {
    ...
    stats: [
      ...
      { value: "179+", label: "modelos de datos de restaurante" },
      { value: "30+", label: "módulos analíticos", footnoteMarker: "†" },
