 ...
 *   CLM-004 (location-count claim) DIALED BACK — replaced with capability framing pending validation
    ...
    <section aria-labelledby="proof-headline" className="relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 py-16 sm:py-20 lg:py-24">
        <div className="text-center max-w-3xl mx-auto">
          <div className="eyebrow mb-4">BUILT WITH OPERATORS</div>
          <h2 id="proof-headline" className="section-h2 text-balance mb-5">
            Shaped by restaurant operators across every format.
          </h2>
          <p className="body-lg max-w-2xl mx-auto">
            QSR, casual dining, fine dining, cloud kitchens, and hospitality
            groups inform the intelligence layer restaurants actually need —
            from single-shop operators to multi-brand portfolios.
          </p>
        </div>
