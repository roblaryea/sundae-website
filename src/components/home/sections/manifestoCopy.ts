...
export const manifestoCopy: Record<WebsiteLocale, ManifestoCopy> = {
  en: {
    ...
    coda: 'Food-service doesn’t fail in reports. It slips in moments - a section slows, labor drifts, covers fall behind, a table waits too long. Sundae exists to catch those moments while there’s still time to change the outcome.',
  },
  ar: {
    eyebrow: 'ما نؤمن به',
    statement: 'أفضل القرارات تُتَّخذ *والخدمة ما زالت قائمة.*',
    coda: 'خدمات الطعام لا تفشل في التقارير. بل تتعثّر في اللحظات: قسم يتباطأ، عمالة تنحرف عن مسارها، طاولات تتأخر، وزبون ينتظر أكثر من اللازم. وُجِدت Sundae لتلتقط تلك اللحظات بينما لا يزال هناك وقت لتغيير النتيجة.',
  },
  fr: {
    eyebrow: 'Ce en quoi nous croyons',
    statement: 'Les meilleures décisions se prennent *pendant que le service est encore vivant.*',
    coda: "La restauration n'échoue pas dans les rapports. Elle dérape dans les instants - une zone ralentit, le personnel se décale, les couverts prennent du retard, une table attend trop longtemps. Sundae existe pour saisir ces instants tant qu'il est encore temps de changer l'issue.",
  },
  es: {
    eyebrow: 'En lo que creemos',
    statement: 'Las mejores decisiones ocurren *mientras el turno sigue vivo.*',
    coda: 'La hostelería no fracasa en los informes. Se le escapa el control en los momentos: una zona se ralentiza, el personal se desajusta, los comensales se acumulan, una mesa espera demasiado. Sundae existe para atrapar esos momentos cuando todavía hay tiempo de cambiar el desenlace.',
  },
  de: {
    eyebrow: 'Woran wir glauben',
    statement: 'Die besten Entscheidungen fallen, *solange der Service noch läuft.*',
    coda: 'Die Gastronomie scheitert nicht in Reports. Sie gerät in einzelnen Momenten ins Rutschen: eine Station wird langsamer, der Personaleinsatz verschiebt sich, die Gedecke geraten in Rückstand, ein Tisch wartet zu lange. Sundae ist da, um diese Momente zu erfassen, solange noch Zeit bleibt, den Ausgang zu ändern.',
  },
  nl: {
    eyebrow: 'Waar wij in geloven',
    statement: 'De beste beslissingen vallen *terwijl de service nog leeft.*',
    coda: 'De horeca gaat niet onderuit in rapporten. Ze glipt weg in momenten: een sectie loopt vast, de personeelsinzet schuift, de couverts raken achterop, een tafel wacht te lang. Sundae bestaat om die momenten te grijpen terwijl er nog tijd is om de afloop te veranderen.',
  },
  pt: {
    eyebrow: 'No que acreditamos',
    statement: 'As melhores decisões acontecem *enquanto o turno ainda está vivo.*',
    coda: 'A restauração não falha nos relatórios. Ela escorrega nos momentos: uma área desacelera, a equipa sai do ritmo, os cobertos atrasam, uma mesa espera tempo demais. A Sundae existe para apanhar esses momentos enquanto ainda há tempo de mudar o desfecho.',
  },
  hi: {
    eyebrow: 'हम क्या मानते हैं',
    statement: 'सबसे अच्छे फ़ैसले तभी होते हैं *जब शिफ़्ट अभी ज़िंदा हो.*',
    coda: 'फ़ूड-सर्विस रिपोर्ट में नहीं डूबती। वह पलों में फिसलती है: कोई सेक्शन धीमा पड़ता है, स्टाफ़ की तैनाती बिगड़ती है, मेहमान पिछड़ जाते हैं, कोई टेबल बहुत देर तक इंतज़ार करती है। Sundae इसी लिए है कि उन पलों को तब पकड़े जब नतीजा बदलने का समय अभी बाक़ी हो।',
  },
  ur: {
    eyebrow: 'ہم کس بات پر یقین رکھتے ہیں',
    statement: 'بہترین فیصلے تب ہوتے ہیں *جب شفٹ ابھی زندہ ہو۔*',
    coda: 'فوڈ سروس رپورٹوں میں ناکام نہیں ہوتی۔ وہ لمحوں میں پھسلتی ہے: کوئی سیکشن سست پڑ جاتا ہے، عملہ بے ترتیب ہو جاتا ہے، مہمان پیچھے رہ جاتے ہیں، کوئی میز بہت دیر انتظار کرتی ہے۔ Sundae اسی لیے ہے کہ ان لمحوں کو تب تھام لے جب نتیجہ بدلنے کا وقت ابھی باقی ہو۔',
  },
  it: {
    eyebrow: 'In cosa crediamo',
    statement: 'Le decisioni migliori si prendono *mentre il servizio è ancora vivo.*',
    coda: "La ristorazione non fallisce nei report. Scivola negli attimi - una zona rallenta, il personale perde il ritmo, i coperti restano indietro, un tavolo aspetta troppo a lungo. Sundae esiste per cogliere quegli attimi finché c'è ancora tempo di cambiare l'esito.",
  },
  pl: {
    eyebrow: 'W co wierzymy',
    statement: 'Najlepsze decyzje zapadają *kiedy zmiana wciąż trwa.*',
    coda: 'Gastronomia nie upada w raportach. Wymyka się w pojedynczych chwilach: sektor zwalnia, obsada się rozjeżdża, kuwerty zostają w tyle, stolik czeka za długo. Sundae istnieje po to, by uchwycić te chwile, póki jest jeszcze czas, by zmienić wynik.',
  },
  tr: {
    eyebrow: 'Neye inanıyoruz',
    statement: 'En iyi kararlar *servis hâlâ canlıyken* alınır.',
    coda: 'Yeme-içme sektörü raporlarda batmaz. Anların içinde kayıp gider: bir bölge yavaşlar, ekip ritmini kaçırır, masalar geride kalır, bir masa fazlaca bekletilir. Sundae, sonucu değiştirmeye hâlâ vakit varken o anları yakalamak için var.',
  },
  'zh-Hans': {
    eyebrow: '我们的信念',
    statement: '最好的决策，发生在 *这一班还活着的时候。*',
    coda: '餐饮不是败在报表里，而是在一个个瞬间里悄悄滑落：一片区域慢了下来，人手开始错位，客流被甩在后面，一桌客人等得太久。Sundae 的存在，就是为了在还来得及改变结局的时候，抓住这些瞬间。',
  },
  ja: {
    eyebrow: '私たちが信じること',
  ...
  ko: {
    ...
    coda: '외식업은 보고서에서 무너지지 않는다. 순간순간 미끄러질 뿐이다: 한 구역이 느려지고, 인력 배치가 어긋나고, 손님이 밀리고, 한 테이블이 너무 오래 기다린다. Sundae는 결과를 바꿀 시간이 아직 남아 있을 때 그 순간을 붙잡기 위해 존재한다.',
  },
  id: {
    eyebrow: 'Yang kami yakini',
    statement: 'Keputusan terbaik diambil *saat shift masih hidup.*',
    coda: 'Layanan makanan tidak gagal di laporan. Ia tergelincir di momen-momen kecil: satu area melambat, penempatan staf melenceng, tamu menumpuk, satu meja menunggu terlalu lama. Sundae hadir untuk menangkap momen-momen itu selagi masih ada waktu mengubah hasilnya.',
  },
  vi: {
    eyebrow: 'Điều chúng tôi tin',
    statement: 'Những quyết định tốt nhất được đưa ra *khi ca làm vẫn còn đang sống.*',
    coda: 'Dịch vụ ăn uống không sụp đổ trong báo cáo. Nó tuột dốc trong từng khoảnh khắc: một khu chậm lại, nhân sự lệch nhịp, khách dồn ứ, một bàn chờ quá lâu. Sundae tồn tại để bắt lấy những khoảnh khắc đó khi vẫn còn kịp thay đổi kết cục.',
  },
  ro: {
    eyebrow: 'În ce credem',
    statement: 'Cele mai bune decizii se iau *cât timp tura este încă vie.*',
    coda: 'HoReCa nu eșuează în rapoarte. Alunecă în momente: o zonă încetinește, echipa se abate de la ritm, comenzile rămân în urmă, o masă așteaptă prea mult. Sundae există ca să prindă aceste momente cât mai e timp să schimbi deznodământul.',
  },
  sv: {
    eyebrow: 'Det vi tror på',
    statement: 'De bästa besluten fattas *medan passet fortfarande lever.*',
    coda: 'Restaurangbranschen faller inte i rapporterna. Den glider undan i ögonblicken: en sektion saktar ner, bemanningen glider iväg, gästerna hopar sig, ett bord får vänta för länge. Sundae finns för att fånga de ögonblicken medan det ännu finns tid att ändra utgången.',
  },
  bn: {
    eyebrow: 'আমরা যা বিশ্বাস করি',
    statement: 'সেরা সিদ্ধান্তগুলো হয় *যখন শিফট তখনও জীবন্ত.*',
    coda: 'ফুড সার্ভিস রিপোর্টে ব্যর্থ হয় না। তা ফসকে যায় মুহূর্তে: কোনো সেকশন ধীর হয়ে পড়ে, কর্মী বিন্যাস এলোমেলো হয়, অতিথিরা পিছিয়ে পড়ে, কোনো টেবিল বড্ড বেশি অপেক্ষা করে। Sundae আছে সেই মুহূর্তগুলো ধরতে, যখন ফলাফল বদলানোর সময় এখনও বাকি।',
  },
  th: {
    eyebrow: 'สิ่งที่เราเชื่อ',
    statement: 'การตัดสินใจที่ดีที่สุดเกิดขึ้น *ขณะที่กะยังมีชีวิตอยู่*',
    coda: 'ธุรกิจบริการอาหารไม่ได้ล้มในรายงาน แต่พลาดไปในแต่ละช่วงเวลา: โซนหนึ่งเริ่มช้า การจัดคนเริ่มเพี้ยน ลูกค้าเริ่มตกค้าง โต๊ะหนึ่งรอนานเกินไป Sundae มีอยู่เพื่อคว้าช่วงเวลาเหล่านั้นไว้ ในขณะที่ยังมีเวลาพอจะเปลี่ยนผลลัพธ์',
  },
  ms: {
    eyebrow: 'Apa yang kami percaya',
    statement: 'Keputusan terbaik berlaku *semasa syif masih hidup.*',
    coda: 'Perkhidmatan makanan tidak gagal dalam laporan. Ia tergelincir dalam saat-saat kecil: satu kawasan perlahan, tenaga kerja terpesong, tetamu tertangguh, satu meja menunggu terlalu lama. Sundae wujud untuk menangkap saat-saat itu selagi masih ada masa untuk mengubah keputusannya.',
  },
};
