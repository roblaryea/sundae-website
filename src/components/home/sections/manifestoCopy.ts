...
export const manifestoCopy: Record<WebsiteLocale, ManifestoCopy> = {
  ...
  pl: {
    ...
    coda: "Restauracje nie upadają w raportach. Wymykają się w pojedynczych chwilach: sektor zwalnia, obsada się rozjeżdża, kuwerty zostają w tyle, stolik czeka za długo. Sundae istnieje po to, by uchwycić te chwile, póki jest jeszcze czas, by zmienić wynik, i po to, by potem udowodnić, że było warto.",
  },
  tr: {
    eyebrow: 'Neye inanıyoruz',
    statement: 'En iyi kararlar *servis hâlâ canlıyken* alınır.',
    coda: "Restoranlar raporlarda batmaz. Anların içinde kayıp gider: bir bölge yavaşlar, ekip ritmini kaçırır, masalar geride kalır, bir masa fazlaca bekletilir. Sundae, sonucu değiştirmeye hâlâ vakit varken o anları yakalamak için var ve sonrasında bunun değdiğini kanıtlamak için.",
  },
  'zh-Hans': {
    eyebrow: '我们的信念',
  ...
  ja: {
    ...
    coda: "店は報告書の中で潰れるのではない。一瞬一瞬の中で取りこぼしていく：あるセクションが滞り、人の配置がずれ、客の流れが追いつかず、ひとつのテーブルが待たされすぎる。Sundae は、まだ結果を変えられるうちにその一瞬をつかむために存在する、そしてそれが価値ある行動だったと後から証明するために。",
  },
  ko: {
    eyebrow: '우리가 믿는 것',
    statement: '최고의 결정은 *근무가 아직 살아 있을 때* 내려진다.',
    coda: "식당은 보고서에서 무너지지 않는다. 순간순간 미끄러질 뿐이다: 한 구역이 느려지고, 인력 배치가 어긋나고, 손님이 밀리고, 한 테이블이 너무 오래 기다린다. Sundae는 결과를 바꿀 시간이 아직 남아 있을 때 그 순간을 붙잡기 위해 존재한다, 그리고 그것이 값어치 있었음을 나중에 증명하기 위해.",
  },
  id: {
    eyebrow: 'Yang kami yakini',
    statement: 'Keputusan terbaik diambil *saat shift masih hidup.*',
    coda: "Restoran tidak gagal di laporan. Mereka tergelincir di momen-momen kecil: satu area melambat, penempatan staf melenceng, tamu menumpuk, satu meja menunggu terlalu lama. Sundae hadir untuk menangkap momen-momen itu selagi masih ada waktu mengubah hasilnya, dan untuk membuktikan setelahnya bahwa itu sepadan.",
  },
  vi: {
    eyebrow: 'Điều chúng tôi tin',
    statement: 'Những quyết định tốt nhất được đưa ra *khi ca làm vẫn còn đang sống.*',
    coda: "Nhà hàng không sụp đổ trong báo cáo. Họ tuột dốc trong từng khoảnh khắc: một khu chậm lại, nhân sự lệch nhịp, khách dồn ứ, một bàn chờ quá lâu. Sundae tồn tại để bắt lấy những khoảnh khắc đó khi vẫn còn kịp thay đổi kết cục, và để chứng minh sau đó rằng điều đó là xứng đáng.",
  },
  ro: {
  ...
  bn: {
    ...
    coda: "রেস্তোরাঁ রিপোর্টে ব্যর্থ হয় না। তারা ফসকে যায় মুহূর্তে: কোনো সেকশন ধীর হয়ে পড়ে, কর্মী বিন্যাস এলোমেলো হয়, অতিথিরা পিছিয়ে পড়ে, কোনো টেবিল বড্ড বেশি অপেক্ষা করে। Sundae আছে সেই মুহূর্তগুলো ধরতে, যখন ফলাফল বদলানোর সময় এখনও বাকি, আর পরে প্রমাণ করতে যে সেটি সার্থক ছিল।",
  },
  th: {
  ...
  ms: {
    ...
    coda: "Restoran tidak gagal dalam laporan. Ia tergelincir dalam saat-saat kecil: satu kawasan perlahan, tenaga kerja terpesong, tetamu tertangguh, satu meja menunggu terlalu lama. Sundae wujud untuk menangkap saat-saat itu selagi masih ada masa untuk mengubah keputusannya, dan untuk membuktikan kemudian bahawa ia berbaloi.",
  },
};
