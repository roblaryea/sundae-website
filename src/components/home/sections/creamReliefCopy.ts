...
export type CreamReliefVariantCopy = {
  ...
  statement: string;
  lede: string;
  /** Three macro-frame captions (used by the 'decisions' beat only). */
...
export const creamReliefCopy: Record<WebsiteLocale, CreamReliefCopy> = {
  en: {
    decisions: {
      ...
      trio: ['The plate', 'The line', 'The room'],
    },
    truth: {
  ...
  fr: {
    decisions: {
      ...
      trio: ["L'assiette", 'La ligne', 'La salle'],
    },
    truth: {
  ...
  es: {
    decisions: {
      ...
      trio: ['El plato', 'La línea', 'La sala'],
    },
    truth: {
  ...
  de: {
    decisions: {
      ...
      trio: ['Der Teller', 'Die Linie', 'Der Raum'],
    },
    truth: {
  ...
  it: {
    decisions: {
      ...
      trio: ['Il piatto', 'La linea', 'La sala'],
    },
    truth: {
  ...
  vi: {
    decisions: {
      ...
      trio: ['Món ăn', 'Dây chuyền', 'Phòng ăn'],
    },
    truth: {
  ...
  th: {
    decisions: {
      ...
      trio: ['จานอาหาร', 'ไลน์ครัว', 'ห้องอาหาร'],
    },
    truth: {
