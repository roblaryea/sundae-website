 ...
 * <PhoneFrame screenBg="#020617">. Pure markup — safe to server-render.
 *
    ...
    <div style={{ background: T.bg, color: T.tx, fontFamily: FONT, padding: '6px 14px 16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '14px 2px 0' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ font: `500 10px ${FONT}`, color: T.tx3, marginTop: 1 }}>4 shifts · 30h</div>
        </div>
        <span style={{ width: 30, height: 30, borderRadius: 9, background: T.surf, border: `1px solid ${T.bd}`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: 3, marginTop: 11 }}>
        <Day d="M" n="22" dot={C.blue} />
        <Day d="T" n="23" />
        <Day d="W" n="24" active />
        <Day d="T" n="25" />
        <Day d="F" n="26" dot={C.amber} />
        <Day d="S" n="27" dot={C.purple} />
        <Day d="S" n="28" />
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ font: `700 10px ${FONT}`, letterSpacing: '.09em', textTransform: 'uppercase', color: T.tx3 }}>Next shift</span>
          <span style={{ font: `600 10px ${FONT}`, color: T.tx3 }}>Starts in 2h 40m</span>
        </div>
        <div style={{ font: `700 20px ${FONT}`, letterSpacing: '-.01em', color: T.tx, marginTop: 8 }}>5:30 – 11:00 PM</div>
        <div style={{ font: `500 11.5px ${FONT}`, color: T.tx2, marginTop: 4 }}>Sundae — DIFC · Server · Section 3</div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 13 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
            ...
            <span style={{ font: `600 11px ${FONT}`, color: T.tx2, whiteSpace: 'nowrap' }}>4 with you</span>
          </div>
          <button
            style={{
              minHeight: 34,
      ...
      <div style={{ margin: '18px 2px 9px' }}>
        <span style={{ font: `700 10px ${FONT}`, letterSpacing: '.09em', textTransform: 'uppercase', color: T.tx3 }}>This week</span>
      </div>
      <div style={{ font: `600 10px ${FONT}`, color: T.tx3, margin: '0 2px 6px' }}>Wed 24 Jun · Today</div>
      <div style={{ display: 'flex', background: T.surf, border: `1px solid ${T.bd}`, borderRadius: 15, overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, padding: '12px 12px 12px 11px', minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ font: `700 9px ${FONT}`, letterSpacing: '.04em', textTransform: 'uppercase', background: 'rgba(96,165,250,.16)', color: '#93c5fd', borderRadius: 6, padding: '3px 7px', whiteSpace: 'nowrap' }}>Upcoming</span>
          </div>
          <div style={{ font: `500 11px ${FONT}`, color: T.tx2, marginTop: 4 }}>Sundae — DIFC · Server</div>
        </div>
